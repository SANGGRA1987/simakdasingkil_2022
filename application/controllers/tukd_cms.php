...
class Tukd_cms extends CI_Controller {
    ...
    function proses_menubp(){
        ...
        $init4 = $this->db->query("delete from ms_skpd_cms where kd_skpd='$skpd'");
    ...
    function config_npwp(){
        $skpd     = $this->session->userdata('kdskpd');
        $sql = "SELECT top 1 npwp,rekening FROM ms_skpd a WHERE left(a.kd_skpd,7) = left('$skpd',7)"; 
        $query1 = $this->db->query($sql);  		
		$result = array();
        foreach($query1->result_array() as $resulte)
        { 
	...
	{		
        ...
        $inskpd = substr($lccr,0,7);
        $cek_skpd = $this->db->query("select count(*) as hasil from ms_skpd_cms where kd_skpd='$lccr'")->row();
        ...
        if($cek_skpd1==1){
            ...
            $init_skpd = "left(kd_skpd,7)=left('$lccr',7)";
        }
	...
	{		
		$lccr =  $this->session->userdata('kdskpd');
        $sql = "SELECT top 1 rekening_pend FROM ms_skpd where left(kd_skpd,7)=left('$lccr',7) order by kd_skpd";
        $query1 = $this->db->query($sql);  
        $result = array();
        foreach($query1->result_array() as $resulte)
        { 
	...
	{				
        ...
        $cek_skpd = $this->db->query("select count(*) as hasil from ms_skpd_cms where kd_skpd='$skpd'")->row();
        $cek_skpd1 = $cek_skpd->hasil;
        if($cek_skpd1==1){            
            if($inskpd=='1.02.01'){
    ...
    function transout()
    {
        ...
        $cek_skpd = $this->db->query("select count(*) as hasil from ms_skpd_cms where kd_skpd='$kd_skpd'")->row();
    ...
    function load_trskpd_sub_tunai() {        
        ...
        $cek = explode(".",$bid);
        if($cek=="00"){
            $par = "left(b.kd_skpd,7)='$sskpd' and b.kd_rek5 in ('5220312','5220104','5220501','5222501','5220307','5220505','5220314','5220801','5220702','5221012','5220321','5220326')";
            $par2 = "left(b.kd_skpd,7)='$sskpd'";
        }else{
            $par = "b.kd_skpd='$bid' and b.kd_rek5 in ('5220312','5220104','5220501','5222501','5220307','5220505','5220314','5220801','5220702','5221012','5220321','5220326')";
            $par2 = "b.kd_skpd='$bid'";
        }
            ...
            if($giat=='1.01.1.01.01.00.22.002'){
                ...
                $sql = "SELECT a.kd_rek5,a.nm_rek5,
                    (SELECT SUM(nilai) FROM 
						...
						0 AS sp2d,nilai AS anggaran,nilai_sempurna as nilai_sempurna, nilai_ubah AS nilai_ubah
						FROM trdrka a WHERE a.kd_kegiatan= '$giat' AND a.kd_rek5 in ('5220312','5220104','5220501','5222501','5220307','5220505','5220314','5220801','5220702','5221012','5220321','5220326') AND a.kd_skpd = '$kode' $notIn  ";
    ...
    function load_sisa_bank(){
        ...
        if($cek_skpd1==1){
            ...
            select a.tgl_sts as tgl,a.no_sts as bku, a.keterangan as ket, SUM(b.rupiah) as jumlah, '1' as jns, a.kd_skpd as kode 
					...
					where jns_trans NOT IN('4','2','5') and pot_khusus in ('0','2') AND bank='BNK' AND left(a.kd_skpd,7)=left('$kd_skpd',7)
            ...
            SELECT tgl_bukti AS tgl,no_bukti AS bku,ket as ket,nilai AS jumlah,'1' AS jns,kd_skpd AS kode FROM trhINlain WHERE left(kd_skpd,7)=left('$kd_skpd',7) and pay='BANK' union ALL            
    ...
    function load_sisa_bank_cms_val($kd_skpd=''){
		//$kd_skpd = $this->session->userdata('kdskpd');    
        $skpdbp =  substr($kd_skpd,8,2);
        $inskpd = substr($kd_skpd,7);
        $cek_skpd = $this->db->query("select count(*) as hasil from ms_skpd_cms where kd_skpd='$kd_skpd'")->row();
    ...
    function load_trans_trmpot(){
       ...
       $sql = "SELECT DISTINCT a.no_tgl,a.no_voucher,a.tgl_voucher,b.no_sp2d,b.kd_kegiatan,b.nm_kegiatan,b.kd_rek5,b.nm_rek5,a.jns_spp,a.total 
            ...
            and a.status_upload not in ('1') and a.jns_spp in ('1','3')
            order by a.tgl_voucher,a.no_voucher";
    ...
    function load_sisa_tunai(){
        ...
        $query1 = $this->db->query("
				...
				select a.tgl_sts as tgl,a.no_sts as bku, a.keterangan as ket, SUM(b.rupiah) as jumlah, '2' as jns, a.kd_skpd as kode 
					from trhkasin_pkd a INNER JOIN trdkasin_pkd b ON a.no_sts=b.no_sts AND a.kd_skpd=b.kd_skpd 
					where jns_trans NOT IN('4','2','5') and pot_khusus in ('0','2')  AND $init_skpd
					GROUP BY a.tgl_sts,a.no_sts, a.keterangan,a.kd_skpd				
				UNION ALL
    ...
    function cek_status_ang(){
        ...
        $skpd     = $this->session->userdata('kdskpd');
        $sql = "select 
                case when statu=1 and status_sempurna=1 and status_ubah=1 then 'Perubahan' 
   ...
   function no_urut_validasibku($kd_skpd=''){
    //$kd_skpd = $this->session->userdata('kdskpd'); 
    $cek_skpd = $this->db->query("select count(*) as hasil from ms_skpd_cms where kd_skpd='$kd_skpd'")->row();
        $cek_skpd1 = $cek_skpd->hasil;
        if($cek_skpd1==1){
   ...
   function no_urut_cms(){
    ...
    union all
    select no_upload nomor, 'Urut Upload Setor Dana Bank cms' ket, kd_skpd from trhupload_cmsbank_bidang where $init_skpd     
    union all
    ...
    function no_urut_validasicms($kd_skpd=''){
    //$kd_skpd = $this->session->userdata('kdskpd'); 
...
a.bank_tujuan,a.ket_tujuan,b.kd_kegiatan,b.nm_kegiatan,c.bersih,a.jns_spp        
    ...
    function load_listbelum_validasi(){
        ...
        $query1 = $this->db->query("SELECT a.no_bukti,a.kd_skpd,a.nm_skpd,a.no_tgl,a.no_voucher,a.tgl_voucher,a.no_sp2d,a.ket,a.total,a.status_upload,
a.tgl_upload,a.status_validasi,a.tgl_validasi,a.rekening_awal,a.nm_rekening_tujuan,a.rekening_tujuan,
a.bank_tujuan,a.ket_tujuan,a.status_trmpot,c.no_upload,d.bersih,a.jns_spp FROM trhtransout_cmsbank a left join trdtransout_cmsbank b on b.kd_skpd=a.kd_skpd and a.no_voucher=b.no_voucher 
        left join trdupload_cmsbank c on a.no_voucher = c.no_voucher and a.kd_skpd = c.kd_skpd
        left join (
        select a.no_voucher,a.kd_skpd,sum(a.nilai) bersih from trdtransout_transfercms a where $init_skpd
        group by no_voucher,kd_skpd)d on d.no_voucher=a.no_voucher and d.kd_skpd=a.kd_skpd
...
a.bank_tujuan,a.ket_tujuan,a.status_trmpot,c.no_upload
    ...
    function load_list_validasi_close(){
        $result = array();
        $row = array();
      	$page = isset($_POST['page']) ? intval($_POST['page']) : 1;
	    $rows = isset($_POST['rows']) ? intval($_POST['rows']) : 10;
    ...
    function csv_cmsbank_panjar($nomor=''){
        ...
        if($cek_skpd1==1){
            ...
            if($init_skp=='1.02.01'){
                ...
                where $init_skpd and a.no_upload='$nomor' order by c.no_bukti");
            }else{
                $sqlquery = $this->db->query("SELECT a.tgl_upload,a.kd_skpd,(SELECT obskpd from ms_skpd where kd_skpd=a.kd_skpd) as nm_skpd,
                b.rekening_awal,c.nm_rekening_tujuan,c.rekening_tujuan,c.nilai,b.ket_tujuan,b.no_upload_tgl FROM trhupload_cmsbank_panjar a 
