...
class anggaran_murni_model extends CI_Model {
    ...
    function pgiat_rancang($lccr,$cskpd) {
        ...
        $sql  = " SELECT a.kd_sub_kegiatan,b.nm_sub_kegiatan,b.jns_sub_kegiatan,status_keg FROM trskpd a INNER JOIN     ms_sub_kegiatan b ON a.kd_sub_kegiatan=b.kd_sub_kegiatan
                where left(a.kd_skpd,20)=left('$cskpd',20) and status_sub_kegiatan='1' and status_keg='1' and (upper(a.kd_sub_kegiatan) like upper('%$lccr%') or upper(a.nm_sub_kegiatan) like upper('%$lccr%') ) order by a.kd_kegiatan";
    ...
    function select_rka_rancang($kegiatan,$skpd) {
        $sql = "SELECT c.jns_kegiatan,a.kd_rek6,b.nm_rek6,a.nilai,a.nilai_sempurna,a.nilai_ubah,a.sumber,a.sumber2,a.sumber3,a.sumber4,a.nilai_sumber,a.nilai_sumber2
                ...
                where a.kd_sub_kegiatan='$kegiatan' and a.kd_skpd='$skpd' order by a.kd_rek6 ";                   
    ...
    function load_sum_rek_rancang($kdskpd,$sub_kegiatan){
        ...
        $query1 = $this->db->query(" SELECT sum(nilai) as rektotal,sum(nilai_sempurna) as rektotal_sempurna,sum(nilai_ubah) as rektotal_ubah from 
                                     trdrka where left(kd_skpd,20)=left('$kdskpd',20) and kd_sub_kegiatan='$sub_kegiatan'");  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
        { 
    ...
    function rka_rinci_rancang($skpd,$kegiatan,$rekening,$norka,$idlokasi) {
        if($idlokasi==''){
            ...
            $kondisi="and kd_lokasi='$idlokasi'";
        }
        $sql    = "SELECT * from trdpo where no_trdrka='$norka' $kondisi order by no_po";                   
    ...
    function load_pengesahan_dpa($kriteria=''){
        ...
        $sql = "SELECT count(a.kd_skpd) as tot from trhrka a where len(a.kd_skpd)=20" ;
        $query1 = $this->db->query($sql);
        $total = $query1->row();
        ...
        $sql = "SELECT a.*,b.nm_skpd,
                ...
                from trhrka a inner join ms_skpd b on a.kd_skpd =b.kd_skpd $where  order by kd_skpd ";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
    ...
    function simpan_pengesahan($kdskpd,$sdpa,$srka,$sdppa,$nodpa,$tanggal1,$nodppa,$tanggal2,$sdpasempurna,$nosempurna,$tanggal3,$sdpasempurnax,$nosempurnax,$tanggal3x,$norka,$tanggal4,$last_update){
        ...
        $sql2 = "UPDATE trhrka set status_sempurna = '$sdpasempurna',
                ...
                tgl_dpa ='$tanggal1'
                where left(kd_skpd,20)=left('$kdskpd',20)";
