...
/*============*/            
    ...
    function pilih_edit(){
            ...
            if(jenis=='5'){
                ...
                if (( n_sisakua < total_rinci_edit )&&(jenis=='5')){
                    if(harga_<harga_edit_hidden){
...
<h3><a href="#" id="section2" >Rincian Rekening</a></h3>
    ...
    <div >
        ...
        <table id="dpo"  border='0' align="center" style="width:100%;">
           ...
           <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
                <td colspan='2' style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:110px;border-bottom-style:hidden;border-right-style:hidden;">GROUP SUBKELUARAN</td>
                <td colspan='6' style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
                    <input type="text" id="kdlokasi" style="width: 700px;" />
                    <input type="text" id="kdlokasi_ket" style="width: 100px; border:none; background-color:#E9967A;" />
                    <br>
                    <!-- <button id="stdhrg" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="javascript:lokasi_po();" style="margin:10px; cursor: pointer; ">Set Grouping</button> -->
                    <button id="addlokasi" class="button" onclick="javascript:lokasi_load('a');" style="cursor: pointer; background-color: #f5424b" title="Filter berdasarkan SubKeluaran"><b>Filter</b> Sub Keluaran</button>
                    <button id="addlokasi" class="button" onclick="javascript:lokasi_load('b');" style="cursor: pointer; background-color: #3082fc" title="Menampilkan semua data rincian">Load Data ALL</button>
                    <button id="addlokasi" class="button" onclick="javascript:lokasi_add();"     style="cursor: pointer; " title="Tambah jika di data dipilihan tidak ada">Tambah Edit Sub Keluaran</button>

                </td>
           </tr>
            <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
                <td colspan='2' style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:110px;border-bottom-style:hidden;border-right-style:hidden;">STANDART</td>
                <td colspan='6' style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
                     <input type="text" name="sbiaya" id="sbiaya" style="width: 800px" onclick="javascript:sbiayaharga();">
                    <!-- <button id="stdhrg" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="javascript:standard_harga();" style="margin:10px; cursor: pointer; ">Standart harga</button> -->
                </td>
           </tr>                
            <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening">
    ...
    <table border='0' style="width:800px;">
        ...
        <button id="pil_edit";class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:pilih_edit();">Simpan</button> &nbsp; &nbsp; &nbsp;
