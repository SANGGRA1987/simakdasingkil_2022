...
function ttd(kode){
    ...
    function cek2(cetak){
        ...
        if(cekbok==false){
            var url="<?php echo site_url(); ?>/cetak_rka/preview_rka_skpd_penetapan/"+ctglttd+'/'+ttd+'/'+ttd2+'/'+ckdskpd+'/'+cetak+'/hide/'+tipe_doc+'/'+cgaji+'/Cetak_RKA'+ckdskpd;
        }else{
            var url="<?php echo site_url(); ?>/cetak_rka/preview_rka_skpd_penetapan/"+ctglttd+'/'+ttd+'/'+ttd2+'/'+ckdskpd+'/'+cetak+'/detail/'+tipe_doc+'/'+cgaji+'/Cetak_RKA'+ckdskpd;            
        }
    ...
    function cetakbawah(){
        ...
        if(cekbok==false){
            url="<?php echo site_url(); ?>/cetak_rka/preview_rka_skpd_penetapan/2020-1-1/tanpa/tanpa/"+ckdskpd+"/0/hide/"+tipe_doc+"/"+cgaji+"/aa"; 
        }else{
            url="<?php echo site_url(); ?>/cetak_rka/preview_rka_skpd_penetapan/2020-1-1/tanpa/tanpa/"+ckdskpd+"/0/detail/"+tipe_doc+"/"+cgaji+"/aa";
        }
        if(ckdskpd!=''){
