      ...
      function cek_status(){
        ...
        function validate_giat(){
            ...
            onSelect:function(rowIndex,rowData){
				...
				cekgj = (rowData.kd_kegiatan).substr(16,5);
				if((cekgj=='00.001') || (cekgj=='00.002')){
					document.getElementById('nilairek').disabled = true;
				}else{
					document.getElementById('nilairek').disabled = true;
				}                  
                document.getElementById('nilairek').value   = 0;
                document.getElementById('nilairekcek').value   = 0;
...
*/			
        ...
        function validate_combo(){
			...
			$('#dg').edatagrid({
				 ...
				 onSelect:function(rowIndex,rowData){
                              ...
                              $("#nilairekcek").attr("value",vvnilai);
		...
		function hapus(){
				...
				var nil_ang = document.getElementById('nilairek').value ;
               // alert(nil_ang);
				...
				if  (del==true){
					$(function(){
						$('#dg').edatagrid({
							 url: '<?php echo base_url(); ?>/index.php/rka_ro/thapus_ro/'+cskpd+'/'+cgiat+'/'+rek,
							 idField:'id',
							 toolbar:"#toolbar",              
							 rownumbers:"true", 
							 fitColumns:"true",
		...
		function hapus_rinci(){
            ...
            for (i=0; i < rows.length; i++) {
                ...
                alert("Rincian Telah dihilangkan, Jika Telah Sesuai Silahkan Simpan Kembali");
                    /*
                    $(document).ready(function(){
                        $.ajax({
                               type     : 'POST',
        ...
        */
        ...
        if ( rows.length == 0 ) {
            ...
            $.ajax({
                    ...
                    url      : '<?php echo base_url(); ?>index.php/rka_ro/thapus_rinci_ar_all_ro',
                    success  : function(data){
                               }    
                        });
                    });
	...
	/*		cvolume2  = rows[i].volume2;
            ...
            if ( i > 0 ) {
                csql = csql+","+"('"+cgiat+"','"+crek+"','"+no+"','"+cheader+"','"+ckode+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume2+"','"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"','"+cvolume+"','"+cvolume+"','"+cvolume1+"','"+cvolume1+"','"+cvolume3+"','"+cvolume+"','"+csatuan1+"','"+csatuan1+"','"+csatuan3+"','"+charga1+"','"+ctotal+"','"+charga1+"','"+ctotal+"')";
            } else {
                csql = "values('"+cgiat+"','"+crek+"','"+no+"','"+cheader+"','"+ckode+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume2+"','"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"','"+cvolume+"','"+cvolume+"','"+cvolume1+"','"+cvolume1+"','"+cvolume3+"','"+cvolume+"','"+csatuan1+"','"+csatuan1+"','"+csatuan3+"','"+charga1+"','"+ctotal+"','"+charga1+"','"+ctotal+"')";                                            
        ...
        $(document).ready(function(){
                $.ajax({
                    type     : "POST",   
                    dataType : 'json',                 
                    data     : ({no:norka,sql:csql,cskpd:cskpd,giat:cgiat,dana1:sdana1,dana2:sdana2,dana3:sdana3,dana4:sdana4,
								vdana1:ndana1,vdana2:ndana2,vdana3:ndana3,vdana4:ndana4,crek:crek}),
    ...
    function tambah(){
        ...
        var nmrek5 = document.getElementById('nmrek5').value;
        var nrekcek= angka(document.getElementById('nilairekcek').value) ;
        ...
        var n_sisakua   = angka(document.getElementById('sisa_nilai_kua').value) ;
         ...
         if(nrekawal!=nrek){
            //alert(nrekawal+'/'+nrek);
            alert('Nilai Detail tak sesuai silahkan cek lagi!!!');
            return;
        }
       ...
       if(lkegi!=22){
        ...
        if(sdana1=='' && ndana1>0){
            alert('sumber dana tak boleh kosong');
            return;
        }
        ...
        */
        ...
        $.ajax({
           ...
           url      : '<?php echo base_url(); ?>index.php/rka/tsimpan_ar', 
           success  : function(data){
                      st12 = data;
                      if ( st12 == '1' ){
                        alert("Data Tersimpan...!!!");
    ...
    function pilih_edit(){
            ...
            if ( n_sisakuax < total_edit ){
                alert('Nilai Melebihi nilai KUA g');
                exit();
            }      
...
<h2><a href="#" id="section1" onclick="javascript:validate_combo()">Rekening Anggaran</a></h2>
   ...
   <div  style="height:700px;">      
       ...
       <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:170px;border-bottom-style:hidden;border-right-style:hidden;"><input id="nilairek" disabled name="nilairek" style="width:170px;text-align:right;" onkeypress="javascript:enter(event.keyCode,'add');return(currencyFormat(this,',','.',event))"/><input  type ="hidden" id="cek_kas" name="cek_kas" style="width:170px;text-align:right;"/>
        <input id="nilairekcek" type="hidden" name="nilairek" style="width:170px;text-align:right;" onkeypress="javascript:enter(event.keyCode,'add');return(currencyFormat(this,',','.',event))"/></td>
...
<h3><a href="#" id="section4" onclick="javascript:load_detail_keg();" >Detail Kegiatan</a></h3>
    ...
    <p id="stathead" style="font-size: x-large;color: red;">Inputan dibawah Terisi Sesuai Data Hasil Transfer dari Aplikasi SIPP !</p>
	<br />
	...
	<tr style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;">
		...
		<td colspan="3" style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" > <input disabled type="text" id="ang_lalu" style="width:190px;text-align: right;"  onkeypress="javascript:return(currencyFormat(this,',','.',event))"/></td>
		...
		<td style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" ><textarea disabled id="lokasi" name="lokasi" rows='2' cols="40" ></textarea></td>
		...
		<td style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;"><textarea disabled id="sasaran" name="sasaran" rows='2' cols="40"></textarea></td>
	</tr>
	<tr style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
		<td style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" ><b>Waktu</b></td>
		<td style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" ><textarea disabled id="wkeg" name="wkeg" rows='2' cols="40" > </textarea></td>
		<td style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" >&nbsp;&nbsp;</td>
	...
	<tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;">
		...
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;">&nbsp;&nbsp;</td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea disabled id="cp_tu" name="cp_tu" rows='2' cols="45" > </textarea></td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;">&nbsp;&nbsp;</td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea disabled id="cp_ck" name="cp_ck" rows='2' cols="45" > </textarea></td>
	</tr>
	<tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><b>Masukan</b></td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;">&nbsp;&nbsp;</td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea disabled id="m_tu" name="m_tu" rows='2' cols="45"  > </textarea></td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;">&nbsp;&nbsp;</td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea disabled id="m_ck" name="m_ck" rows='2' cols="45"  > </textarea></td>
	</tr>
	<tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><b>Keluaran</b></td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;">&nbsp;&nbsp;</td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea disabled id="k_tu" name="k_tu" rows='2' cols="45" > </textarea></td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" >&nbsp;&nbsp;</td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea disabled id="k_ck" name="k_ck" rows='2' cols="45" > </textarea></td>
	</tr>
	<tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><b>Hasil</b></td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;">&nbsp;&nbsp;</td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea disabled id="h_tu" name="h_tu" rows='2' cols="45" > </textarea></td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;">&nbsp;&nbsp;</td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea disabled id="h_ck" name="h_ck" rows='2' cols="45" > </textarea></td>
	</tr>
	</table>
        <div id="toolbar1xa" >
    		<!--<button id="save4" class="easyui-linkbutton" iconCls="icon-save" plain="true" disable ="true" onclick="javascript:simpan_det_keg()">Simpan</button>-->
    		<button class="easyui-linkbutton" iconCls="icon-back" plain="true" onclick="javascript:section1()">Kembali</button>
        </div>
    </fieldset>    
	</div>   
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening">
    ...
    <table border='0' style="width:800px;">
        ...
        <button class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:pilih_edit();">Perbaiki</button>
