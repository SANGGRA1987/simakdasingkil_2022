<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    cek_status(kode);
        ...
        $(function(){  
          ...
          $(function(){  
           $('#dg_ckeg').edatagrid({
                url           : '<?php echo base_url(); ?>/index.php/rka/cs_kegi_ubah/'+kode,
                 idField      : 'id',
                 toolbar      : "#toolbar",              
                 rownumbers   : "true", 
                 fitColumns   : "true",
 ...
 function tombol2(stax){  
    ...
    function cek($cetak,$ckdskpd,$ckdgiat,$nmgiat){
         ...
         if(x=='semua'){
            ...
            url="<?php echo site_url(); ?>/rka/preview_rka221_murni/"+$ckdskpd+'/'+$ckdgiats+'/'+$cetak+'/'+cpa+'/'+cell
            openWindow( url );
            ...
            $cnmgiats = $nmgiat;
            $cnmgiatx  = $cnmgiats.split("/" && ",").join(" ");
            url="<?php echo site_url(); ?>/rka/preview_rka221_murni/"+$ckdskpd+'/'+$ckdgiat+'/'+$cetak+'/'+cpa+'/'+cell
            openWindow( url );
        
        } 
    }

        function ceker($cetak,$ckdskpd,$ckdgiat,$nmgiat){
         //var ckdskpd = $kegiatan->kd_skpd;
         //var cgiat = $kegiatan->kd_skpd;
         var stat_ang = status_data_ang;
         //  alert(stat_ang);
         ...
         if(x=='semua'){
            ...
            $cnmgiats  = rows[p].nm_kegiatan;        
            $cnmgiatx = $cnmgiats.split("/" && ",").join(" ");
            url="<?php echo site_url(); ?>/allprint/printall_rka221_murni/"+$ckdskpd+'/'+$ckdgiats+'/'+$cetak+'/'+cpa+'/'+cell
            openWindow( url );
            ...
            $cnmgiats = $nmgiat;
            $cnmgiatx  = $cnmgiats.split("/" && ",").join(" ");
            url="<?php echo site_url(); ?>/allprint/printall_rka221_murni/"+$ckdskpd+'/'+$ckdgiat+'/'+$cetak+'/'+cpa+'/'+cell
            openWindow( url );
 ...
 function openWindow( url ){
    ...
    <div id="content">        
        <h1><?php echo 'DAFTAR KEGIATAN' ?><span><a href="<?php echo site_url(); ?>/rka/dpa221">Kembali</a></span></h1>
                ...
                <div id="div_bend">
                        <table style="width:100%; align:right;" border="0">
                            <td>Cetak Semua ke PDF<a class="easyui-linkbutton" plain="true" onclick="javascript:cek(3,'','semua');return false">                    
                                ...
                                <button style="background:  #008000; color: white; border: none;">Cetak Semua Satu File</button>
                                <a class="easyui-linkbutton" plain="true" onclick="javascript:ceker(3,'<?php echo $kode_skpd; ?>','all','');return false">                    
                                <img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a>
                            </td> 
                        </table>
                </div>
        ...
        <table class="narrow">
            ...
            <tr>
                ...
                <td>
                    <a class="easyui-linkbutton" plain="true" onclick="javascript:cek(2,'<?php echo $kegiatan->kd_skpd; ?>','<?php echo $kegiatan->giat; ?>','<?php echo $kegiatan->nm_kegiatan; ?>');return false" >
                    <img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="preview"/></a>
                    <a class="easyui-linkbutton" plain="true" onclick="javascript:cek(3,'<?php echo $kegiatan->kd_skpd; ?>','<?php echo $kegiatan->giat; ?>','<?php echo $kegiatan->nm_kegiatan; ?>');return false">                    
                    <img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a>
