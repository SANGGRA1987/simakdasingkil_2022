                ...
                onSelect:function(rowIndex,rowData){
                    ...
                    $(function(){      
                     $.ajax({
                        ...
                        url:"<?php echo base_url(); ?>index.php/rka_ro/total_triwulan/nilai_ubah",
                        dataType:"json",
    ...
    function simpan(){
        ...
        $(function(){      
         $.ajax({
            ...
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/rka_ro/simpan_trskpd_ubah_ro",
            success:function(data){
                if (data = 1){
    ...
    function load(){         
        ...
        $(function(){      
         $.ajax({
            ...
            url:"<?php echo base_url(); ?>index.php/rka_ro/load_trdskpd_ubah",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    bulan = n['bulan'];
