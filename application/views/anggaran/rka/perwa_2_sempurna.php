<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function cek($cetak){
		...
		if ($('input[name="chkrinci"]:checked').val()=='1'){
		 ...
		 var cell = document.getElementById('cell').value;
            url="<?php echo site_url(); ?>/rka/preview_perwa2_sempurna/"+ckdskpd+'/'+$cetak+'/'+cell+'/'+ctglttd+'/Report DPA-1'+'/'+crinci,
	...
	<div id="content">        
		...
		<tr>
                <td><input type="checkbox" name="chkrinci" id="chkrinci" value="1" /> MUNCULKAN SELISIH
                </td>
                <td>&ensp;</td>
                <td>&nbsp;</td>
            </tr>
