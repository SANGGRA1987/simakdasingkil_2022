<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function cek($cetak,$jns){
        url="<?php echo site_url(); ?>/rka/preview_perdaII_sempurna/"+$jns+"/"+$cetak+"/Lampiran Perda II Pergeseran"+$jns;
        openWindow( url);
    }
...
if($url==base_url("/index.php/rka/perda_II_sempurna")){
    $hidden="hidden";
}else{
    $hidden="";
} 
