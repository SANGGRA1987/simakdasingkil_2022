<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function cek($cetak,$jns){
         ...
         if (document.getElementById("chksetda").checked == true){
            var csetda = '1';
         }else{
            var csetda   = '0';
         } 
         ...
         if ($('input[name="chkcover"]:checked').val()=='1'){
            url="<?php echo site_url(); ?>/rka/preview_coverdppa1/"+ckdskpd+'/'+$cetak+'/Report Cover DPPA-1 Perubahan'
         }else{
            ...
            url="<?php echo site_url(); ?>/rka/preview_dppa1_ubah/"+ckdskpd+'/'+$cetak+'/'+cpa+'/'+cell+'/'+csetda+'/Report DPPA-1 Perubahan'
         } 
 ...
 function openWindow( url,$jns ){
           ...
           if ((ttd_2=='' ) || (ttd_1=='' )){
                    alert("Harap isi kedua penandatangan !"); 
                return;
                }
         ...
         if ($('input[name="chkppkd"]:checked').val()=='1'){
		   ...
		   alert("Penanda tangan 1 atau tanggal Tanda tangan tidak boleh kosong");
            ...
            lc = '?tgl_ttd='+ctglttd+'&ttd1='+ttd1+'&ttd2='+ttd2+'&cttx='+cttx+'';
			window.open(url+lc,'_blank');
			window.focus();
	...
	<div id="content">        
		...
		<td colspan="4">
            ...
            <tr>
                ...
                <td><input  type="checkbox" hidden ="true"  name="chkpa" id="chkpa" value="1" />
                </td>
                <td>&ensp;</td>
                <td>&nbsp;</td>
                <td><input hidden type="checkbox" name="chkcover" id="chkcover" value="1" /> <!-- Cetak Cover -->
                </td>
                <td><input type="checkbox" hidden ="true" name="chksetda" id="chksetda" value="1" />
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ukuran Baris  : &nbsp;<input type="number" id="cell" name="cell" style="width: 50px; border:1" value="1" /> &nbsp;&nbsp;</td>
                <td>&nbsp;</td>
