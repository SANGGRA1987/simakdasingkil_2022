...
<head>
     ...
     $(document).ready(function() {
      ...
      $(function(){
        $('#cc').combogrid({  
         ...
         $(function(){ 
         $('#dg').edatagrid({
    		url: '<?php echo base_url(); ?>/index.php/rka/kegi_sumber_rancang',
            idField:'id',
            toolbar:"#toolbar",              
            rownumbers:"true", 
            fitColumns:"true",
      ...
      function giat(kode){
        $(function(){  
            $('#dg').edatagrid({
    		  url: '<?php echo base_url(); ?>/index.php/rka/kegi_sumber_rancang/'+kode
            });
        });
      }
    ...
    function simpan(){
        ...
        */
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>/index.php/rka/update_sumber_kegi_rancang',
...
<div id="accordion">
<h3><a href="#" id="section1">Sumber Dana Per Kegiatan</a></h3>
   <div  style="height: 350px;">
   <p>  
        <h3>S K P D&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="cc" name="skpd" style="width: 400px;"/> </h3>
        <h3>&nbsp;</h3>
        <h3 style="color: red;">"*)Pilih Kode PD, lalu double click kegiatan pada tabel untuk edit !"</h3>
