...
<script src="<?php echo base_url(); ?>assets/js/select2.min.js"></script>   
    ...
    $(function(){
           ...
           $('#dg').edatagrid({
            ...
            $("#sdana1").combogrid({
                ...
                textField :'nm_sdana',
                mode      :'remote',
                url       : '<?php echo base_url(); ?>index.php/anggaran_geserController/ambil_sdana',
            ...
            textField:'kd_skpd',  
            mode:'remote',
            url:'<?php echo base_url(); ?>index.php/anggaran_geserController/skpduser',  
            columns:[[  
    ...
    function get_skpd(kd_s='',nm_s='',st_s='') {
      ...
      function cek_status(kdskpd){
            $.ajax({
                url:'<?php echo base_url(); ?>index.php/anggaran_geserController/config_skpd2',
                type: "POST",
                dataType:"json",
                data      : ({kdskpd:kdskpd}),                         
                success:function(data){
                                        sta    = data.status_sem;
                                        kunci    = data.kunci_geser;
                                        tombol(sta,kunci);
                                      }                                     
            });        
       }
      ...
      function kunci_inputan(){
        ...
        function get_nilai_kua()
        {
            ...
            $.ajax({
                ...
                url:'<?php echo base_url(); ?>index.php/anggaran_geserController/load_nilai_kua_rancang/'+kdskpd,
        ...
        function cek_transaksi(){
            ...
            $.ajax({
               ...
               url       : '<?php echo base_url(); ?>/index.php/anggaran_geserController/cek_transaksi',
               type      : 'POST',
               dataType  : 'json',
        ...
        function validate_giat(){
            ...
            mode       : 'remote',
            url        : '<?php echo base_url(); ?>index.php/anggaran_geserController/pgiat_rancang/'+kdskpd,  
            columns    : [[  
        ...
        function validate_rekening(){
            ...
            $('#kdrek5').combogrid({  
               ...
               textField  : 'kd_rek6',  
               mode       : 'remote',
               url        : '<?php echo base_url(); ?>index.php/anggaran_geserController/ambil_rekening5_all_ar',  
        ...
        function get_realisasi(){
            ...
            $.ajax({
                ...
                url:'<?php echo base_url(); ?>index.php/anggaran_geserController/get_realisasi/'+kdskpd,
        ...
        function validate_combo(){
            ...
            $(function(){
            $('#dg').edatagrid({
                 url: '<?php echo base_url(); ?>/index.php/anggaran_geserController/select_rka_rancang/'+cgiat+'/'+cskpd,
                 idField     : 'id',
                 toolbar     : "#toolbar",              
                 rownumbers  : "true", 
                 fitColumns  : "true",
    ...
    function load_sum_real(){                
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b}),
            url:"<?php echo base_url(); ?>index.php/anggaran_geserController/get_realisasi_keg",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
        ...
        function get_nilai_real_rek(){
            ...
            $.ajax({           
                url:'<?php echo base_url(); ?>index.php/anggaran_geserController/get_realisasi_rek/'+kdskpd,
                type: "POST",
                dataType:"json",  
        ...
        function hapus(){
                ...
                if ( nilai_rekening_murni > 0 ){
                    alert("DATA APBD MURNI TIDAK DAPAT DI HAPUS...!!!");
                    exit();
                }
                ...
                if  (del==true){
                    ...
                    $(function(){
                        $('#dg').edatagrid({
                             url: '<?php echo base_url(); ?>/index.php/anggaran_geserController/thapus_rancang/'+cskpd+'/'+cgiat+'/'+rek,
                             idField:'id',
                             toolbar:"#toolbar",              
                             rownumbers:"true", 
                             fitColumns:"true",
        ...
        function hapus_rinci(){
                ...
                if(nilai_rekening_rincian_murni > 0){
                    alert("APBD MURNI TIDAK DAPAT DIHAPUS");
                    exit();
                }
                ...
                if ( cfm == true ){
                    ...
                    $(document).ready(function(){
                        $.ajax({
                               ...
                               url      : '<?php echo base_url(); ?>index.php/anggaran_geserController/hapus_rincian_dpo',
                               success  : function(data){
                                    if(data=="7"){
...
/*==========untuk update apabila rincian tidak diisi*/
        ...
        if ( rows.length == 0 ) { 
            ...
            $.ajax({
                    ...
                    url      : '<?php echo base_url(); ?>index.php/anggaran_geserController/thapus_rinci_ar_all_rancang',
                    success  : function(data){
...
/*end ==========untuk update apabila rincian tidak diisi*/       
        ...
        $(document).ready(function(){
                $.ajax({
                    ...
                    url      : '<?php echo base_url(); ?>/index.php/anggaran_geserController/tsimpan_rinci_jk_rancang',
                    success  : function(data) {
                        status = data.pesan;
                        if (status == '1') {
                            $("save1").show();
    ...
    /*id,header,no_po,kode,kd_barang,uraian,volume1,satuan1,volume2,satuan2,volume3,satuan3,volume,harga1,total */                         
                ...
                columns:[[ 
                    ...
                    {field:'spesifikasi_sempurna',
                     title:'Spesifikai',
                     width:500,
                    },
                    {field:'koefisien_sempurna',
                     title:'Koefisien',
                     width:200,
                     align:'left'
                     },
                    ...
                    {field:'pajak_sempurna',
                     title:'Pajak (%)',
                     width:50,
                     align:'right'
                     },
                    {field:'harga_sempurna',
                     title:'Harga',
                     width:110,
                     align:'right'
                     },
                    {field:'total_sempurna',
                     title:'Total+Pajak Geser',
                     width:150,
                     align:'right',
                     styler: function(value,row,index){
        ...
        function section(kdrek){
           ...
           if ( mgiat=='' ){
            ...
            $(document).ready(function(){
                ...
                $(function(){
                    $('#dg1').edatagrid({
                         url          : '<?php echo base_url(); ?>/index.php/anggaran_geserController/rka_rinci_rancang/'+mskpd+'/'+mgiat+'/'+kdrek,
                         idField      : 'id',
                         toolbar      : "#toolbar1",              
                         rownumbers   : "true", 
                         fitColumns   : false,
                         ...
                         onSelect     : function(rowIndex,rowData){
                                       ...
                                       $("#spesifikasi_edit").attr("value",rowData.spesifikasi_sempurna);
                                       ...
                                       $("#volume1_edit").attr("value",rowData.volume_sempurna1);
                                       $("#volume2_edit").attr("value",rowData.volume_sempurna2);
                                       $("#volume3_edit").attr("value",rowData.volume_sempurna3);
                                       $("#volume4_edit").attr("value",rowData.volume_sempurna4);
                                       ...
                                       $('#satuan1_edit').val(rowData.satuan_sempurna1).trigger("change");
                                       $('#satuan2_edit').val(rowData.satuan_sempurna2).trigger("change");
                                       $('#satuan3_edit').val(rowData.satuan_sempurna3).trigger("change");
                                       $('#satuan4_edit').val(rowData.satuan_sempurna4).trigger("change");

                         
                                       $("#sat1_edit").attr("value",rowData.satuan_sempurna1);
                                       $("#pajak_edit").attr("value",rowData.pajak_sempurna);

                                       $("#harga_edit").attr("value",rowData.harga_sempurna);
                                       $("#nomor_insert").attr("value",rowData.no_po) ;
                                       
                                       
                                       var vol1_e  = rowData.volume_sempurna1 ;
                                       var harga_e = rowData.harga_sempurna ;
                                       

                                       var ntotal_edit = rowData.total_sempurna;
    ...
    function load_sum_rek(){   /*total nilai satu kegiatan*/             
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b}),
            url:"<?php echo base_url(); ?>index.php/anggaran_geserController/load_sum_rek_rancang",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
    ...
    function load_sum_rek_rinci(c){     /* rincian rekening trdpo*/          
        ...
        $(function(){      
         $.ajax({
            ...
            url:"<?php echo base_url(); ?>index.php/anggaran_geserController/load_sum_rek_rinci_rancang",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){

                    $("#rektotal_rinci").attr("value",n['rektotal_rinci_geser']);
                });
            }
         });
        });
    ...
    function tambah(){
        ...
        $.ajax({
           ...
           data     : ({kd_skpd:skpd,kd_kegiatan:kegi,kd_rek5:reke,nilai:nrek,dana1:sdana1,dana2:sdana2,dana3:sdana3,dana4:sdana4,
                        vdana1:ndana1,vdana2:ndana2,vdana3:ndana3,vdana4:ndana4}),
           url      : '<?php echo base_url(); ?>index.php/anggaran_geserController/tsimpan_ar_geser', 
           success  : function(data){
                      st12 = data;
                      if ( st12 == '1' ){
                        $("#proses").hide();
    ...
    function simpan_det_keg(){
        ...
        $(function(){      
         $.ajax({
            ...
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/anggaran_geserController/simpan_det_keg_rancang",
            success:function(data){ 
                    alert('Data Tersimpan');
                    }
         });
    ...
    function load_detail_keg(){  /*untuk menampilkan Indikator*/            
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b}),
            url:"<?php echo base_url(); ?>index.php/anggaran_geserController/load_det_keg_rancang",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
...
/*==================  */    
                 ...
                 $.ajax({
                    ...
                    data: ({
                        ...
                        skpd:cskpd}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/anggaran_geserController/simpan_rincian_dpo_geser",
                    success:function(data){
                        alert('Data Tersimpan');
                        $("#loading").hide();
                        $('#kod').show();
...
/*===============*/
    ...
    function edit_rincian_po(){ /*ini untuk sementara */
            ...
            $(function(){      
                 $.ajax({
                    ...
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/anggaran_geserController/update_rincian_dpo_sementara_geser",
                    success:function(data){ 
                        $("#loading").hide();
                        $("#dialog-modal-edit").dialog('close');
                        $("#dg1").datagrid("reload");
                ...
                $(function(){      
                 $.ajax({
                    ...
                    data: ({
                        ...
                        sdana1:sdana1}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/anggaran_geserController/update_rincian_dpo_geser",
                    success:function(data){ 
                        $("#dg1").datagrid("reload");
                        section(crek);
                        $("#loading").hide();
    ...
    function subheader(){
            ...
            $('#kode_header').combogrid('clear');
                $(function(){      
                    ...
                    textField  : 'uraian',  
                    mode       : 'remote',
                    url        : '<?php echo base_url(); ?>index.php/anggaran_geserController/subheader',
    ...
    function standardharga(kdrek) {
                ...
                $(function(){      
                    ...
                    textField  : 'uraian',  
                    mode       : 'remote',
                    url        : '<?php echo base_url(); ?>index.php/anggaran_geserController/standarhargasipd',
                    queryParams: ({kdrek:kdrek}),
                    columns   : [[
                        {field:'nama_standar_harga',title:'Standar Harga',width:300},
                        {field:'harga_preview',title:'Harga',width:100, align:'right'},   
                        {field:'satuan',title:'Satuan',width:70}, 
                        {field:'spek',title:'Spesifikasi',width:1000}, 
                    ]],
                    onSelect :function(rowIndex,rowData){
                       ...
                       $('#sat1').attr("value",rowData.satuan);
                       $('#spesifikasi').attr("value",rowData.spek);
                       $('#harga').attr("value",rowData.harga);
                       $('#total_dpo').attr("value", rowData.harga);
                    ...
                    onSelect :function(rowIndex,rowData){
                       ...
                       $('#sat1_edit').attr("value",rowData.satuan);
                       $('#spesifikasi_edit').attr("value",rowData.spek);
                       $('#harga_edit').attr("value",rowData.harga);
                       $('#total_dpo_edit').attr("value", rowData.harga);
                    }
    ...
    <div> <div id="dpo">
      ...
      <div style="display: inline-block;  position: absolute;">
          <div style="display: block; padding-right: 10px; width: 100%">
            ...
            <!--    6. Selengkapnya <a href="#">klik disini</a> -->
      ...
      <div style="padding: 10px; ">
          <div style="display: inline-block;" >
            ...
            <input  type="number" class="input" name="volume1" id="volume1" onkeyup="javascript:total_dpo();" onchange="javascript:total_dpo();" step="0.01" min="0" style="display: inline-block;" placeholder="Volume 1"><?php echo $this->rka_model->satuan('satuan1','onkeyup="javascript:total_dpo();"'); ?> <br>
            <input type="number" class="input" name="volume2" id="volume2" onkeyup="javascript:total_dpo();" onchange="javascript:total_dpo();" step="0.01" min="0" style="display: inline-block;" placeholder="Volume 2"><?php echo $this->rka_model->satuan('satuan2','onkeyup="javascript:total_dpo();"'); ?> <br>
            <input  type="number" class="input" name="volume3" id="volume3" onkeyup="javascript:total_dpo();" onchange="javascript:total_dpo();" step="0.01" min="0" style="display: inline-block;" placeholder="Volume 3"><?php echo $this->rka_model->satuan('satuan3','onkeyup="javascript:total_dpo();"'); ?> <br>
            <input  type="number" class="input" name="volume4" id="volume4" onkeyup="javascript:total_dpo();" onchange="javascript:total_dpo();" step="0.01" min="0" style="display: inline-block;" placeholder="Volume 4"><?php echo $this->rka_model->satuan('satuan4','onkeyup="javascript:total_dpo();"'); ?> <br>
          </div>
            ...
            <tr style="border-style: hidden;">
                ...
                <td style="border-style: hidden;">
                 ...
                 <td align='right' style="border-style: hidden;">
                    <B>Total</B>&nbsp;&nbsp;&nbsp;&nbsp;<input class="input" type="text" name="rektotal_rinci" id="rektotal_rinci"  style="width:200px;text-align: right;" align="right" readonly="true" />  <br>
                    <b>REALISASI REKENING
                        <input class="input" type="text" name="nreal_rek" id="nreal_rek"  style="width:200px;text-align: right;" align="right" readonly="true" /> 
                    </td>
                ...
                <tr>
                    ...
                    <td hidden align='right' style="border-style: hidden;">
                        <B>Sisa KUA</B>&nbsp;&nbsp;&nbsp;&nbsp;<input class="right" type="text" name="sisa_kua2" id="sisa_kua2"  style="width:200px;text-align: right;" align="right" readonly="true" />
                    </td>
                </tr>
                <tr hidden>
                    <td style="border-style: hidden;"></td>
                    <td align='right' style="border-style: hidden; width=50%">
                        <B>Ang. Rekening</B>&nbsp;&nbsp;<input class="right" type="text" name="nilai_kua_rek" id="nilai_kua_rek"  style="width:200px;text-align: right;" align="right" readonly="true" />
                ...
                <tr >
                    <td style="border-style: hidden;"></td>
                    <td align='right' style="border-style: hidden; width=50%">
                        <B>Sisa KUA + Rek.</B>&nbsp;&nbsp;<input class="right" type="text" name="total_sisa_kua_rek" id="total_sisa_kua_rek"  style="width:200px;text-align: right;" align="right" readonly="true" />
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening">
  ...
  <div>
      ...
      <div style="padding: 10px;">
        <div style="display: inline-block;">Pajak (%)<input type="number" id="pajak_edit" style="width: 90px;"class="input" /></div>
        <div style="display: inline-block;">Satuan <input  type="text" id="sat1_edit" style="width: 104px;" class="input" /></div>
        <div style="display: inline-block;">Harga <input  class="input" type="text" id="harga_edit" style="width: 175px; text-align: right;" onkeypress="javascript:return(currencyFormat(this,',','.',event))"  />
      ...
      <div style="padding: 10px; ">
          <div style="display: inline-block;">
            Koefisien (Perkalian) <br>
            <input type="number" class="input" name="volume1_edit" id="volume1_edit" step="0.01" min="0" style="display: inline-block;" placeholder="Volume 1"><?php echo $this->rka_model->satuan('satuan1_edit',''); ?> <br>
            <input type="number" class="input" name="volume2_edit" id="volume2_edit" step="0.01" min="0" style="display: inline-block;" placeholder="Volume 2"><?php echo $this->rka_model->satuan('satuan2_edit',''); ?> <br>
            <input type="number" class="input" name="volume3_edit" id="volume3_edit" step="0.01" min="0" style="display: inline-block;" placeholder="Volume 3"><?php echo $this->rka_model->satuan('satuan3_edit',''); ?> <br>
            <input type="number" class="input" name="volume4_edit" id="volume4_edit" step="0.01" min="0" style="display: inline-block;" placeholder="Volume 4"><?php echo $this->rka_model->satuan('satuan4_edit',''); ?> <br>
          </div>
      </div>
