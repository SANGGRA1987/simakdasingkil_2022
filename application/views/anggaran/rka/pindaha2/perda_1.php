<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function cek($cetak){
        ...
        url="<?php echo site_url(); ?>/rka/preview_perda1/"+$cetak+'/'+chkrancang;
        openWindow( url);
    }

	function print_csv(){
		var url    = "<?php echo site_url(); ?>/cperda_1/cetak_perda1";          
		window.open(url+'/991947_Murni', '_blank');
		window.focus();
    }
	...
	<div id="content">      
    	...
    	<h1><?php echo $page_title; ?><br /><br/>
          ...
          <tr >
            <td width="20%" style="border: none;">TANGGAL TTD</td>         
            <td width="1%" style="border: none;">:</td>            
            <td style="border: none;"><input type="text" id="tgl_ttd" style="width: 100px;" />
                &nbsp;&nbsp;<input type="checkbox" name="chkrancang" id="chkrancang" value="1"/> Rancangan
            </td> 
          </tr>
          <tr>
        ...
        <tr>
            <td> 
                    ...
                    <a class="easyui-linkbutton" plain="true" onclick="javascript:print_csv();return false">                    
                    <img src="<?php echo base_url(); ?>assets/images/icon/csv.png" width="25" height="23" title="cetak csv"/></a>
        </tr>
