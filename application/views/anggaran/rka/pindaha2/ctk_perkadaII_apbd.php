	...
	function cek($cetak,$jns){
        ...
        if ($jns=='all'){
             var corg = 'all';       
 	          ...
 	          url="<?php echo site_url(); ?>/rka/preview_perkadaII_apbd/"+corg+'/'+$cetak+'/'+chkrancang+'/Laporan Penjabaran APBD-'+corg+'';
 ...
 function openWindow( url,$jns ){
	...
	<div id="content">        
        ...
        <table style="width:100%;" border="0"> 
            <tr>
    			<td width="15%" style="border: none;">SKPD</td>
                <td width="1%" style="border: none;">:</td>
                <td style="border: none;"><input type="text" id="corg" style="width: 100px;" />&nbsp;&nbsp;<input type="text" id="nmorg" readonly="true" style="width: 605px;border:0" />
                </td> 
            </tr>
            <tr>
