...
<div id="dialog-modal" title="">
    <fieldset>
     ...
     <option value="2">PENYEMPURNAAN 1</option>
     <option value="3">PENYEMPURNAAN 2</option>
     <option value="4">PENYEMPURNAAN 3</option>
     <option value="5">PENYEMPURNAAN 4</option>
     <option value="6">PENYEMPURNAAN 5</option>
     <option value="7">PERUBAHAN</option>
	 </select>
