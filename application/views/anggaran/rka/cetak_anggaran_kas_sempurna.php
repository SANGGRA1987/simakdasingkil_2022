   ...
   function cetak($ctk)
        {
			...
			if(cetak==2){
				url="<?php echo site_url(); ?>/rka/preview_anggaran_kas_sempurna/"+skpd+'/'+cetak+'/'+cell+'/Report_Anggaran_Kas_Sempurna'+skpd+'.xls';
			}else{
	           url="<?php echo site_url(); ?>/rka/preview_anggaran_kas_sempurna/"+skpd+'/'+cetak+'/'+cell+'/Report_Anggaran_Kas_Sempurna'+skpd;
			}
