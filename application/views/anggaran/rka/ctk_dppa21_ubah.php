<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    var ctk = '';
		...
		$(function(){  
            $('#ttd1').combogrid({  
                ...
                textField:'nama',  
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/rka/load_ttd_pa',  
                columns:[[  
	...
	function cek($cetak,$jns){
         ...
         if ($('input[name="chkcover"]:checked').val()=='1'){
            url="<?php echo site_url(); ?>/rka/preview_coverdppa21/"+ckdskpd+'/'+$cetak+'/Report Cover DPPA-2.1 -'+ckdskpd
         }else{
            ...
            url="<?php echo site_url(); ?>/rka/preview_dppa21_ubah/"+ckdskpd+'/'+$cetak+'/'+cpa+'/'+cell+'/Report_DPPA-2.1-Perubahan'+ckdskpd
         } 
	...
	<div id="content">        
        ...
        <td colspan="4">
                <div id="div_bend">
                        <table style="width:100%;" border="0">                          
                            ...
                            <!--<td width="10%"></td>
                            <td width="1%"></td>
                            <td><input type="text" hidden="true" id="ttd2" style="width: 200px;" /> 
                            </td>--> 
                        </table>
                </div>
        </td> 
		...
		<td colspan="4">
            ...
            <tr>
                ...
                <td>&ensp;</td>
                <td>&nbsp;</td>
                <td><input type="checkbox" hidden="true" name="chkcover" id="chkcover" value="1" />
                </td>
                <td>&ensp;</td>
                <td>&nbsp;</td>
