<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    function cek($cetak){
            ...
            url="<?php echo site_url(); ?>/rka/preview_rka0pkd/4.02.01.00/"+$cetak
         
         
        openWindow( url );
    }
    
     function cek_cover($cetak){
       
         
            url="<?php echo site_url(); ?>/rka/preview_coverrka0pkd/4.02.01.00/"+$cetak
    ...
    <div id="content">        
        ...
        <tr>
           ...
           <td> 
                    ...
                    <a class="easyui-linkbutton" plain="true" onclick="javascript:cek_cover(1);return false" >
                    <img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="preview"/></a>
                    <a class="easyui-linkbutton" plain="true" onclick="javascript:cek_cover(2);return false">                    
                    <img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="cetak"/></a>
           </td>    
        </tr>
