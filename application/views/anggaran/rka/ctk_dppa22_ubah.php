...
$(function(){
        ...
        $(function(){  
            $('#ttd1').combogrid({  
                ...
                textField:'nama',  
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/rka/load_ttd',  
                columns:[[  
	...
	function cek($cetak,$jns){
        ...
        url="<?php echo site_url(); ?>/rka/preview_dppa22_ubah/"+ckdskpd+'/'+$cetak+'/'+cpa+'/'+cell+'/Report DPPA-2 Perubahan-'+ckdskpd
		...
		<td colspan="4">
                <div id="div_bend">
                        <table style="width:100%;" border="0">							
							...
							<!--<td width="10%">PA</td>
                            <td width="1%">:</td>
                            <td><input type="hidden" id="ttd2" style="width: 200px;" /> 
                            </td>--> 
                        </table>
                </div>
        </td> 
