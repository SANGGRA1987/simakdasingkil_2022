...
/*		function get_nilai_kua()
        ...
        $(function(){      
         $.ajax({
            ...
            success:function(data){ 
                $.each(data, function(i,n){
                    total_ubah = angka(n['rektotal_rka_ubah']);
                    total_sem = angka(n['rektotal_rka_sempurna']);
                    total = angka(n['rektotal_rka']);
                    if(total_ubah>0){
                        alert('Nilai Perubahan belum 0. Tidak bisa dihapus');
                        return;
                    }else{
                        if(total_sem>0){
                            alert('Rekening Penyempurnaan tidak boleh dihapus');
                            return;
                        }else{
                            hapus2();
                        }
		...
		function hapus_rinci(){
                ...
                var total_sem  = angka(document.getElementById('total_edit_sem').value);
                ...
                if(total_sem > 0){
                    alert('Rincian Penyempurnaan tidak bisa dihapus.');
                    return;
				}
	...
	/*		
            ...
            if ( i > 0 ) {
                csql = csql+","+"('"+no+"','"+norka+"','"+cpenerima+"','"+calamat+"','"+ctotal+"','"+ctotal_sem+"','"+ctotal_ubah+"','"+no+"','"+cuser+"',getdate())";
            } else {
                csql = "values('"+no+"','"+norka+"','"+cpenerima+"','"+calamat+"','"+ctotal+"','"+ctotal_sem+"','"+ctotal_ubah+"','"+no+"','"+cuser+"',getdate())";                                            
        ...
        $(document).ready(function(){
                $.ajax({
                    ...
                    url      : '<?php echo base_url(); ?>/index.php/rka/tsimpan_alokasidanarinci_ubah_jk',
                    success  : function(data){                        
                        status = data.pesan; 
                         if (status=='1'){               
        			...
        			$('#dg1').edatagrid({
						 ...
						 onSelect     : function(rowIndex,rowData){
                                       ...
                                       */
                                       ...
                                       $("#total_edit").attr("value",rowData.total_ubah);
									   $("#totallama_edit").attr("value",rowData.total_ubah);
                                       $("#total_edit_susun").attr("value",rowData.total);
                                       $("#total_edit_sem").attr("value",rowData.total_sem);
    ...
    if (st=='1'){
       ...
       function insert_row() {
            ...
            $('#dg1').edatagrid('insertRow',{index:idx_ins,row:{cad1:idx_ins+1,penerima:penerima,alamat:alamat,total_ubah:total,total_sem:'0.00',total:'0.00'}});
            $("#dg1").datagrid("unselectAll");
   ...
   function append_save() {
			...
			//alert(''+id);
            $('#dg1').edatagrid('appendRow',{id:id,cad1:id+1,penerima:penerima,alamat:alamat,total_ubah:ftotal,total_sem:'0.00',total:'0.00'});
            $("#dg1").datagrid("unselectAll");
 ...
 /*    function pilih_std(){
    ...
    function pilih_edit(){
            ...
            $('#dg1').edatagrid('updateRow',{index:idx_ins_edit,row:{cad1:cad1_edit,penerima:penerima_edit,alamat:alamat_edit,total_ubah:ftotal_edit}});
            $("#dg1").datagrid("unselectAll");
   ...
   <div  style="height:700px;">      
       ...
       <table id="dg" title="Input Rekening Rencana Kegiatan Anggaran" style="width:880px;height:400px;" >          
        ...
        <div id="toolbarx">
            ...
            <B>Total Ubah</B>&nbsp;&nbsp;<input class="right" type="text" name="rektotal" id="rektotal"  style="width:200px;text-align:right;"  readonly="true"/>
            </td></tr>
			<tr>
			<tr><td align="right">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table border='0' style="width:800px;">
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
            <td colspan='8' style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
                ...
                <input type="text" id="total_edit_sem" style="width: 200px;" />
			</td>
