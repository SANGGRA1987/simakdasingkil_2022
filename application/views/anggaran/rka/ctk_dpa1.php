<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 if((stat_ang=='1') || (stat_rinci=='1')){
         ...
         if ($('input[name="chkcover"]:checked').val()=='1'){
            url="<?php echo site_url(); ?>/rka/preview_coverdpa1/"+ckdskpd+'/'+$cetak+'/Report Cover DPA-PENDAPATAN'
         }else{
            ...
            url="<?php echo site_url(); ?>/rka/preview_dpa1/"+ckdskpd+'/'+$cetak+'/'+cpa+'/'+cell+'/Report DPA-PENDAPATAN'
         } 
    ...
    function openWindow( url,$jns ){
        ...
        if ($('input[name="chkpa"]:checked').val()=='1'){
         ...
         if ($('input[name="chkppkd"]:checked').val()=='1'){
            ...
            lc = '/'+ctglttd+'/'+ttd1+'/'+ttd2+'/'+cttx+'/cetak dpa1?pilih='+pilihnya;
			window.open(url+lc,'_blank');
			window.focus();
