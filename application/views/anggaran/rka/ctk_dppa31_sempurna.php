<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function cek($cetak,$jns){
         ...
         if ($('input[name="chkcover"]:checked').val()=='1'){
            url="<?php echo site_url(); ?>/rka/preview_coverdpa31/"+ckdskpd+'/'+$cetak+'/Report Cover DPA-3.1 -'+ckdskpd
         }else{
            url="<?php echo site_url(); ?>/rka/preview_dppa31_sempurna/"+ckdskpd+'/'+$cetak+'//Report DPPA-3.1 Penyempurnaan -'+ckdskpd
         } 
