    ...
    $(document).ready(function(){
      ...
      function cek_status(){
        ...
        function validate_rekening(){
            ...
            var opd= document.getElementById('skpd').value;
            ...
            $('#kdrek5').combogrid({  
               ...
               queryParams: ({reknotin:zfrek,jns_kegi:jkegi,opd:opd}),
               columns    : [[  
...
*/			
    ...
    function simpan_det_keg(){
        ...
        var depan = angka(document.getElementById('ang_depan').value);
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data: ({skpd:a,giat:b,lokasi:c,sasaran:d,wkeg:e,cp_tu:f,cp_ck:g,m_tu:h,m_ck:i,k_tu:j,k_ck:k,h_tu:l,h_ck:m,ttd:n,lalu:lalu,depan:depan}),
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/rka_ro/simpan_det_keg",
            success:function(data){ 
                    alert('Data Tersimpan');
                    }
         });
         ...
         $.ajax({
            ...
            success:function(data){ 
                $.each(data, function(i,n){
                    ...
                    $("#ang_depan").attr("value",n['ang_depan']);
...
<h3><a href="#" id="section4" onclick="javascript:load_detail_keg();" >Detail Kegiatan</a></h3>
    ...
    <tr style="border-spacing:0px ;padding:0px 0px 0px 0px; border-collapse:collapse;border-style:hidden;">
        <td style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" ><b>Anggaran Tahun Lalu &nbsp; (n - 1)</b></td>
    ...
    <tr style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;">
        <td style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" ><b>Anggaran Tahun Depan (n + 1)</b></td>
        <td colspan="3" style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" > <input  type="text" id="ang_depan" style="width:190px;text-align: right;"  onkeypress="javascript:return(currencyFormat(this,',','.',event))"/></td> 
    </tr>   
    <tr style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;">
