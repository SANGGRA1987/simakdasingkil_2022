...
$(function(){  
    ...
    function cek_seluruh($cetak,$jns){
       var  ctglttd = $('#tgl_ttd').datebox('getValue');
        ...
        url="<?php echo site_url(); ?>/rka/preview_cetak_spd_bud/seluruh/"+$cetak+'/'+status_triw+'/'+ttd+'/'+ctglttd+'/Report-Regis-SPD'
  ...
  function cek_seluruh_2($cetak,$jns){
       var  ctglttd = $('#tgl_ttd').datebox('getValue');
        ...
        url="<?php echo site_url(); ?>/rka/preview_cetak_spd_bud_2/seluruh/"+$cetak+'/'+status_triw+'/'+ttd+'/'+ctglttd+'/Report-Regis-SPD'
