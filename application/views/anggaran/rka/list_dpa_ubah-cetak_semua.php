   ...
   cek_status_angkas(kode);
	...
	function cek_status(kode){
            ...
            $.ajax({
                ...
                type: "POST",
                dataType:"json",
                data      : ({kdskpd:$kd_skpd,rekk:'22',angg:'ubah'}),                         
       ...
       function cek_status_angkas(kode){
            ...
            $.ajax({
                ...
                type: "POST",
                dataType:"json",
                data      : ({kdskpd:$kd_skpd,rekk:$rek,angg:'ubah'}),                         
                success:function(data){
                                        stax    = data.hasilx;
                                        tombol2(stax);
                                      }                                     
...
function tombol2(stax){  
	...
	function cek($cetak,$ckdskpd,$ckdgiat,$nmgiat){
         ...
         if(x=='semua'){
            ...
            url="<?php echo site_url(); ?>/rka/preview_dpa221_ubah/"+$ckdskpd+'/'+$ckdgiats+'/'+$cetak+'/'+cpa+'/'+cell
            openWindow( url );
            ...
            $cnmgiats = $nmgiat;
            $cnmgiatx  = $cnmgiats.split("/" && ",").join(" ");
            url="<?php echo site_url(); ?>/rka/preview_dpa221_ubah/"+$ckdskpd+'/'+$ckdgiat+'/'+$cetak+'/'+cpa+'/'+cell
            openWindow( url );
 ...
 function openWindow( url ){
	...
	<div id="content">        
    	<h1><?php echo 'DAFTAR KEGIATAN PERUBAHAN' ?><span><a href="<?php echo site_url(); ?>/rka/dpa221_ubah">Kembali</a></span></h1>
        ...
        <td colspan="3">
                <div id="div_bend">
                        <table style="width:100%; align:right;" border="0">
                            <td>Cetak Semua ke PDF<a class="easyui-linkbutton" plain="true" onclick="javascript:cek(2,'','semua');return false">                    
        ...
        <table class="narrow">
            ...
            <?php $no=1; foreach($list->result() as $kegiatan) : ?>
            <tr>
                <td><?php echo $no; ?></td>
