...
<head>
    ...
    var total_pic =0;
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/rka_ro/ambil_rek_angkas_ro_penyempurna',
        idField:'id',
        toolbar:"#toolbar",              
        rownumbers:"true", 
        fitColumns:"true",
        ...
        columns:[[
          ...
          cnilai_ubah  = rowData.nilai_ubah;         
     ...
     function giat(kode){
          ...
          $(function(){  
            $('#ck').combogrid({
                ...
                columns:[[  
//                    {field:'kd_skpd',title:'skpd',width:130,hidden},
                ...
                onSelect:function(rowIndex,rowData){
                    ...
                    $("#total_pic2").attr("value",total);

                    $(function(){      
                     $.ajax({
                        type: 'POST',
                        data:({kegiatan:kegiatan}),
                        url:"<?php echo base_url(); ?>index.php/rka_ro/total_triwulan/nilai_ubah_penyempurna",
                        dataType:"json",
     ...
     function get(ckd_rek5,cnm_rek5,cnilai_ubah){
      ...
      function rek(kegiatan){
        $(function(){  
            $('#dg').edatagrid({
    		  url: '<?php echo base_url(); ?>/index.php/rka_ro/ambil_rek_angkas_ro_penyempurna/'+kegiatan
            });
        });
        load();                
      }
...
//        }
    ...
    function simpan(){
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data: ({csts:'susun',cskpda:kode,cskpd:skpdd,crek5:xrekening,cgiat:xkegiatan,jan:a,feb:b,mar:c,apr:d,mei:e,jun:f,jul:g,ags:h,sep:i,okt:j,nov:k,des:l,tr1:m,tr2:n,tr3:o,tr4:p}),
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/rka_ro/simpan_trskpd_ubah_ro_penyempurna",
            success:function(data){
                if (data = 1){
                    load();
    ...
    function load(){         
        ...
        $(function(){      
         $.ajax({
            ...
            url:"<?php echo base_url(); ?>index.php/rka_ro/load_trdskpd_ubah_penyempurna",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    bulan = n['bulan'];
...
<div id="accordion">
<h3><a href="#" id="section1">Anggaran Kas Belanja Perubahan RO</a></h3>
   ...
   <p>
        ...
        <h3>*Warna Orange Menunjukan Ada Selisih Penginputan </h3>
...
<h3><a href="#" id="section2"></a></h3>
    ...
    <div class="result">
        <table align="center">
            ...
            <tr>
                <td><b>Total Anggaran Kas Penyempurnaan Kegiatan</b></td>
            ...
            <tr>
                <td><b>Total Anggaran Kas Penyempurnaan</td>
