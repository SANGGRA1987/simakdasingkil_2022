 ...
 function tombol2(stax){  
	...
	function cek($cetak,$jns){
         ...
         if ($('input[name="chkcover"]:checked').val()=='1'){
            url="<?php echo site_url(); ?>/rka/preview_coverdpa21/"+ckdskpd+'/'+$cetak+'/Report Cover DPA-BELANJA -'+ckdskpd
         }else{
            ...
            url="<?php echo site_url(); ?>/rka/preview_dpa21/"+ckdskpd+'/'+$cetak+'/'+cpa+'/'+cell+'/Report BELANJA -'+ckdskpd
         } 
    ...
    function openWindow( url,$jns ){
        ...
        var ttd1 = ttd_1.split(" ").join("x");
         ...
         if ($('input[name="chkppkd"]:checked').val()=='1'){
            ...
            lc = '/'+ctglttd+'/'+ttd1+'/'+ttd2+'/'+cttx+'/DPA BELANJA?pilih='+pilihnya;
			window.open(url+lc,'_blank');
			window.focus();
		...
		<td colspan="4">
                <div id="div_bend">
                        <table style="width:100%;" border="0"> 
							<td width="20%">SKPD</td>
                            <td width="1%">:</td>
                            <td><input name="text" type="text" id="cunit" style="width: 180px;" />
