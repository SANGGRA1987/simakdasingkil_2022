                ...
                total = '0.00';
                 ...
                 $.ajax({
                    ...
                    data: ({
                        ...
                        unik:''}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/rka/simpan_rincian_dpo_geser",
                    success:function(data){ 
                        $("#dg1").datagrid("reload");
                        get_nilai_kua();
                        get_nilai_kua_rek();
                ...
                $(function(){      
                 $.ajax({
                    ...
                    data: ({
                        ...
                        unik:kode_unik}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/rka/update_rincian_dpo_geser",
                    success:function(data){ 
                        $("#dg1").datagrid("reload");
                        get_nilai_kua();
                        get_nilai_kua_rek();
...
<div id="content">
   ...
   &nbsp;&nbsp;<input id="nmskpd" name="nmskpd" readonly="true" style="width:600px;border:0;background-color:transparent;color: black;" /></td>
   </tr>
   <tr style="border-style:hidden;">
   <td>SUB KEGIATAN&nbsp;&nbsp;
     <input id="kdgiat" name="kdgiat" style="width:170px;" />  
   &nbsp;&nbsp;<input id="nmgiat" name="nmgiat" readonly="true" style="width:600px;border:0;background-color:transparent;color: black;" />
...
<h3><a href="#" id="section2">Rincian Rekening Pergeseran</a></h3>
    ...
    <div>
        ...
        <td style="border-style: hidden;">
            ...
            <button id="save1" class="easyui-linkbutton" iconCls="icon-save" hidden plain="true" onclick="javascript:detsimpan();">Simpan</button>
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening Pergeseran">
    ...
    <table border='0' style="width:800px;">
         <tr>
            ...
            <input type="text" hidden name="total_murni" id="total_murni">
