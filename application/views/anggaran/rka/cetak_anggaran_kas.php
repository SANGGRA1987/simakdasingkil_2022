...
<head>
  ...
  <style>    
    ...
    function cetak($ctk)
        {
            var cetak  =$ctk;
            var anggx = document.getElementById('kebutuhan_ang').value;
            if(anggx ==''){
                alert('Harap isi Jenis Anggaran');
                exit()
            }
            if (document.getElementById("all").checked == true){
                var skpd = '0';
               ...
               url="<?php echo site_url(); ?>/rka/angaran_kas/"+skpd+'/'+cetak+'/'+anggx+'/Report_Anggaran_Kas - '+skpd;
...
<div id="">
   ...
   <td width='8%'>Jenis Anggaran</td>
   <td width="31%" ><select  name="kebutuhan_ang" id="kebutuhan_ang"  style="width:150px">
     <option value="">...Pilih Jenis... </option>
     <option value="1">1  | Murni</option>
     <option value="2">2  | Pergeseran</option>
     <option value="3">3  | Perubahan</option>

   </select></td> 
 </tr>
        <tr >
            <td colspan="2"><a class="easyui-linkbutton" iconCls="icon-print" plain="true" value="OKE" onclick="javascript:cek(0);">Cetak</a>
