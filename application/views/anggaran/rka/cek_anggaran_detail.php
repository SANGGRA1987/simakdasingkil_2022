...
<head>   
  ...
  <script type="text/javascript">
     ...
     $(function(){ 
        ...
        $('#fstatus').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $(function(){ 
                $('#dg').edatagrid({
		          url: '<?php echo base_url(); ?>/index.php/rka/load_cek_anggaran_detail',
    ...
    function cek($cetak,$jns){
         ...
         if(ckdskpd=='' || status_ang==''){
            alert('Harap Pilih SKPD dan Status Anggaran...!!!');
         }else{
         
        url="<?php echo site_url(); ?>/rka/preview_cetakan_cek_anggaran_detail/"+ckdskpd+'/'+$cetak+'/'+status_ang+'/Report-cek-anggaran'
    ...
    function cek2($cetak,$jns){
         ...
         if(status_ang==''){
          alert('Harap Pilih Status Anggaran...!!!');
                    return;
                  }else{
         
        url="<?php echo site_url(); ?>/rka/preview_cetakan_cek_anggaran_detail_seluruh/"+xsk+'/'+$cetak+'/'+status_ang+'/Report-cek-anggaran'
...
<div id="content"> 
<h3 align="center"><u><b><a>CEK NILAI HEADER DAN RINCIAN KEGIATAN</a></b></u></h3>
    <div align="center">
    <p align="center">     
    <table style="width:400px;" border="0">
        ...
        <tr>
           <td width="10%">Cetak Keseluruhan SKPD</td>
           <td width="1%">:</td>
           <td> 
