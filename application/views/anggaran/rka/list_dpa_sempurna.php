 ...
 function openWindow( url ){
	 ...
	 function cek_status(kode){
            ...
            $.ajax({
                ...
                type: "POST",
                dataType:"json",
                data      : ({kdskpd:$kd_skpd,rekk:'22',angg:'sempurna'}),                         
                success:function(data){
                                        sta    = data.hasil;
                                        tombol(sta);
                                      }                                     
       ...
       function cek_status_angkas(kode){
            ...
            $.ajax({
                ...
                type: "POST",
                dataType:"json",
                data      : ({kdskpd:$kd_skpd,rekk:$rek,angg:'sempurna'}),                         
                success:function(data){
                                        stax    = data.hasilx;
                                        tombol2(stax);
                                      }                                     
...
function tombol2(stax){  
	...
	<div id="content">        
        ...
        <td colspan="3">
                <div id="div_bend">
                        <table style="width:100%; align:right;" border="0">
                            <td>Cetak Semua ke EXCEL<a class="easyui-linkbutton" plain="true" onclick="javascript:cek(0,'','semua');return false">                    
                    <img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="cetak"/></a></td> 
                        </table>
                </div>
        </td> 
        </tr>
