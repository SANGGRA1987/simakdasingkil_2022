 ...
 function tombol2(stax){  
    ...
    function cek($cetak,$ckdskpd,$ckdgiat,$nmgiat){
         ...
         if(x=='semua'){
            ...
            url="<?php echo site_url(); ?>/rka/preview_dpa221/"+$ckdskpd+'/'+$ckdgiats+'/'+$cetak+'/'+cpa+'/'+cell
            openWindow( url );
            ...
            $cnmgiats = $nmgiat;
            $cnmgiatx  = $cnmgiats.split("/" && ",").join(" ");
            url="<?php echo site_url(); ?>/rka/preview_dpa221/"+$ckdskpd+'/'+$ckdgiat+'/'+$cetak+'/'+cpa+'/'+cell
            openWindow( url );
        ...
        function ceker($cetak,$ckdskpd,$ckdgiat,$nmgiat){
         ...
         if(x=='semua'){
            ...
            $cnmgiats  = rows[p].nm_kegiatan;        
            $cnmgiatx = $cnmgiats.split("/" && ",").join(" ");
            url="<?php echo site_url(); ?>/allprint/printall_dpa221/"+$ckdskpd+'/'+$ckdgiats+'/'+$cetak+'/'+cpa+'/'+cell
            openWindow( url );
            ...
            $cnmgiats = $nmgiat;
            $cnmgiatx  = $cnmgiats.split("/" && ",").join(" ");
            url="<?php echo site_url(); ?>/allprint/printall_dpa221/"+$ckdskpd+'/'+$ckdgiat+'/'+$cetak+'/'+cpa+'/'+cell
            openWindow( url );
