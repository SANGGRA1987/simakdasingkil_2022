<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    var ctk = '';
		...
		$('#cunit').combogrid({  
            ...
            columns:[[  
                {field:'kd_skpd',title:'Kode Unit',width:200},  
                {field:'nm_skpd',title:'Nama Unit',width:600}    
            ]],
           ...
           $(function(){
            $('#ttd1').combogrid({  
                ...
                url: '<?php echo base_url(); ?>/index.php/rka/load_ttd_unit/'+skpd,  
				 ...
				 $('#ttd2').combogrid({  
                panelWidth:500,  
                url: '<?php echo base_url(); ?>/index.php/rka/load_ttd_kba/'+skpd,  
                    idField:'nip',  
                    textField:'nama',
                    mode:'remote',  
                    fitColumns:true
	...
	function cek($cetak,$jns){
         ...
         if ($jns=='skpd'){
		 	...
		 	var ckdskpd = '5.02.0.00.0.00.02.0000';
		 }
           

 	          url="<?php echo site_url(); ?>/rka/preview_reg_spd/"+ckdskpd+'/'+$cetak+'/'+$jns+'/Register SPD '+ckdskpd;
 ...
 function openWindow( url,$jns ){
	...
	<div id="content">        
        ...
        <tr>
           <td width="10%">Cetak Keseluruhan</td>
            <td> 
