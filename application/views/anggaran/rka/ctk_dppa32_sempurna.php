<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function cek($cetak,$jns){
         ...
         if ($('input[name="chkcover"]:checked').val()=='1'){
            url="<?php echo site_url(); ?>/rka/preview_coverdpa32/"+ckdskpd+'/'+$cetak+'/Report Cover DPPA-3.2 -'+ckdskpd
         }else{
            url="<?php echo site_url(); ?>/rka/preview_dppa32_sempurna/"+ckdskpd+'/'+$cetak+'//Report DPA-3.2 -'+ckdskpd
         } 
