        ...
        <table style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">
         ...
         <option value="3">Revisi ke-3 (Perubahan)</option>				
            ...
            <tr style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">
                ...
                <td style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">&nbsp;<input hidden=true type="text" id="pengajuan"/>&nbsp;<input type="text" id="stt_angs" style="width: 110px; background-color:red; color:white; font-weight: bold" disabled/></td>
            </tr>   
