                ...
                if ( cfm == true ){
                    ...
                    $(document).ready(function(){
                        $.ajax({
                               ...
                               url      : '<?php echo base_url(); ?>index.php/rka/hapus_rincian_dpo',
                               success  : function(data){
                ...
                $(function(){
        			$('#dg1').edatagrid({
						 ...
						 onSelect     : function(rowIndex,rowData){
                                       ...
                                       $("#total_geser").attr("value",angka(rowData.total_sempurna)) ;
                ...
                ftotal = '0.00';
                 ...
                 $.ajax({
                    ...
                    data: ({
                        ...
                        unik:''}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/rka/simpan_rincian_dpo",
                    success:function(data){ 
                        $("#dg1").datagrid("reload");
                            alert('Data Tersimpan');
                            }
                ...
                $(function(){      
                 $.ajax({
                    ...
                    data: ({
                        ...
                        unik:kode_unik}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/rka/update_rincian_dpo",
                    success:function(data){ 
                        $("#dg1").datagrid("reload");
                            alert('Data Tersimpan');
                            }
