...
*/        
		...
		*/
        ...
        for(var i=0;i<rows.length;i++){     
            ...
            if ( i > 0 ) {
                csql = csql+","+"('"+no+"','"+cheader+"','"+ckode+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume_ubah1+"','"+csatuan_ubah1+"','"+charga_ubah1+"','"+ctotal_ubah+"','"+cvolume2+"','"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"','"+cvolume+"','"+cvolume_sempurna1+"','"+cvolume_sempurna1+"','"+cvolume2+"','"+cvolume3+"','"+cvolume_sempurna1+"','"+csatuan_sempurna1+"','"+csatuan2+"','"+csatuan3+"','"+charga_sempurna1+"','"+ctotal_sempurna+"')";
            } else {
                csql = "values('"+no+"','"+cheader+"','"+ckode+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume_ubah1+"','"+csatuan_ubah1+"','"+charga_ubah1+"','"+ctotal_ubah+"','"+cvolume2+"','"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"','"+cvolume+"','"+cvolume_sempurna1+"','"+cvolume_sempurna1+"','"+cvolume2+"','"+cvolume3+"','"+cvolume_sempurna1+"','"+csatuan_sempurna1+"','"+csatuan2+"','"+csatuan3+"','"+charga_sempurna1+"','"+ctotal_sempurna+"')";                                            
...
<h2><a href="#" id="section1" onclick="javascript:validate_combo()">Rekening Anggaran</a></h2>
   ...
   <div  style="height:700px;">      
       ...
       <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:170px;border-bottom-style:hidden;border-right-style:hidden;"><input id="nilairek" type="decimal" name="nilairek" style="width:170px;text-align:right;" onkeypress="javascript:enter(event.keyCode,'add');return(currencyFormat(this,',','.',event))"/>
...
<h3><a href="#" id="section2">Rincian Rekening</a></h3>
    ...
    <div>
        ...
        <B>Total Perubahan</B>&nbsp;&nbsp;&nbsp;&nbsp;<input class="right" type="text" name="rektotal_rinci" id="rektotal_rinci"  style="width:200px" align="right" readonly="true" />
        </td>
