<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 function validate_ttd(kods){
    ...
    function cek($cetak,$jns){
        ...
        url="<?php echo site_url(); ?>/rka/preview_rka2_permen_33/"+ckdskpd+'/'+$cetak+'/'+cpa+'/'+cell+'/Report RKA-2 -'+ckdskpd

        //url="<?php echo site_url(); ?>/rka/preview_rka22/"+ckdskpd+'/'+$cetak+'/'+cpa+'/'+cell+'/Report RKA-2.2 -'+ckdskpd
