       ...
       function cek_status(){
            ...
            $.ajax({
        		...
        		success:function(data){
					  $.each(data, function(i,n){
                        ...
                        //alert(angka(n_kua) + ' - '+angka(n_kua_terpakai));
        ...
        function validate_giat(){
            ...
            onSelect:function(rowIndex,rowData){
				...
				$("#realsumber").attr("value",'0.00');
                $("#realsumber2").attr("value",'0.00');
                $("#realsumber3").attr("value",'0.00');
                $("#realsumber4").attr("value",'0.00');
...
*/        
        ...
        function validate_combo(){
			...
			$('#dg').edatagrid({
				 ...
				 onSelect:function(rowIndex,rowData){							
                              ...
                              $jdl2 = '#sdana1';
							  $jdl3 = 'nilaisumber';
                              load_total_sdana2(cgiat,vvsdana1,vvkdrek,kdskpd,$jdl,$jdl2,$jdl3);
                              if(vvsdana2!=''){
                                $jdl = '#realsumber2';
                                $jdl2 = '#sdana2';
								$jdl3 = '#nilaisumber2';
                                load_total_sdana2(cgiat,vvsdana2,vvkdrek,kdskpd,$jdl,$jdl2,$jdl3);
                              }
                              if(vvsdana3!=''){
                                $jdl = '#realsumber3';
                                $jdl2 = '#sdana3';
								$jdl3 = 'nilaisumber3';
                                load_total_sdana2(cgiat,vvsdana3,vvkdrek,kdskpd,$jdl,$jdl2,$jdl3);
                              }
                              if(vvsdana4!=''){
                                $jdl = '#realsumber4';
                                $jdl2 = '#sdana4';
								$jdl3 = 'nilaisumber4';
                                load_total_sdana2(cgiat,vvsdana4,vvkdrek,kdskpd,$jdl,$jdl2,$jdl3);
                              }                              
        ...
        function load_total_sdana2(giat,sumber,kode_rek,kode,jdl,jdl2,jdl3){  
    		$(function(){      
             $.ajax({
                type: 'POST',
                url:"<?php echo base_url(); ?>index.php/rka/load_total_sdana2",
                dataType:"json",
    			data: ({giat:giat,kode:kode,sumber:sumber,kode_rek:kode_rek}),
                success:function(data){ 
                    $.each(data, function(i,n){
                        $(jdl).attr("value",n['total_trans_sumber']);
                        var ceksum  = angka(n['total_trans_sumber']) ;
                        if(ceksum!=0){  
                           $(jdl2).combogrid("disable"); 
						   document.getElementById(jdl3).disabled = false;
                        }else{
                           $(jdl2).combogrid("enable"); 
						   document.getElementById(jdl3).disabled = false;
                        }
                        
                        if(sumber=='DAK FISIK' || sumber=='DAK NON FISIK'){
                            $(jdl2).combogrid("disable"); 
							document.getElementById(jdl3).disabled = true;
		...
		function hapus_rinci(){
                ...
                if ( cek_po == 1 ) {
                    alert('Rincian Penetapan/ Penyempurnaan Tidak Bisa Dihapus di Perubahan');
                    exit();
                }
                ...
                if ( cfm == true ){
                    ...
                    for (i=0; i < rows.length; i++) {
                        total_rincian+=angka(rows[i].total_ubah);
                    }
        ...
        var sdana1 = $("#sdana1").combogrid("getValue").trim();
        var sdana2 = $("#sdana2").combogrid("getValue").trim();
        var sdana3 = $("#sdana3").combogrid("getValue").trim();
        var sdana4 = $("#sdana4").combogrid("getValue").trim();
        var cekdana = 0;
	    var cekdana2 = 0;
	    var cekdana3 = 0;
	    var cekdana4 = 0;
        ...
        var ndbhp = 0;
        var ndid = 0;
        var lreke = crek.length;
        var lkegi = cgiat.length;
		...
		if(lkegi!=21){
            alert("Kode Digit Kegiatan Salah!!!");
			return;
		}
		
        if(lreke!=7){
            alert("Kode Digit Rekening Salah!!!");
			return;
		}   
		...
		if ((  total_rinci < real_rek5 )&&(lcrek='5')){
			if(lcrek1!='00.51'){	
				...
				if(crek.substring(0,5)=='51101'){
					if (confirm('Nilai Anggaran kurang dari nilai Realisasi. Yakin Simpan?')) {
					} else {
						return;
					}
				}else{
		...
		if (total_rinci != totaldana){
			alert("Total Rincian Tidak sama dengan Nilai Sumber");
            return;
		}
        ...
        for(var i=0;i<rows.length;i++){     
            ...
            if ( i > 0 ) {
                csql = csql+","+"('"+no+"','"+cheader+"','"+ckode+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"',"+
                       "'"+ctotal+"','"+cvolume_ubah1+"','"+csatuan_ubah1+"','"+charga_ubah1+"','"+ctotal_ubah+"','"+cvolume2+"',"+
                       "'"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"',"+
                       "'"+cvolume+"','"+cvolume_sempurna1+"','"+cvolume_sempurna1+"','"+cvolume2+"','"+cvolume3+"','"+cvolume_sempurna1+"',"+
                       "'"+csatuan_sempurna1+"','"+csatuan2+"','"+csatuan3+"','"+charga_sempurna1+"','"+ctotal_sempurna+"','"+lsusun+"',"+
                       "'"+lsempurna+"','"+lubh+"')";
            } else {
                csql = "values('"+no+"','"+cheader+"','"+ckode+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"',"+
                       "'"+ctotal+"','"+cvolume_ubah1+"','"+csatuan_ubah1+"','"+charga_ubah1+"','"+ctotal_ubah+"','"+cvolume2+"',"+
                       "'"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"',"+
                       "'"+cvolume+"','"+cvolume_sempurna1+"','"+cvolume_sempurna1+"','"+cvolume2+"','"+cvolume3+"','"+cvolume_sempurna1+"',"+
                       "'"+csatuan_sempurna1+"','"+csatuan2+"','"+csatuan3+"','"+charga_sempurna1+"','"+ctotal_sempurna+"','"+lsusun+"',"+
        ...
        $(document).ready(function(){
                ...
                if (status=='1'){               
                            alert('Data Berhasil Tersimpan1...!!!');
							$("#nilairek").attr("value",total_rinci);
                        } else{ 
                ...
                $(function(){
        			$('#dg1').edatagrid({
						 ...
						 onSelect     : function(rowIndex,rowData){
                                       ...
                                       $("#vol2_edit").attr("value",rowData.volume_ubah2) ;
                                       $("#vol3_edit").attr("value",rowData.volume_ubah3) ;
                                       $("#sat1_edit").attr("value",rowData.satuan_ubah1) ;
                                       $("#sat2_edit").attr("value",rowData.satuan_ubah2) ;
                                       $("#sat3_edit").attr("value",rowData.satuan_ubah3) ;
                                       ...
                                       var vol2_e  = rowData.volume_ubah2 ;
                                       var vol3_e  = rowData.volume_ubah3 ;
...
*/        
        ...
        $("#sdana2").combogrid("enable"); 
        $("#sdana3").combogrid("enable"); 
        $("#sdana4").combogrid("enable"); 
        $("#kdrek5").combogrid("setValue",'');
        $("#sdana1").combogrid("setValue",'');
        $("#sdana2").combogrid("setValue",'');
        $("#sdana3").combogrid("setValue",'');
    ...
    function tambah(){
        ...
        if(nrek != totaldana){
            alert('Nilai sumber dana dan nilai rekening masih selisih');
            return;
        }
        ...
        $.ajax({
           ...
           data     : ({kd_skpd:skpd,kd_kegiatan:kegi,kd_rek5:reke,nilai:nrek,dana1:sdana1,dana2:sdana2,dana3:sdana3,dana4:sdana4,
                        vdana1:ndana1,vdana2:ndana2,vdana3:ndana3,vdana4:ndana4}),
           url      : '<?php echo base_url(); ?>index.php/rka/tsimpan_ubah', 
           success  : function(data){
                      st12 = data;
                      if ( st12 == '1' ){
    ...
    function append_save() {
            ...
            $('#dg1').edatagrid('appendRow',{header:o,kode:kode_header,uraian:uraian,volume_ubah1:vol1,satuan_ubah1:sat1,
                                            tvolume_ubah:tvol,harga_ubah1:fharga,total_ubah:ftotal,volume_sempurna1:'0.00',
                                            satuan_sempurna1:'',tvolume_sempurna:'0.00',harga_sempurna1:'0.00',total_sempurna:'0.00',
                                            volume1:'0.00',satuan1:'',volume2:'0.00',satuan2:'',volume3:'0.00',volume:'0.00',satuan3:'',
                                            harga1:'0.00',id:id,total:'0.00',lsusun:0,lsempurna:0,lubh:1});
            $("#dg1").datagrid("unselectAll");
            ...
            for (i=0; i < rows.length; i++) {
                total_rinci+=angka(rows[i].total_ubah);
            }
            $("#rektotal_rinci").attr("value",number_format(total_rinci,2,'.',','));
            $('#dg1').datagrid('unselectAll');
            kosong();
       ...
       function insert_row() {
            ...
            $('#dg1').edatagrid('insertRow',{index:idx_ins,row:{header:o,kode:kode_header,uraian:uraian,volume_ubah1:volu1,volume_sempurna1:'0.00',
                                volume1:'0.00',satuan_ubah1:sat1,satuan_sempurna1:' ',harga_ubah1:harga,harga_sempurna1:'0.00',total_ubah:total,
                                total_sempurna:'0.00',satuan1:' ',volume2:'0.00',satuan2:'',volume3:'0.00',volume:'0.00',satuan3:'',harga1:'0.00',
                                id:id,total:'0.00',id:idx_ins,no_po:idx_ins,lsusun:0,lsempurna:0,lubh:1}});
            $("#dg1").datagrid("unselectAll");
    ...
    function pilih_edit(){
            ...
            $('#dg1').edatagrid('updateRow',{index:idx_ins_edit,row:{header:o,kode:kode_edit,uraian:uraian_edit,volume_ubah1:volu1_edit,satuan_ubah1:sat1_edit,volume_ubah:tvol_edit,harga_ubah1:fharga_edit,total_ubah:ftotal_edit}});
            ...
            var data = $('#dg1').datagrid('getData');
            var rows = data.rows;
            var total_rinci_edit = 0;
            
            for (i=0; i < rows.length; i++) {
                total_rinci_edit+=angka(rows[i].total_ubah);
            }
...
<h2><a href="#" id="section1" onclick="javascript:validate_combo()">Rekening Anggaran</a></h2>
       ...
       <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:170px;border-bottom-style:hidden;border-right-style:hidden;"><input id="nilairek" type="decimal" name="nilairek" style="width:170px;text-align:right;" onkeypress="javascript:enter(event.keyCode,'add');return(currencyFormat(this,',','.',event))" disabled="true"/>
       ...
       <div id="toolbarx">
    		...
    		<!--<button id="save" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:$('#dg').edatagrid('addRow');">Simpan</button>-->
    		<!--<button id="cancel" class="easyui-linkbutton" iconCls="icon-undo" plain="true" onclick="javascript:$('#dg').edatagrid('cancelRow')">Batal</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
            <table style="width:880px;height:10px;border-style:hidden;border-bottom-style:hidden" >
            <tr>
                <td align="right"><B>Total Perubahan</B>&nbsp;&nbsp;<input class="right" type="text" name="rektotal" id="rektotal"  style="width:200px;text-align:right;"  readonly="true" disabled="true"/></td>
            </tr>
			<tr>
                <td align="right">
			        ...
			        <B>Plafond (KUA-PPAS)</B>&nbsp;&nbsp;<input class="right" type="text" name="nilai_kua" id="nilai_kua"  style="width:200px;text-align:right;"  readonly="true" disabled="true"/>
                </td>
            </tr>
			<tr><td align="right">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <B>Total Belanja (BTL+BL)</B>&nbsp;&nbsp;<input class="right" type="text" name="nilai_kua_ang" id="nilai_kua_ang"  style="width:200px;text-align:right;"  readonly="true" disabled="true"/>
            </td></tr>
			<tr><td align="right">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <B>Sisa Plafond (KUA-PPAS)</B>&nbsp;&nbsp;<input class="right" type="text" name="sisa_nilai_kua" id="sisa_nilai_kua"  style="width:200px;text-align:right;"  readonly="true" disabled="true"/>
            </td>
            </tr>
			<tr><td align="right">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <B>Total Realisasi</B>&nbsp;&nbsp;<input class="right" type="text" name="total_realisasi" id="total_realisasi"  value='0.00' style="width:200px;text-align:right;"  readonly="true" disabled="true"/>
            </td>
            </tr>
			<tr><td align="right">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <B>Realisasi Keg.</B>&nbsp;&nbsp;<input class="right" type="text" name="n_realkeg" id="n_realkeg"  value='0.00' style="width:200px;text-align:right;"  readonly="true" disabled="true"/>
            </td>
            </tr>
 			<tr><td align="right">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <B>Realisasi Rek.</B>&nbsp;&nbsp;<input class="right" type="text" name="n_realrek" id="n_realrek"  value='999,999,999,999,999,999.00' style="width:200px;text-align:right;"  readonly="true" disabled="true"/>
            </td>
            </tr>
...
<h3><a href="#" id="section2" >Rincian Rekening</a></h3>
    ...
    <div>
       ...
       <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:170px;border-bottom-style:hidden;border-right-style:hidden;"><input id="nilaisumber" name="nilaisumber"  type="decimal" value='0.00' style="width:170px;text-align:right;" onkeypress="javascript:return(currencyFormat(this,',','.',event))"/></td>  
       ...
       <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:260px;border-bottom-style:hidden;"><input id="nilaisumber4" type="decimal" name="nilaisumber4" value='0.00' style="width:170px;text-align:right;" onkeypress="javascript:return(currencyFormat(this,',','.',event))"/></td> 
        ...
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">
            <td style="text-align:center; border-right-style:hidden; border-bottom-color:black;border-style-bottom:hidden;border-spacing:4px ;padding:3px 3px 3px 3px;border-collapse:collapse;"> <input type="checkbox" id="header_po" style="width: 40px;" onkeypress="javascript:enter(event.keyCode,'uraian');"/></td>
            ...
            <td colspan="2" style="text-align:center; border-right-style:hidden; border-bottom-color:black;border-style-bottom:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;"> <input type="text" id="uraian" style="width: 350px;" onkeypress="javascript:enter(event.keyCode,'vol1');"/></td>
            ...
            <td style="border-spacing:3px ;padding:3px 3px 3px 3px;border-bottom-color:black;"><input type="text" id="harga" style="width: 165px; text-align: right;"  onkeypress="javascript:enter(event.keyCode,'uraian');return(currencyFormat(this,',','.',event))"/><input type="hidden" value="0" id="cek_po" name="cek_po"  style="width:165px;text-align:right;"/>
            </td>
        </tr>
		<tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
		...
		<td align='right' style="border-style: hidden;">
		<B>Sisa KUA</B>&nbsp;&nbsp;<input class="right" type="text" name="sisa_kua2" id="sisa_kua2"  style="width:200px" align="right" readonly="true" disabled="true"/>
		</td>
        </tr>
		<tr>
		<td style="border-style: hidden;width: 400px;" ></td>
		<td align='right' style="border-style: hidden;">
		<B>Ang. Rekening</B>&nbsp;&nbsp;<input class="right" type="text" name="nilai_kua_rek" id="nilai_kua_rek"  style="width:200px" align="right" readonly="true" disabled="true"/></td>
		</tr>
		<tr>
		<td style="border-style: hidden;"></td>
		<td align='right' style="border-style: hidden;" >
		<B>Sisa KUA + Rek.</B>&nbsp;&nbsp;<input class="right" type="text" name="total_sisa_kua_rek" id="total_sisa_kua_rek"  style="width:200px" align="right" readonly="true" disabled="true"/>
		...
		<td style="border-style: hidden;"></td>
		<td align='right' style="border-style: hidden;">
		<B>Realisasi Rek.</B>&nbsp;&nbsp;<input class="right" type="text" value='999,999,999,999,999,999.00' name="nreal_rek" id="nreal_rek"  style="width:200px" align="right" readonly="true" disabled="true"/>
		</td>
		</tr>
        </table>
