    ...
    function get_skpd(kd_s='',nm_s='',st_s='') {
      ...
      function cek_status(kdskpd){
        ...
        function validate_combo(){
            ...
            $(function(){
            $('#dg').edatagrid({
                 url: '<?php echo base_url(); ?>/index.php/anggaran_murni/select_rka_rancang/'+cgiat,
                 idField     : 'id',
                 toolbar     : "#toolbar",              
                 rownumbers  : "true", 
                 fitColumns  : "true",
...
<div id="content">
   <?php echo $prev; ?><p id="p1" style="font-size: x-large;color: red;"></p>
   <table style="border-collapse:collapse;border-style:hidden;" width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr style="border-style:hidden;">
            ...
            <td>
                ...
                <br><input type="text" id="jnskegi" name="jnskegi" style="width:20px; border:0;" />
            </td>
...
<h2><a href="#" id="section1" onclick="javascript:validate_combo(); ">Rekening Anggaran</a></h2>
   ...
   <div  style="height:700px;">      
       ...
       <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:770px;border-bottom-style:hidden;" colspan="4"><input id="kdrek5" name="kdrek5" style="width:175px;" />  
       ...
       <table id="dg" title="Input Rekening Rencana Kegiatan Anggaran" style="width:1024px; height:400px;" >          
       </table>  <br>
                                <div id="toolbarx">
    ...
    <div >
        ...
        <table border='1' style="width:100%;">
           ...
           <tr style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
               ...
               <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;border-right-style:hidden;"><input id="sdana1" name="sdana1" style="width:207px;"/></td>  
               <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;border-right-style:hidden;"><input id="sdana2" name="sdana2" style="width:207px"/></td>  
               <td colspan='2' style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;border-right-style:hidden;"><input id="sdana3" name="sdana3" style="width:207px"/></td> 
               <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:260px;border-bottom-style:hidden;"><input id="sdana4" name="sdana4" style="width:207px"/></td> 
           </tr>
           ...
           <tr style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
               ...
               <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;border-right-style:hidden;"><input id="saldosumber" name="saldosumber"  type="decimal" style="text-align:right; width:200px" disabled/></td>  
               <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;border-right-style:hidden;"><input id="saldosumber2" name="saldosumber2" type="decimal" value='0.00'  style="text-align:right; width:200px" disabled/></td>  
               <td colspan='2' style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;border-right-style:hidden;"><input id="saldosumber3" name="saldosumber3" type="decimal" value='0.00'  style="text-align:right; width:200px" disabled/></td> 
               <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:260px;border-bottom-style:hidden;"><input id="saldosumber4" type="decimal" name="saldosumber4" value='0.00' style="text-align:right; width:200px" disabled/></td> 
           </tr>
           ...
           <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;border-right-style:hidden;"><input id="nilaisumber" name="nilaisumber"  type="decimal" style="text-align:right; width:200px;" onkeypress="javascript:return(currencyFormat(this,',','.',event))"/></td>  
           <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;border-right-style:hidden;"><input id="nilaisumber2" name="nilaisumber2" type="decimal" value='0.00'  style="text-align:right; width:200px;" onkeypress="javascript:return(currencyFormat(this,',','.',event))"/></td>  
           <td colspan='2' style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;border-right-style:hidden;"><input id="nilaisumber3" name="nilaisumber3" type="decimal" value='0.00'  style="text-align:right; width:200px;" onkeypress="javascript:return(currencyFormat(this,',','.',event))"/></td> 
           <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:260px;border-bottom-style:hidden;"><input id="nilaisumber4" type="decimal" name="nilaisumber4" value='0.00' style="text-align:right; width:200px;" onkeypress="javascript:return(currencyFormat(this,',','.',event))"/></td> 
           </tr>
            ...
            <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">
                ...
                <td style="border-spacing:3px ;padding:3px 3px 3px 3px;border-bottom-color:black;"><input type="text" value="0" id="harga" style="width:200px;; text-align: right;"  onkeypress="javascript:enter(event.keyCode,'uraian');return(currencyFormat(this,',','.',event))"/>
                </td>
            </tr> 
            <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
        ...
        <td style="border-style: hidden;">
            ...
            <button style="background-color: red; border: 1px solid black; padding: 3px; cursor:pointer; color: #ffffff" id="del1" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:hapus_rinci();"><b>Hapus</button>
            <button style="background-color: #4CAF50; border: 1px solid black; padding: 3px; cursor:pointer; color: #ffffff" id="save1" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:cek_jns_kegiatan();"><b>Simpan Detail</button> 
            <!-- detsimpan(); -->
...
<table align="center" border='0' width="100%" style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
    ...
    <tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;">
        ...
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><textarea id="tu_capai" name="tu_capai" rows='2' cols="20" ></textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea id="tu_capai_p" name="tu_capai_p" rows='2' cols="20" > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><textarea id="tk_capai" name="tk_capai" rows='2' cols="20" > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea id="tk_capai_p" name="tk_capai_p" rows='2' cols="20" > </textarea></td>
    </tr>
    <tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><b>Masukan</b></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><textarea id="tu_mas" name="tu_mas" rows='2' cols="20"  > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea id="tu_mas_p" name="tu_mas_p" rows='2' cols="20"  > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><textarea id="tk_mas" name="tk_mas" rows='2' cols="20"  > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea id="tk_mas_p" name="tk_mas_p" rows='2' cols="20"  > </textarea></td>
    </tr>
    <tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><b>Keluaran</b></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><textarea id="tu_kel" name="tu_kel" rows='2' cols="20" > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea id="tu_kel_p" name="tu_kel_p" rows='2' cols="20" > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" ><textarea id="tk_kel" name="tk_kel" rows='2' cols="20" > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea id="tk_kel_p" name="tk_kel_p" rows='2' cols="20" > </textarea></td>
    </tr>
    <tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><b>Hasil</b></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><textarea id="tu_has" name="tu_has" rows='2' cols="20" > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea id="tu_has_p" name="tu_has_p" rows='2' cols="20" > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;"><textarea id="tk_has" name="tk_has" rows='2' cols="20"  > </textarea></td>
        <td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea id="tk_has_p" name="tk_has_p" rows='2' cols="20" > </textarea></td>
    </tr>
    <tr style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;">
        <td style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" ><b>Kelompok Sasaran Kegiatan</b></td>
        <td colspan="5" style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" ><textarea id="kel_sasaran_kegiatan" name="kel_sasaran_kegiatan" rows='2' cols="100"  ></textarea></td>
