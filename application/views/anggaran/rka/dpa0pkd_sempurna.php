<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    function cek($cetak,$jns){
        ...
        if ($jns == 'cover'){
            url="<?php echo site_url(); ?>/rka/preview_coverdpa0_ppkd_sempurna/"+ckdskpd+'/'+$cetak+'/Report-Cover-DPA-0'
         }else{
            url="<?php echo site_url(); ?>/rka/preview_dpa0pkd_sempurna/"+ckdskpd+'/'+$cetak
         } 
