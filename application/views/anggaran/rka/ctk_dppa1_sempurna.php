<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function cek($cetak,$jns){
         ...
         if ($('input[name="chkcover"]:checked').val()=='1'){
            url="<?php echo site_url(); ?>/rka/preview_coverdppa1_sempurna/"+ckdskpd+'/'+$cetak+'/Report Cover DPPA-1 Penyempurnaan'
         }else{
            ...
            url="<?php echo site_url(); ?>/rka/preview_dppa1_sempurna/"+ckdskpd+'/'+$cetak+'/'+cpa+'/'+cell+'/'+csetda+'/Report DPPA-1 Penyempurnaan'
         } 
