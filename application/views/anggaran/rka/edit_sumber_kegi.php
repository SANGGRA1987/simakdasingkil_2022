...
<head>
     ...
     $(document).ready(function() {
      ...
      $(function(){
        $('#cc').combogrid({  
         ...
         $(function(){ 
         $('#dg').edatagrid({
    		url: '<?php echo base_url(); ?>/index.php/rka/kegi_sumber',
            idField:'id',
            toolbar:"#toolbar",              
            rownumbers:"true", 
            fitColumns:"true",
      ...
      function giat(kode){
        $(function(){  
            $('#dg').edatagrid({
    		  url: '<?php echo base_url(); ?>/index.php/rka/kegi_sumber/'+kode
            });
        });
      }
    ...
    function simpan(){
        ...
        */
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>/index.php/rka/update_sumber_kegi',
