         ...
         $.ajax({
            ...
            success:function(data){ 
                $.each(data, function(i,n){
                    $("#rektotal_rka").attr("value",n['rektotal_rka_ubah']);
                });
            }
         });
        });
      ...
      function get_skpd(kd_s='',nm_s='',st_s='')
       ...
       function cek_status(){
        	...
        	$.ajax({
                ...
                data      : ({kdskpd:$kd_skpd}),                         
        		success:function(data){
                                        sta    = data.status_ubah_penyempurna;
                                        tombol(sta);
        							  }                                     
        	});        
       }
            ...
            $.ajax({
        		...
        		success:function(data){
					  $.each(data, function(i,n){
						...
						$("#nilai_kua_ang").attr("Value",n['kua_terpakai_ubah']);
						var n_kua  = n['nilai'] ;                
						var n_kua_terpakai = n['kua_terpakai_ubah'];
        	...
        	$.ajax({
        		...
        		success:function(data){
					  $.each(data, function(i,n){
						...
						$("#nilai_kua_ang").attr("Value",n['kua_terpakai_ubah_penyempurna']);
						var n_kua  = n['nilai'] ;
						var n_kua_terpakai = n['kua_terpakai_ubah'];
					    var n_sisa_kua = angka(n_kua) - angka(n_kua_terpakai) ;
...
//        	alert(reke);
        ...
        function cek_kas(){
            ...
            $.ajax({
               ...
               url       : '<?php echo base_url(); ?>/index.php/rka/cek_kas_ubah',
               type      : 'POST',
               dataType  : 'json',
...
*/        
        ...
        function validate_combo(){
			...
			$('#dg').edatagrid({
				 ...
				 onSelect:function(rowIndex,rowData){							
                              ...
                              vvnilai  = rowData.nilai_ubah_penyempurna;
                              vvsdana1 = rowData.sumber1_ubah_penyempurna;
                              vvsdana2 = rowData.sumber2_ubah_penyempurna;
                              vvsdana3 = rowData.sumber3_ubah_penyempurna;
                              vvsdana4 = rowData.sumber4_ubah_penyempurna;
                              vvnsdana1 = rowData.nsumber1_ubah_penyempurna;
                              vvnsdana2 = rowData.nsumber2_ubah_penyempurna;
                              vvnsdana3 = rowData.nsumber3_ubah_penyempurna;
                              vvnsdana4 = rowData.nsumber4_ubah_penyempurna;
                              vvnilaisusun =   angka(rowData.nilai);
                              vvnilaisem = angka(rowData.nilai_sempurna);
                              $("#kdrek5").combogrid("disable");
                              ...
                              $("#cek_rek5_sempurna").attr("value",vvnilaisem);
		...
		function hapus(){
                ...
                var rek5_sempurna = document.getElementById('cek_rek5_sempurna').value ;
                ...
                if ( ncekreal < nrealkegsemp ) {
                    alert('Nilai Perubahan Tidak Boleh lebih kecil dari Realisasi...!!!');
                    return;
                }
                ...
                if ( rek5_sempurna > 0 ) {
                    alert('Rekening ini sudah ada di penyempurnaan. Tidak bisa dihapus');
                    return;
                }
                ...
                if  (del==true){
					$(function(){
						$('#dg').edatagrid({
							 url: '<?php echo base_url(); ?>/index.php/rka/thapus_ubah/'+cskpd+'/'+cskpd2+'/'+cgiat+'/'+rek,
							 idField:'id',
							 toolbar:"#toolbar",              
							 rownumbers:"true", 
							 fitColumns:"true",
	...
	function hapus_rinci(){
                ...
                var murni  = document.getElementById('total_murni').value;
                var geser  = document.getElementById('total_geser').value;
...
/*                if ( cek_po == 1 ) {
                ...
                if(murni!=0){
                    alert('Rincian Penetapan Tidak Bisa Dihapus di Perubahan');
                    exit();                    
                }
                if(geser!=0){
                    alert('Rincian Penetapan Tidak Bisa Dihapus di Perubahan');
                ...
                if ( cfm == true ){
                    ...
                    $(document).ready(function(){
                        $.ajax({
                               ...
                               url      : '<?php echo base_url(); ?>index.php/rka/hapus_rincian_dpo_penyempurna',
                               success  : function(data){
		...
		if (satuan3==""){
            ...
            $.ajax({
                type     : "POST",       
                dataType : 'json',         
                data     : ({skpd:cskpd,skpd2:cskpd2,giat:cgiat,rek:rk,id:idx,uraian:uraian,volum1:volum1,satuan1:satuan1,harga1:harga1,volum2:volum2,satuan2:satuan2,volum3:volum3,satuan3:satuan3}),
                url      : '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_ubah',
                success  : function(data){
                    status = data.pesan;
        ...
        var norka  = cskpd+'.'+cgiat+'.'+crek;
          ...
          $.ajax({ 
        		url:'<?php echo base_url(); ?>index.php/rka/cek_nopo_ubah/'+norka+'/'+no,
        		type: "POST",
        		dataType:"json", 
        		success:function(data){
        		          //result = data;
		...
		*/
        ...
        if(status_skrg=='Kegiatan Sudah Aktif'){
            alert("Silakan Non Aktifkan Kegiatan ini Terlebih Dahulu...!!!"); //jadi tidak aktif
			return;
        }
...
*/
        ...
        for(var i=0;i<rows.length;i++){     
            ...
            cvolume_ubah1  = rows[i].volume_ubah1;
            csatuan_ubah1  = rows[i].satuan_ubah1;
            charga_ubah1   = angka(rows[i].harga_ubah1);
            ...
            if ( i > 0 ) {
                csql = csql+","+"('"+no+"','"+cheader+"','"+ckode+"','"+cgiat+"','"+crek+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume_ubah1+"','"+csatuan_ubah1+"','"+charga_ubah1+"','"+ctotal_ubah+"','"+cvolume2+"','"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"','"+cvolume+"','"+cvolume_sempurna1+"','"+cvolume_sempurna1+"','"+cvolume2+"','"+cvolume3+"','"+cvolume_sempurna1+"','"+csatuan_sempurna1+"','"+csatuan2+"','"+csatuan3+"','"+charga_sempurna1+"','"+ctotal_sempurna+"')";
            } else {
                csql = "values('"+no+"','"+cheader+"','"+ckode+"','"+cgiat+"','"+crek+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume_ubah1+"','"+csatuan_ubah1+"','"+charga_ubah1+"','"+ctotal_ubah+"','"+cvolume2+"','"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"','"+cvolume+"','"+cvolume_sempurna1+"','"+cvolume_sempurna1+"','"+cvolume2+"','"+cvolume3+"','"+cvolume_sempurna1+"','"+csatuan_sempurna1+"','"+csatuan2+"','"+csatuan3+"','"+charga_sempurna1+"','"+ctotal_sempurna+"')";                                            
        ...
        $(document).ready(function(){
                $.ajax({
                    type     : "POST",   
                    dataType : 'json',                 
                    data     : ({no:norka,sql:csql,skpd:cskpd,skpd2:cskpd2,giat:cgiat,vsdana1:sdana1,vsdana2:sdana2}),
                    url      : '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_jk_ubah',
                    success  : function(data){                        
                        status = data.pesan; 
                         if (status=='1'){               
    ...
    $(function(){
        ...
        */
        ...
        $(function(){
			...
			$('#dg1').edatagrid({
				...
				columns:[[
                    ...
                    {field:'volume_ubah1_penyempurna',
                     title:'Vol Penyempurna',
                     width:70,
                     align:'right'
                     },
                    {field:'satuan_ubah1_penyempurna',
                     title:'Sat Penyempurna',
                     width:50,
                     align:'left'
                     },
                    {field:'harga_ubah1_penyempurna',
                     title:'Harga Penyempurna',
                     width:110,
                     align:'right'
                     },
                    {field:'total_ubah_penyempurna',
                     title:'Total Penyempurna',
                     width:150,
                     align:'right',
                     styler: function(value,row,index){
                                  return 'background-color:#d9e3fc;color:red;font-weight:bold;';
        ...
        function section(kdrek){
           ...
           $("#n_realrek").attr("Value",'999,999,999,999,999.00');
            $("#nreal_rek").attr("Value",'999,999,999,999,999.00');
                ...
                $(function(){
        			$('#dg1').edatagrid({
						 ...
						 onSelect     : function(rowIndex,rowData){
                                       ...
                                       $("#kode_unik").attr("value",rowData.unik) ;
                                       $("#total_murni").attr("value",angka(rowData.total));
                                       $("#total_geser").attr("value",angka(rowData.total_ubah)) ;
                                       $("#nomor_insert").attr("value",rowData.no_po) ;
                                       $("#uraian_edit").attr("value",rowData.uraian) ;
                                       $("#vol1_edit").attr("value",rowData.volume_ubah1_penyempurna) ;
                                       $("#vol2_edit").attr("value",rowData.volume_ubah2_penyempurna) ;
                                       $("#vol3_edit").attr("value",rowData.volume_ubah3_penyempurna) ;
                                       $("#sat1_edit").attr("value",rowData.satuan_ubah1_penyempurna) ;
                                       $("#sat2_edit").attr("value",rowData.satuan_ubah2_penyempurna) ;
                                       $("#sat3_edit").attr("value",rowData.satuan_ubah3_penyempurna) ;
                                       $("#harga_edit").attr("value",rowData.harga_ubah1_penyempurna) ;
                                       ...
                                       var vol1_e  = rowData.volume_ubah1_penyempurna ;
                                       var vol2_e  = rowData.volume_ubah2_penyempurna ;
                                       var vol3_e  = rowData.volume_ubah3_penyempurna ;
                                       var harga_e = rowData.harga_ubah1_penyempurna ;
    ...
    function load_sum_rek(){                
        ...
        $(function(){      
         $.ajax({
            ...
            success:function(data){ 
                $.each(data, function(i,n){
                    $("#rektotal").attr("value",n['rektotal_ubah_penyempurna']);
                });
            }
         });
        });
    ...
    function load_sum_rek_rinci(c){                
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b,rek:c}),
            url:"<?php echo base_url(); ?>index.php/rka/load_sum_rek_rinci_ubah",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    $("#rektotal_rinci").attr("value",n['rektotal_rinci1']);
                });
            }
         });
        });
...
/*        
        if(nkegsemp < nrealkegsemp){
            alert('Nilai Pergeseran tidak boleh kurang dari realisasi!!!'); 
            exit();           
        }
*/        
		//$("#kdrek5").combogrid("setValue",'');
    ...
    function tambah(){
        ...
        var totrek   = angka(document.getElementById('rektotal_rinci').value);
        ...
        var x1 = sdana1.length;
        var x2 = sdana2.length;
        var x3 = sdana3.length;
        var x4 = sdana4.length;
    /*if ((lcrek1!='00.001') && (lcrek1!='00.002')){ 
        if(( totrek != nrek )){
                alert('Harap Perbaiki Rincian Terlebih Dahulu');
                return;
            }
    }    
*/
...
*/
        ...
        $.ajax({
           type     : "POST",
           dataType : "json",
           data     : ({kd_skpd:skpd,kd_skpd2:skpd2,kd_kegiatan:kegi,kd_rek5:reke,nilai:nrek,dana1:sdana1,dana2:sdana2,dana3:sdana3,dana4:sdana4,
                        vdana1:ndana1,vdana2:ndana2,vdana3:ndana3,vdana4:ndana4}),
           url      : '<?php echo base_url(); ?>index.php/rka/tsimpan_ubah_penyempurna', 
           success  : function(data){
                      st12 = data;
                      if ( st12 == '1' ){
    ...
    function append_save() {
                ...
                ftotal = '0.00';
                 ...
                 $.ajax({
                    ...
                    data: ({
                        ...
                        volume1:0,
                        volume1_sempurna1:0,
                        volume_ubah1_penyempurna:vol1,
                        satuan1:0,
                        satuan_sempurna1:0,
                        satuan_ubah1_penyempurna:sat1,
                        harga1:0,
                        harga_sempurna1:0,
                        harga_ubah1_penyempurna:angka(fharga),
                        total:0,
                        total_sempurna:0,
                        total_ubah_penyempurna:angka(ftotal),
                        unik:''}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/rka/simpan_rincian_dpo_penyempurna",
                    success:function(data){ 
                        $("#dg1").datagrid("reload");
                            get_nilai_kua_rek();
                            get_nilai_real_rek();
            ...
            $('#dg1').edatagrid('appendRow',{header:o,kode:kode_header,uraian:uraian,volume_ubah1:vol1,satuan_ubah1:sat1,tvolume_ubah:tvol,harga_ubah1:fharga,total_ubah:ftotal,volume_sempurna1:'0.00',satuan_sempurna1:'',tvolume_sempurna:'0.00',harga_sempurna1:'0.00',total_sempurna:'0.00',volume1:'0.00',satuan1:'',volume2:'0.00',satuan2:'',volume3:'0.00',volume:'0.00',satuan3:'',harga1:'0.00',id:id,total:'0.00'});
            $("#dg1").datagrid("unselectAll");
                ...
                total = '0.00';
                 ...
                 $.ajax({
                    ...
                    data: ({
                        ...
                        harga1:0,
                        harga_sempurna1:0,
                        harga_ubah1_penyempurna:harga,
                        total:0,
                        total_sempurna:0,
                        total_ubah_penyempurna:total,
                        unik:''}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/rka/simpan_rincian_dpo_penyempurna",
                    success:function(data){ 
...
/*============*/
            ...
            $('#dg1').edatagrid('insertRow',{index:idx_ins,row:{header:o,kode:kode_header,uraian:uraian,volume_ubah1:volu1,volume_sempurna1:'0.00',volume1:'0.00',satuan_ubah1:sat1,satuan_sempurna1:' ',harga_ubah1:harga,harga_sempurna1:'0.00',total_ubah:total,total_sempurna:'0.00',satuan1:' ',volume2:'0.00',satuan2:'',volume3:'0.00',volume:'0.00',satuan3:'',harga1:'0.00',id:id,total:'0.00',id:idx_ins,no_po:idx_ins}});
            $("#dg1").datagrid("unselectAll");
    ...
    function kosong(){
            ...
            $("#total_geser").attr("value","");
            $("#total_murni").attr("value","");
    ...
    function pilih_edit(){
            ...
            var urai = document.getElementById('uraian_edit').value;
            var uraian_edit= urai.replace(/['"]+/ig,"");
                ...
                $(function(){      
                 $.ajax({
                    ...
                    data: ({
                        ...
                        unik:kode_unik}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/rka/update_rincian_dpo_penyempurna",
                    success:function(data){ 
            ...
            $('#dg1').edatagrid('updateRow',{index:idx_ins_edit,row:{header:o,kode:kode_edit,uraian:uraian_edit,volume_ubah1_penyempurna:volu1_edit,satuan_ubah1_penyempurna:sat1_edit,volume_ubah_penyempurna:tvol_edit,harga_ubah1_penyempurna:fharga_edit,total_ubah_penyempurna:ftotal_edit}});
   ...
   function getSB(koderekk){
        var vrek = koderekk;
        //alert(vrek);

        if(vrek==''){
            var xurl = '<?php echo base_url(); ?>index.php/sb/sb/ambil_sb1';
        }else{
            var xurl = '<?php echo base_url(); ?>index.php/sb/sb/ambil_sb1/'+vrek;
        }
        $(function(){
            $('#header_sb').combotree({  
            panelWidth : 700,  
            idField    : 'kode_rek_rinci',  
            treeField  : 'uraian',
            url        : xurl,  
    ...
    function getSB_edit(koderekk){
     ...
     function getNilai(){
            var val = $('#header_sb').combotree('getValue');       
            var vall = "51108030103";
            //alert(val);
            if(val==''){                    
                alert('Pilihan Standar Biaya Belum Sesuai');                
            }else{
                $(document).ready(function(){
                $.ajax({
                    type     : "POST",   
                    dataType : 'json',                 
                    data     : ({id:val}),
                    url      : '<?php echo base_url(); ?>index.php/sb/sb/ambil_sb1_filter',
                    success  : function(data){                        
                        xuraian = data.text;
                        xsatuan = data.satuan;
                        xharga  = number_format(data.besaran,2,'.',',');
                        
                        document.getElementById('uraian').value=xuraian;
                        document.getElementById('sat1').value=xsatuan;
                        document.getElementById('harga').value=xharga;
     ...
     function getNilai_edit(){
            var val = $('#header_sb_edit').combotree('getValue');       
            var vall = "51108030103";
            //alert(val);
            if(val==''){                    
                alert('Pilihan Standar Biaya Belum Sesuai');                
                ...
                $.ajax({
                    ...
                    success  : function(data){                        
                        ...
                        document.getElementById('uraian_edit').value=xuraian;
                        document.getElementById('sat1_edit').value=xsatuan;
                        document.getElementById('harga_edit').value=xharga;   
                        //alert(xharga);                       
...
<h2><a href="#" id="section1" onclick="javascript:validate_combo()">Rekening Anggaran</a></h2>
   ...
   <div  style="height:700px;">      
       ...
       <input  type="hidden" id="cek_rek5_sempurna" name="cek_rek5_sempurna" style="width:170px;"/> 
       ...
       <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:260px;border-bottom-style:hidden;"><input id="nilaisumber4" type="decimal" name="nilaisumber4" value='0.00' style="width:170px;text-align:right;" onkeyup="javascript:hitung();" onkeypress="javascript:return(currencyFormat(this,',','.',event))"/></td> 
       </tr>
       <tr style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
       ...
       <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:170px;border-bottom-style:hidden;border-right-style:hidden;"><input id="nilairek"  disabled name="nilairek" style="width:170px;text-align:right;" onkeypress="javascript:enter(event.keyCode,'add');return(currencyFormat(this,',','.',event))"/>
       <input type="hidden" id="cek_kas" name="cek_kas" style="width:170px;text-align:right;"/>
       <input  id="nilairekawal" type="hidden" name="nilairekawal" value="0" style="width:170px;text-align:right;"/>
       </td>
...
<h3><a href="#" id="section2" >Rincian Rekening</a></h3>
    ...
    <div>
        ...
        <tr>
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;" colspan="2">Standar Biaya</td>
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;"><input id="header_sb" style="width: 400px;" /></td>      
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;" colspan="3"><a href="javascript:void(0)" title="Sumber Data: sisb.pontianakkota" class="easyui-linkbutton" onclick="getNilai()">Set Standar Biaya</a></td>            
        </tr>
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
		...
		<tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
			...
			<i><b>Tekan Enter untuk simpan</b></i>
			</td>
        ...
        <td style="border-style: hidden;">
            ...
            <button hidden id="save1" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:detsimpan();">Simpan</button>
...
<h3><a href="#" id="section4" onclick="javascript:load_detail_keg();" >Detail Kegiatan</a></h3>
	...
	<tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
        ...
        <div id="toolbar1xa" >
    		<button id="save4" disabled class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:simpan_det_keg()">Simpan</button>
    		<button class="easyui-linkbutton" iconCls="icon-back" plain="true" onclick="javascript:section1()">Kembali</button>
        </div>
    </fieldset>    
	</div>   
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening">
    ...
    <table border='0' style="width:800px;">
         <tr>
            <input hidden type="text" name="total_murni" id="total_murni">
            <input hidden type="text" name="total_geser" id="total_geser">
            <input type="text" hidden name="kode_unik" id="kode_unik">
            <input hidden type="text" name="nomor_insert" id="nomor_insert">
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;" colspan="2">Standar Biaya</td>
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;"><input id="header_sb_edit" style="width: 400px;" /></td>      
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;" colspan="3"><a href="javascript:void(0)" title="Sumber Data: sisb.pontianakkota" class="easyui-linkbutton" onclick="getNilai_edit()">Set Standar Biaya</a></td>            
        </tr>        
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
