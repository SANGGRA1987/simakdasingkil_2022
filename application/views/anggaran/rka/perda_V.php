    ...
    $(function(){
        ...
        function cek($cetak,$jns){
            ...
            url="<?php echo site_url(); ?>/rka/preview_perdaV/"+ckdskpd+'/'+$cetak+'/Lampiran V - '+ckdskpd;
        ...
        function openWindow( url,$jns ){
            ...
            <tr>                
                ...
                <td >                     
                    ...
                    <a class="easyui-linkbutton" plain="true" onclick="javascript:cek(2,'FUNGSI');return false">                    
