  ...
  function ttd(){
        var skpd="<?php  
           ...
           $(function(){
            $('#ttd1').combogrid({  
            panelWidth:900,  
            url: '<?php echo base_url(); ?>/index.php/dpa_geser/cetak_dpa_rincianbelanja_geserController/load_tanda_tangan/'+skpd,  
                idField:'id_ttd',                    
                textField:'nama',
                mode:'remote',  
                fitColumns:true,  
        ...
        var skpd="<?php  
           ...
           $(function(){
            ...
            $('#ttd1').combogrid({  
                ...
                fitColumns:true,   
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/dpa_geser/cetak_dpa_rincianbelanja_geserController/load_tanda_tangan_bud/'+skpd,  
                columns:[[  
                    {field:'nip',title:'NIP',width:200},  
            ...
            $.ajax({
                ...
                success:function(data){
                      $.each(data, function(i,n){
                        ...
                        var urlx="<?php echo site_url(); ?>index.php/cetak_rka/preview_rincian_belanja_skpd_pergeseran/"+skpd+"/"+giat+"/1";
                        openWindow( urlx );
...
<br>
    ...
    <?php $sql=$this->db->query("SELECT left(a.kd_subkegiatan,12) giat, (select nm_kegiatan from m_kegiatan where kd_kegiatan=left(a.kd_subkegiatan,12) ) nm_kegiatan from trdrka a  where left(kd_skpd,17)=left('$skpd',17) AND left(kd_rek6,1)='5'  GROUP BY
left(a.kd_subkegiatan,12)"); 
    ...
    ?>
        <tr>
            ...
            <td width="25%" align="center"> 
                <a href="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_rincianbelanja_geserController/preview_rincian_belanja_skpd_pergeseran/<?php echo $skpd ?>/<?php echo $abc->giat; ?>/<?php echo '0';?> "class="button" plain="true" onclick="javascript:openWindow(this.href);return false"><img src="<?php echo base_url(); ?>assets/images/icon/print.png"  width="25" height="23" title="cetak"></a> 
                <a href="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_rincianbelanja_geserController/preview_rincian_belanja_skpd_pergeseran/<?php echo $skpd ?>/<?php echo $abc->giat; ?>/<?php echo '1';?> "class="button" plain="true" onclick="javascript:openWindow(this.href);return false"><img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png"  width="25" height="23" title="cetak"></a>
                <a href="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_rincianbelanja_geserController/preview_rincian_belanja_skpd_pergeseran/<?php echo $skpd ?>/<?php echo $abc->giat; ?>/<?php echo '2';?> "class="button" plain="true" onclick="javascript:openWindow(this.href);return false"><img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg"  width="25" height="23" title="cetak"></a>
                <a href="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_rincianbelanja_geserController/preview_rincian_belanja_skpd_pergeseran/<?php echo $skpd ?>/<?php echo $abc->giat; ?>/<?php echo '3';?> "class="button" plain="true" onclick="javascript:openWindow(this.href);return false"><img src="<?php echo base_url(); ?>assets/images/icon/word.jpg"  width="25" height="23" title="cetak"></a>
            </td>
        </tr>
    <?php endforeach; ?>
    </table>
