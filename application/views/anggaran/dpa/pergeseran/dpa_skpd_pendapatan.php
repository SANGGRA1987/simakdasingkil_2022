...
function ttd(skpd){
           $(function(){
            $('#ttd1').combogrid({  
            panelWidth:900,  
            url: '<?php echo base_url(); ?>/index.php/dpa_geser/cetak_dpa_rekap_geserController/load_tanda_tangan/'+skpd,  
                idField:'id_ttd',                    
                textField:'nama',
                mode:'remote',  
                fitColumns:true,  
...
function ttd2(){
           $(function(){
            ...
            $('#ttd1').combogrid({  
                ...
                fitColumns:true,   
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/dpa_geser/cetak_dpa_rekap_geserController/load_tanda_tangan_bud/'+skpd,  
                columns:[[  
                    {field:'nip',title:'NIP',width:200},  
    ...
    function cek(cetak){
        ...
        url="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_pendapatan_geserController/preview_pendapatan_pergeseran/"+ctglttd+'/'+ttd+'/'+ttd2+'/'+ckdskpd+'/'+cetak+'/'+doc+'/'+status_anggaran1+'/nilai_sempurna/RKA Pendapatan Penyusunan-'+ckdskpd;
    ...
    function cetakbawah(){ 
        ...
        var  status_anggaran1    = document.getElementById('status_anggaran1').value;
        var  status_anggaran2    = document.getElementById('status_anggaran2').value;
        url="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_pendapatan_geserController/preview_pendapatan_pergeseran/2020-1-1/tanpa/tanpa/"+ckdskpd+"/0/"+doc+"/"+status_anggaran1+"/nilai_sempurna/ Pendapatan Penyusunan-"+ckdskpd;        
        if(ckdskpd!=''){
