    ...
    var ctk = '1';
     ...
     $(function(){ 
        ...
        $('#skpd').combogrid({  
            ...
            textField:'kd_skpd',  
            mode:'remote',
            url:'<?php echo base_url(); ?>index.php/dpa_geser/cetak_dpa_rekap_geserController/skpduser_induk',  
            columns:[[  
...
function ttd(kode){
           $(function(){
            $('#ttd1').combogrid({  
            panelWidth:500,  
            url: '<?php echo base_url(); ?>/index.php/dpa_geser/cetak_dpa_rekap_geserController/load_tanda_tangan/'+kode,  
                idField:'id_ttd',                    
                textField:'nama',
                mode:'remote',  
                fitColumns:true,  
            ...
            $('#ttd2').combogrid({  
                ...
                fitColumns:true,   
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/dpa_geser/cetak_dpa_rekap_geserController/load_tanda_tangan_bud/'+kode,  
                columns:[[  
                    {field:'nip',title:'NIP',width:100},  
    ...
    function cek2(cetak){
        ...
        if(cekbok==false){
            var url="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_rekap_geserController/preview_dpa_skpd_pergeseran/"+ctglttd+'/'+ttd+'/'+ttd2+'/'+ckdskpd+'/'+cetak+'/hide/'+tipe_doc+'/'+cgaji+'/'+status_anggaran1+'/'+status_anggaran2+'/Cetak_RKA'+ckdskpd;
        }else{
            var url="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_rekap_geserController/preview_dpa_skpd_pergeseran/"+ctglttd+'/'+ttd+'/'+ttd2+'/'+ckdskpd+'/'+cetak+'/detail/'+tipe_doc+'/'+cgaji+'/'+status_anggaran1+'/'+status_anggaran2+'/Cetak_RKA'+ckdskpd;            
        }
    ...
    function cetakbawah(){
        ...
        if(cekbok==false){
            url="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_rekap_geserController/preview_dpa_skpd_pergeseran/2020-1-1/tanpa/tanpa/"+ckdskpd+"/0/hide/"+tipe_doc+"/"+cgaji+"/"+status_anggaran1+"/"+status_anggaran2+"/aa"; 
        }else{
            url="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_rekap_geserController/preview_dpa_skpd_pergeseran/2020-1-1/tanpa/tanpa/"+ckdskpd+"/0/detail/"+tipe_doc+"/"+cgaji+"/"+status_anggaran1+"/"+status_anggaran2+"/aa";
        }
        if(ckdskpd!=''){
