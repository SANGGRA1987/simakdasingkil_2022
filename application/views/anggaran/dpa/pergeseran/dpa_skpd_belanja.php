...
function ttd2(skpd){
    ...
    function cek(cetak){
        ...
        url="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_belanja_geserController/preview_belanja_pergeseran/"+ctglttd+'/'+ttd+'/'+ttd+'/'+ckdskpd+'/'+cetak+'/'+doc+'/'+status_anggaran1+'/'+status_anggaran2+'/'+doc+' Belanja Penyusunan-'+ckdskpd;
    ...
    function cetakbawah(){
        ...
        url="<?php echo site_url(); ?>/dpa_geser/cetak_dpa_belanja_geserController/preview_belanja_pergeseran/2020-1-1/tanpa/tanpa/"+ckdskpd+'/0/'+doc+'/'+status_anggaran1+'/'+status_anggaran2+'/'+doc+' Belanja Penyusunan-'+ckdskpd;        
        if(ckdskpd!=''){
