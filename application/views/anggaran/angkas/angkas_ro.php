...
<h3><a href="#" id="section1" >Anggaran Kas Belanja RO</a></h3>
   ...
   <p>
        <h3>S K P D&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="cc" name="skpd" style="width: 300px;"/><input type ='hidden' id="skpdd" name="skpdd" style="width: 400px;"/> </h3> <p id="p1"></p>
        <div id="kegi"><h3>SUB KEGIATAN&nbsp;&nbsp;&nbsp;&nbsp;<input id="ck" name="kegiatan" style="width: 300px;" /> 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <table align="center">
            ...
            <tr>
                <td colspan="4" align="center">
                    <p id="isi"></p>
                    <input type="submit" name="submit" id='kunci1' value="Simpan" onclick="javascript:simpan();"/>
                    <input type="submit" name="submit" id='kunci2' value="Kosongkan" onclick="javascript:kosongkan();"/>
                    <input type="submit" name="submit" id='kunci3'   value="Bagi Rata" onclick="javascript:bagi();"/>
