      ...
      function get_skpd(kd_s='',nm_s='',st_s='')
       ...
       function cek_status(){
            ...
            $.ajax({
                ...
                success:function(data){
                                        sta      = data.status_sem;
                                        sta_final= data.status_sem_final;
                                        tombol(sta,sta_final);
                                      }                                     
            });        
       }
...
*/        
    ...
    if (st=='1' && st_final=='1'){
            ...
            document.getElementById("p1").innerHTML="APBD PERGESERAN 2 TELAH DI - SAH - KAN...!!!";
            status_apbd = '1';
            
     } else if(st=='1' && st_final!='1'){
            ...
            document.getElementById("p1").innerHTML="APBD PERGESERAN 1 TELAH DI - SAH - KAN...!!!";
            status_apbd = '1';
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening Pergeseran">
    ...
    <table border='0' style="width:800px;">
        ...
        <tr>
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">*/Ketika Selesai Perbaiki Jangan Lupa Tekan Simpan</td>
        </tr> 
