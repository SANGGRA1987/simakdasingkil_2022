     ...
     function giat(kode){
          ...
          $(function(){  
            $('#ck').combogrid({
                ...
                columns:[[  
                    //{field:'kd_skpd',title:'Kode Kegiatan',width:130},
                    {field:'kd_kegiatan',title:'Kode Kegiatan',width:130},  
                    {field:'nm_kegiatan',title:'Nama Kegiatan',width:570}    
                ]], 
                onSelect:function(rowIndex,rowData){
...
//        }
    ...
    function simpan(){
        ...
        //var akum  = m-realtw1;
        //var akum2 = akum+(n-realtw2);
        //var akum3 = akum2+(o-realtw3);
        //var akum4 = akum3+(p-realtw4);
...
$(function(){      
         $.ajax({
            ...
            dataType:"json",
            success:function(data){ 
                             $("#realtriw1").attr("value",triw1);
                             $("#realtriw2").attr("value",triw2);
                             $("#realtriw3").attr("value",triw3);
                             $("#realtriw4").attr("value",triw4);
                     }
                });
