<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    var ctk = '';
		...
		$('#cunit').combogrid({  
            ...
            columns:[[  
                {field:'kd_skpd',title:'Kode USER',width:100},  
                {field:'nm_skpd',title:'Nama USER',width:700}    
            ]],
	...
	function cek($cetak,$jns){
         ...
         if ($('input[name="chkcover"]:checked').val()=='1'){
            url="<?php echo site_url(); ?>/rka/preview_coverdpa32/"+ckdskpd+'/'+$cetak+'/Report Cover DPA-3.2 -'+ckdskpd
         }else{
            url="<?php echo site_url(); ?>/rka/preview_dpa32/"+ckdskpd+'/'+$cetak+'/Report DPA-3.2 -'+ckdskpd
         } 
