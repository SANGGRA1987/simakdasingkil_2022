...
<head>
    ...
    $(function(){
	       ...
	       $('#dg').edatagrid({
				url           : '<?php echo base_url(); ?>/index.php/rka/select_rka_rancang',
                 idField      : 'id',
                 toolbar      : "#toolbar",              
                 rownumbers   : "true", 
                 fitColumns   : "true",
        ...
        $(function(){      
         $.ajax({
            ...
            url:"<?php echo base_url(); ?>index.php/rka/load_sum_rek_rinci_rka_penetapan",
            dataType:"json",
      ...
      function cek_status(){
		...
		function get_nilai_kua()
        {
            ...
            $.ajax({
        		...
        		url:'<?php echo base_url(); ?>index.php/rka/load_nilai_kua_rancang/'+kdskpd,
		...
		function get_nilai_kua2(nrek1)
        {
        	...
        	$.ajax({
        		url:'<?php echo base_url(); ?>index.php/rka/load_nilai_kua_rancang',
        		type: "POST",
        		dataType:"json",                         
        		success:function(data){
					  $.each(data, function(i,n){
        ...
        function validate_giat(){
            ...
            mode       : 'remote',
            url        : '<?php echo base_url(); ?>index.php/rka/pgiat_rancang/'+kdskpd,  
            columns    : [[  
...
*/			
    		if (lama==''){
    			...
    			$(function(){
    				$('#dg').edatagrid({
    				     url: '<?php echo base_url(); ?>/index.php/rka/tsimpan_rancang/'+cskpd+'/'+cgiat+'/'+baru+'/'+lama+'/'+nilai+'/'+sdana,
    					 idField:'id',
    					 toolbar:"#toolbar",              
    					 rownumbers:"true", 
    					 fitColumns:"true",
        ...
        function validate_combo(){
            ...
            $(function(){
			$('#dg').edatagrid({
				 url: '<?php echo base_url(); ?>/index.php/rka/select_rka_rancang/'+cgiat,
                 idField     : 'id',
                 toolbar     : "#toolbar",              
                 rownumbers  : "true", 
                 fitColumns  : "true",
        ...
        function validate_rek(){
            $(function(){
			$('#dg_rek').edatagrid({
				url          :  '<?php echo base_url(); ?>/index.php/rka/ld_rek_rancang/'+kegiatan+'/'+kdrek,
                idField      : 'id',                  
                rownumbers   : "true", 
                fitColumns   : "true",
                singleSelect : "true",
		...
		function hapus(){
                ...
                var cek_nil = document.getElementById('nilairek').value ;
				...
				if  (del==true){
					$(function(){
						$('#dg').edatagrid({
							 url: '<?php echo base_url(); ?>/index.php/rka/thapus_rancang/'+cskpd+'/'+cgiat+'/'+rek,
							 idField:'id',
							 toolbar:"#toolbar",              
							 rownumbers:"true", 
							 fitColumns:"true",
		...
		function hapus_rinci(){
            ...
            for (i=0; i < rows.length; i++) {
                ...
                alert('Uraian Telah dihilangkan, Jika Telah Selesai Harap Tekan Tombol simpan !')
		}
		...
		if (satuan3==""){
            ...
            $.ajax({
                ...
                url      : '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_rancang',
                success  : function(data){
                    status = data.pesan;
        ...
        */
		...
		cekgj = cgiat.substr(16,6);
		if((cekgj!='00.002') & (cekgj!='00.001')){
        ...
        if ( rows.length == 0 ) {
            ...
            $.ajax({
                    ...
                    url      : '<?php echo base_url(); ?>index.php/rka/thapus_rinci_ar_all_rancang',
                    success  : function(data){
                               }    
                        });
                    });
	...
	/*		cvolume2  = rows[i].volume2;
        ...
        $(document).ready(function(){
                $.ajax({
                    ...
                    url      : '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_jk_rancang',
                    success  : function(data){                        
                        status = data.pesan; 
                         if (status=='1'){               
        ...
        */
        ...
        $(function(){
			...
			$('#dg1').edatagrid({
				 ...
				 url           : '<?php echo base_url(); ?>/index.php/rka/rka_rinci_rancang',
                 idField      : 'id',
                 toolbar      : "#toolbar1",              
                 rownumbers   : "true", 
                 fitColumns   : false,
        ...
        function section(kdrek){
            ...
            $(document).ready(function(){
                ...
                $(function(){
        			$('#dg1').edatagrid({
       				     url          : '<?php echo base_url(); ?>/index.php/rka/rka_rinci_rancang/'+mskpd+'/'+mgiat+'/'+kdrek,
                         idField      : 'id',
                         toolbar      : "#toolbar1",              
                         rownumbers   : "true", 
                         fitColumns   : false,
    ...
    function load_sum_rek(){                
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b}),
            url:"<?php echo base_url(); ?>index.php/rka/load_sum_rek_rancang",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
    ...
    function load_sum_rek_rinci(c){                
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b,rek:c}),
            url:"<?php echo base_url(); ?>index.php/rka/load_sum_rek_rinci_rancang",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
    ...
    function tambah(){
        ...
        */
        ...
        $.ajax({
           ...
           url      : '<?php echo base_url(); ?>index.php/rka/tsimpan_ar_rancang', 
           success  : function(data){
                      st12 = data;
                      if ( st12 == '1' ){
                        alert("Data Tersimpan...!!!");
    ...
    function simpan_det_keg(){
		...
		$(function(){      
         $.ajax({
            ...
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/rka/simpan_det_keg_rancang",
			success:function(data){ 
					alert('Data Tersimpan');
					}
         });
    ...
    function load_detail_keg(){                
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b}),
            url:"<?php echo base_url(); ?>index.php/rka/load_det_keg_rancang",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
...
<h2><a href="#" id="section1" onclick="javascript:validate_combo()">Rekening Anggaran</a></h2>
   ...
   <div  style="height:700px;">      
       ...
       <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:170px;border-bottom-style:hidden;border-right-style:hidden;"><input id="nilairek" disabled name="nilairek" style="width:170px;text-align:right;" onkeypress="javascript:enter(event.keyCode,'add');return(currencyFormat(this,',','.',event))"/><input type="hidden" id="cek_kas" name="cek_kas" style="width:170px;text-align:right;"/><input id="nilairekcek" type="hidden" name="nilairek" style="width:170px;text-align:right;" onkeypress="javascript:enter(event.keyCode,'add');return(currencyFormat(this,',','.',event))"/></td>
...
<h3><a href="#" id="section4" onclick="javascript:load_detail_keg();" >Detail Kegiatan</a></h3>
	...
	<tr style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;">
		...
		<td colspan="3" style="border-spacing:0px ;padding:0px 0px 0px 0px;border-collapse:collapse;" > <input type="decimal" value='0.00' id="ang_lalu" style="width:190px;text-align: right;"  onkeypress="javascript:return(currencyFormat(this,',','.',event))"/></td>
