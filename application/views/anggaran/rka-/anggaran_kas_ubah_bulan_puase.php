...
/*    function get_realisasi_triw(ckegi){
        var b = ckegi;
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({keg:b}),
            url:"<?php echo base_url(); ?>index.php/rka/get_realisasi_triw",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    $("#rtr1").attr("value",n['nrtriw1']);
                    $("#rtr2").attr("value",n['nrtriw2']);
                    $("#rtr3").attr("value",n['nrtriw3']);
                    $("#rtr4").attr("value",n['nrtriw4']);
                });
            }
         });
        });
