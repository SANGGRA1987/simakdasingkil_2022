    ...
    $(function(){
           ...
           $('#dg').edatagrid({
                ...
                columns:[[
                    ...
                    {field:'nilaisempurna2',
                     title:'Nilai Pergeseran II',
                     width:30,
                     align:'right',
...
*/        
        ...
        function hapus_rinci(){
            ...
            for (i=0; i < rows.length; i++) {
                total_rinci+=angka(rows[i].total_sempurna_2);
            }
            $("#rektotal_rinci").attr("value",number_format(total_rinci,"2",'.',','));
            alert('Data Telah dihilangkan, Jika Rincian Sudah Sesuai Silahkan Tekan Tombol Simpan!');
        ...
        if (satuan3==""){
            ...
            $.ajax({
                ...
                url      : '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_sempurna_final',
                success  : function(data){
                    status = data.pesan;
...
*/
        ...
        for(var i=0;i<rows.length;i++){     
            ...
            cvolume_ubah1  = rows[i].volume_sempurna2;
            csatuan_ubah1  = rows[i].satuan_sempurna2;
            charga_ubah1   = angka(rows[i].harga_sempurna2);
            ctotal_ubah    = angka(rows[i].total_sempurna_2);               
            no        = i + 1 ;  
            

           
            if ( i > 0 ) {
                csql = csql+","+"('"+no+"','"+cheader+"','"+ckode+"','"+cgiat+"','"+crek+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume_ubah1+"','"+csatuan_ubah1+"','"+charga_ubah1+"','"+ctotal_ubah+"','"+cvolume2+"','"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"','"+cvolume_sempurna1+"','"+cvolume_ubah1+"','"+cvolume_sempurna1+"','"+cvolume_ubah1+"','"+cvolume3+"','"+cvolume_ubah1+"','"+csatuan_sempurna1+"','"+csatuan_ubah1+"','"+csatuan3+"','"+charga_sempurna1+"','"+ctotal_sempurna+"','"+charga_ubah1+"','"+ctotal_ubah+"')";
            } else {
                csql = "values('"+no+"','"+cheader+"','"+ckode+"','"+cgiat+"','"+crek+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume_ubah1+"','"+csatuan_ubah1+"','"+charga_ubah1+"','"+ctotal_ubah+"','"+cvolume2+"','"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"','"+cvolume_sempurna1+"','"+cvolume_ubah1+"','"+cvolume_sempurna1+"','"+cvolume_ubah1+"','"+cvolume3+"','"+cvolume_ubah1+"','"+csatuan_sempurna1+"','"+csatuan_ubah1+"','"+csatuan3+"','"+charga_sempurna1+"','"+ctotal_sempurna+"','"+charga_ubah1+"','"+ctotal_ubah+"')";                                            
        ...
        $(document).ready(function(){
                $.ajax({
                    ...
                    url      : '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_jk_sempurna_final',
                    success  : function(data){                        
                        status = data.pesan; 
                         if (status=='1'){               
        ...
        $(function(){
            ...
            $('#dg1').edatagrid({
                ...
                columns:[[
                    ...
                    {field:'volume_sempurna2',
                     title:'Vol Pergeseran II',
                     width:120,
                     align:'right'
                     },
                    {field:'satuan_sempurna2',
                     title:'Sat Pergeseran II',
                     width:120,
                     align:'left'
                     },
                    {field:'harga_sempurna2',
                     title:'Hrg Pergeseran II',
                     width:120,
                     align:'right'
                     },
                    {field:'total_sempurna_2',
                     title:'Total Pergeseran II',
                     width:170,
                     align:'right',
                     styler: function(value,row,index){
                                  return 'background-color:#d9e3fc;color:red;font-weight:bold;';
...
*/
    ...
    function append_save() {
            ...
            $('#dg1').edatagrid('appendRow',{header:o,kode:kode_header,uraian:uraian,volume_sempurna2:vol1,satuan_sempurna2:sat1,tvolume_sempurna:tvol,harga_sempurna2:fharga,total_sempurna_2:ftotal,volume_sempurna1:'0.00',satuan_sempurna1:'',tvolume_sempurna:'0.00',harga_sempurna1:'0.00',total_sempurna:'0.00',volume1:'0.00',satuan1:'',volume2:'0.00',satuan2:'',volume3:'0.00',volume:'0.00',satuan3:'',harga1:'0.00',id:id,total:'0.00'});
            $("#dg1").datagrid("unselectAll");
    ...
    function pilih_edit(){
            ...
            $('#dg1').edatagrid('updateRow',{index:idx_ins_edit,row:{header:o,kode:kode_edit,uraian:uraian_edit,volume_sempurna2:volu1_edit,satuan_sempurna2:sat1_edit,volume_sempurna:tvol_edit,harga_sempurna2:fharga_edit,total_sempurna_2:ftotal_edit}});
    ...
    function insert_row() {
            ...
            $('#dg1').edatagrid('insertRow',{index:idx_ins,row:{header:o,kode:kode_header,uraian:uraian,volume_sempurna2:volu1,volume_sempurna1:'0.00',volume1:'0.00',satuan_sempurna2:sat1,satuan_sempurna1:' ',harga_sempurna2:harga,harga_sempurna1:'0.00',total_sempurna_2:total,total_sempurna:'0.00',satuan1:' ',volume2:'0.00',satuan2:'',volume3:'0.00',volume:'0.00',satuan3:'',harga1:'0.00',id:id,total:'0.00',id:idx_ins,no_po:idx_ins}});
            $("#dg1").datagrid("unselectAll");
...
<h2><a href="#" id="section1" onclick="javascript:validate_combo()">Rekening Anggaran Pergeseran II</a></h2>
   ...
   <div  style="height:700px;">      
       ...
       <table id="dg" title="Input Rekening Rencana Kegiatan Anggaran Pergeseran II" style="width:880px;height:400px;" >          
       </table>  
        <div id="toolbarx">
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening Anggaran Pergeseran II">
