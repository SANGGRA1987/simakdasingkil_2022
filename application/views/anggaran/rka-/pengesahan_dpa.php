...
<div id="dialog-modal" title="">
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <td width="1%">:</td>
            <td><input type="checkbox" id="stsdpasempurna_final"  onclick="javascript:runEffect();"/></td>
            </tr>
            <tr>
                <td width="30%">NO. DPA PERGESERAN 2</td>
                <td width="1%">:</td>
                <td><input type="text" id="dpasempurna_final" style="width:100px;"/></td>  
            </tr>
            
            <tr>
                <td width="30%">TGL DPA PERGESERAN 2</td>
                <td width="1%">:</td>
                <td><input type="text" id="tgldpasempurna_final" style="width:100px;"/></td>  
            </tr>
			<tr>
