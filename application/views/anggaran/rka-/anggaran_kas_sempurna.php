    ...
    function simpan(){
        ...
        $(function(){      
         $.ajax({
            ...
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/rka/simpan_trskpd_sempurna",
            success:function(data){
                if (data = 1){
    ...
    function load(){ 
        ...
        $(function(){      
         $.ajax({
            ...
            url:"<?php echo base_url(); ?>index.php/rka/load_trdskpd_sempurna",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    bulan = n['bulan'];
...
<div id="accordion">
<h3><a href="#" id="section1">Anggaran Kas Pergeseran</a></h3>
   ...
   <p>
        ...
        <br /><input id="s" type="submit" name="submit" value="Input Anggaran Kas Pergeseran" onclick="javascript:section2();"/><br /><br />
...
<h3><a href="#" id="section2"></a></h3>
    ...
    <div class="result">
        <table align="center">
            <tr>
                <td><b>Total Anggaran Pergeseran</td>
