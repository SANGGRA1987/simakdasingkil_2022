 ...
 function tombol2(stax){  
	...
	function cek($cetak,$jns){
         ...
         if ($('input[name="chkcover"]:checked').val()=='1'){
            url="<?php echo site_url(); ?>/rka/preview_coverdpa21/"+ckdskpd+'/'+$cetak+'/Report Cover DPA-2.1 -'+ckdskpd
         }else{
            ...
            url="<?php echo site_url(); ?>/rka/preview_dpa21/"+ckdskpd+'/'+$cetak+'/'+cpa+'/'+cell+'/Report DPA-2.1 -'+ckdskpd
         } 
