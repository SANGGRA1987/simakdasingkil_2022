...
//			get_spd();
    ...
    function load_angkas(){
        ...
        var tgl1 = $('#tanggal').datebox('getValue');
        	...
        	$(document).ready(function(){
    			$('#dg1').edatagrid({
    				 url: '<?php echo base_url(); ?>/index.php/rka/load_dspd_bl_angkas/52/'+kode+'/'+bln1+'/'+bln2+'/'+cnomor,
...
//			get_spd();
    ...
    function get_total_refisi() {
		...
		var cnomor =cno.split("/").join("123456789");	
        	...
        	$.ajax({
				 url: '<?php echo base_url(); ?>/index.php/rka/load_tot_dspd_bl_angkas/52/'+kode+'/'+bln1+'/'+bln2+'/'+cnomor+'/'+tgl1+'/'+refisi,
        		type: "POST",
        		dataType:"json",   
        		success:function(data){
...
<div id="content">    
<div id="accordion">
<h3><a href="#" id="section1">SPD BL REFISI</a></h3>
    <div>
    <p align="right">         
...
<h3><a href="#" id="section2"><b id="p1" style="font-size:17px;color: red;"></b></a></h3>
   ...
   <p>       
           ...
           <tr>
			...
			<td>			
				<select name="refke" id="refke">
                 <option value="0">Sebelum Refisi</option>
				 <option value="1">Refisi ke-1</option>
				 <option value="2">Refisi ke-2</option>				
				 </select>
		      </td>
              <td style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;border-right-style:hidden;"></td>
                <td style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;border-right-style:hidden;">Tanggal Refisi</td>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td ></td>
            <td align="right">Total Sesudah Refisi: <input type="text" id="total_refisi" style="font-size: large;border:0;width: 200px;text-align: right;" readonly="true"/></td>
        </tr>
        </table>
...
<div id="dialog-cetak" title="Cetak SPD REFISI" >
