       ...
       function cek_status(){
              ...
              //  alert(ncekreal);
               ...
               // alert(nrealkegsemp);
                ...
                if ( ncekreal < nrealkegsemp ) {
                    alert('ncekreal lebih kecil dari nrealkegsemp 1 < 3 Nilai Penyempurnaan Tidak Boleh lebih kecil dari Realisasi...!!!');
                    exit();
                }
        ...
        //kapi    
            ...
            $.ajax({
                type     : "POST",       
                dataType : 'json',         
                data     : ({skpd:cskpd,skpdbp:cskpd2,giat:cgiat,rek:rk,id:idx,uraian:uraian,volum1:volum1,satuan1:satuan1,harga1:harga1,volum2:volum2,satuan2:satuan2,volum3:volum3,satuan3:satuan3}),
                url      : '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_sempurna',
                success  : function(data){
                    status = data.pesan;
    ...
    /*      cvolume2  = rows[i].volume2;
        ...
        $(document).ready(function(){
                $.ajax({
                    type     : "POST",   
                    dataType : 'json',                 
                    data     : ({no:norka,sql:csql,skpd:cskpd,skpdbp:cskpd2,giat:cgiat}),
...
*/        
    ...
    function tambah(){
        ...
        $.ajax({
           type     : "POST",
           dataType : "json",
           data     : ({kd_skpd:skpd,kd_skpd2:skpd2,kd_kegiatan:kegi,kd_rek5:reke,nilai:nrek,nilaimurni:nmurni,dana1:sdana1,dana2:sdana2,dana3:sdana3,dana4:sdana4}),
