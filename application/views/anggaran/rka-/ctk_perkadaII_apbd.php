<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function cek($cetak,$jns){
        ...
        if ($jns=='all'){
             var corg = 'all';       
 	          ...
 	          url="<?php echo site_url(); ?>/rka/preview_perkadaII_apbd/"+corg+'/'+$cetak+'/'+chkrancang+'/Laporan Penjabaran APBD.pdf ['+corg+']';
 ...
 function openWindow( url,$jns ){
	...
	<div id="content">        
        ...
        <tr>
                <td><input type="checkbox" name="chkrancang" id="chkrancang" value="1"/> Rancangan
                </td>
                <td>&ensp;</td>
                <td>&nbsp</td>
            </tr>
