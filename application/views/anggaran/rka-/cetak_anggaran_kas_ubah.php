   ...
   function cetak($ctk)
        {
			...
			if(cetak==2){
				url="<?php echo site_url(); ?>/rka/preview_anggaran_kas_ubah/"+skpd+'/'+cetak+'/'+cell+'/Report_Anggaran_Kas_Perubahan'+skpd+'.xls';
			}else{
	           url="<?php echo site_url(); ?>/rka/preview_anggaran_kas_ubah/"+skpd+'/'+cetak+'/'+cell+'/Report_Anggaran_Kas_Perubahan'+skpd;
			}
...
<h3>Cetak Anggaran Kas Perubahan</h3>
<div id="accordion">
