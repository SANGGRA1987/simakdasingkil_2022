...
//			set_grid();
    ...
    function validate2(){
		...
		if (bln2 < bln1){
			...
			$(document).ready(function(){
    			$('#dg1').edatagrid({
    				 url: '<?php echo base_url(); ?>/index.php/rka/load_dspd_btl/51/'+kode+'/'+bln1+'/'+bln2+'/'+cnomor,
...
//			get_spd();
    ...
    function load_angkas(){
        ...
        var tgl1 = $('#tanggal').datebox('getValue');
        	...
        	$(document).ready(function(){
    			$('#dg1').edatagrid({
    				 url: '<?php echo base_url(); ?>/index.php/rka/load_dspd_btl_angkas/51/'+kode+'/'+bln1+'/'+bln2+'/'+cnomor,
