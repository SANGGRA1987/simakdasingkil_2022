 ...
 function validate_ttd(kods){
    ...
    function cek($cetak,$jns){
         ...
         if ($('input[name="chkcover"]:checked').val()=='1'){
            url="<?php echo site_url(); ?>/rka/preview_coverrka1/"+ckdskpd+'/'+$cetak+'/Report Cover RKA-1'
         }else{
            ...
            url="<?php echo site_url(); ?>/rka/preview_rka1/"+ckdskpd+'/'+$cetak+'/'+cpa+'/'+cell+'/Report RKA-1'
         } 
