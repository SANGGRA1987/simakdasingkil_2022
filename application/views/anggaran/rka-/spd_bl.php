...
function cekangxx(skpd){
          ...
          var jn ='52';
          $.ajax({
            url:'<?php echo base_url(); ?>index.php/rka/jumlah_detail_angkas_spd_baru/',
            type: "POST",
            dataType:"json",   
                data: ({jn:jn,skp:skp}),                      
            success:function(data){
...
//			set_grid();
    ...
    if ((bln1==10) && (bln2!=12)){
		...
		if (bln2 < bln1){
			...
			$(document).ready(function(){
    			$('#dg1').edatagrid({
    				 url: '<?php echo base_url(); ?>/index.php/rka/load_dspd_bl/52/'+kode+'/'+bln1+'/'+bln2+'/'+cnomor,
     ...
     function get_total() {
		...
		var cnomor =cno.split("/").join("123456789");		
        	$.ajax({
				 url: '<?php echo base_url(); ?>/index.php/rka/load_tot_dspd_bl/52/'+kode+'/'+bln1+'/'+bln2+'/'+cnomor+'/'+tgl1,
        		type: "POST",
        		dataType:"json",   
        		success:function(data){
...
<div id="content">    
<div id="accordion">
<h3><a href="#" id="section1">List SPD BL</a></h3>
    <div>
    <p align="right">         
