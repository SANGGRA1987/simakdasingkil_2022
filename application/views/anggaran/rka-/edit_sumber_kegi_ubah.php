...
<head>
     ...
     $(document).ready(function() {
      ...
      $(function(){
        $('#cc').combogrid({  
         ...
         $(function(){ 
         $('#dg').edatagrid({
    		url: '<?php echo base_url(); ?>/index.php/rka/kegi_sumber_ubah',
            idField:'id',
            toolbar:"#toolbar",              
            rownumbers:"true", 
            fitColumns:"true",
      ...
      function giat(kode){
        $(function(){  
            $('#dg').edatagrid({
    		  url: '<?php echo base_url(); ?>/index.php/rka/kegi_sumber_ubah/'+kode
            });
        });
      }
      ...
      function edit_data(kd_k){        
        if (initket==2){
            alert('Modul ini hanya bisa digunakan untuk kegiatan yang memiliki 1 sumber')
        }else{
        lcstatus = 'edit';
    ...
    function simpan(){
        ...
        */
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>/index.php/rka/update_sumber_kegi_ubah',
            data: ({kegi:ckode,csumber1:csumber}),
            dataType:"json",
...
<div id="accordion">
<h3><a href="#" id="section1">Sumber Dana Perubahan Per Kegiatan</a></h3>
   <div  style="height: 350px;">
   <p>  
        <h3>S K P D&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="cc" name="skpd" style="width: 400px;"/> </h3>
        <h3>&nbsp;</h3>
        <h3 style="color: red;">"*)Pilih SKPD, lalu double click kegiatan pada tabel untuk edit !"</h3>
