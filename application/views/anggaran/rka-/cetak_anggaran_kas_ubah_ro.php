   ...
   function cetak($ctk)
        {
			...
			if(cetak==2){
				url="<?php echo site_url(); ?>/rka_ro/preview_anggaran_kas_ubah_ro/"+skpd+'/'+cetak+'/'+cell+'/Report_Anggaran_Kas_Ubah'+skpd+'.xls';
			}else{
	           url="<?php echo site_url(); ?>/rka_ro/preview_anggaran_kas_ubah_ro/"+skpd+'/'+cetak+'/'+cell+'/Report_Anggaran_Kas_Ubah'+skpd;
			}
...
<h3>CETAK ANGGARAN KAS RO PERUBAHAN</h3>
<div id="accordion">
