...
/*      $(document).ready(function() {
	...
	url="<?php echo site_url(); ?>/rka/preview_rka22_baru/"+ckdskpd+'/'+$cetak+'/';
	if(ctk==''){
	alert("Pilih Jenis Laporan");
	exit();
		} else if ($('#skpd').combogrid('getValue')==''){
		alert("Pilih Nama SKPD Terlebih Dahulu")
			} else if ($('#tgl_ttd').datebox('getValue')==''){
			alert("Pilih Tanggal TTD Terlebih Dahulu")
			}	else {
...
<div id="content1" align="center"> 
    <h3 align="center"><b>CETAK RKA 22</b></h3>
