...
/*		function get_nilai_kua()
	...
	/*		
            ...
            if ( i > 0 ) {
                csql = csql+","+"('"+no+"','"+norka+"','"+cpenerima+"','"+calamat+"','"+ctotal+"','"+ccad1+"','"+cuser+"',getdate())";
            } else {
                csql = "values('"+no+"','"+norka+"','"+cpenerima+"','"+calamat+"','"+ctotal+"','"+ccad1+"','"+cuser+"',getdate())";                                            
        ...
        $(document).ready(function(){
                $.ajax({
                    ...
                    url      : '<?php echo base_url(); ?>/index.php/rka/tsimpan_alokasidanarinci_jk',
                    success  : function(data){                        
                        status = data.pesan; 
                         if (status=='1'){               
        			...
        			$('#dg1').edatagrid({
						 ...
						 onSelect     : function(rowIndex,rowData){
                                       ...
                                       */
                                       ...
                                       $("#total_edit").attr("value",rowData.total);
									   $("#totallama_edit").attr("value",rowData.total);
                       },
    ...
    if (st=='1'){
       ...
       function insert_row() {
            ...
            $('#dg1').edatagrid('insertRow',{index:idx_ins,row:{cad1:cad1,penerima:penerima,alamat:alamat,total:total}});
            $("#dg1").datagrid("unselectAll");
   ...
   function append_save() {
			...
			//alert(''+id);
            $('#dg1').edatagrid('appendRow',{id:id,cad1:cad1,penerima:penerima,alamat:alamat,total:ftotal});
            $("#dg1").datagrid("unselectAll");
 ...
 /*    function pilih_std(){
    ...
    function pilih_edit(){
            ...
            $('#dg1').edatagrid('updateRow',{index:idx_ins_edit,row:{cad1:cad1_edit,penerima:penerima_edit,alamat:alamat_edit,total:ftotal_edit}});
            $("#dg1").datagrid("unselectAll");
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening">
    ...
    <table border='0' style="width:800px;">
        ...
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">
            ...
            <td style="border-spacing:3px ;padding:3px 3px 3px 3px;border-bottom-color:black;"><input type="text" id="total_edit" style="width: 175px; text-align: right;"  onkeypress="return(currencyFormat(this,',','.',event))"/>
            </td>
        </tr> 
