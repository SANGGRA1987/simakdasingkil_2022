    ...
    var kegiatan='';
     ...
     $('#dg').edatagrid({
        ...
        columns:[[
    		...
    		title:'Nama Rekening',
    		width:200},
            {field:'nilai_akhir_sempurna',
    		title:'Nilai Pergeseran Final',
    		width:100,
            align:"right"}
        ]]
    });
       ...
       var b =  $('#ck').combogrid('getValue');
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b}),
            url:"<?php echo base_url(); ?>index.php/rka/realisasi_angkas",
            dataType:"json",
...
//        }
    ...
    function simpan(){
        ...
        $(function(){      
         $.ajax({
            ...
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/rka/simpan_trskpd_sempurna_final",
            success:function(data){
                if (data = 1){
    ...
    function load(){ 
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({p:kegiatan,jns:'pergeseran'}),
            url:"<?php echo base_url(); ?>index.php/rka/load_trdskpd_sempurna_final",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    bulan = n['bulan'];
...
<div id="accordion">
<h3><a href="#" id="section1">Anggaran Kas Pergeseran Final</a></h3>
   ...
   <p>
        ...
        <br /><input id="s" type="submit" name="submit" value="Input Anggaran Kas Pergeseran Final" onclick="javascript:section2();"/><br /><br />
        
        
        <table id="dg" title="Rekening Rencana Kegiatan Anggaran Pergeseran Final" style="width:870px;height:350px;" >  
        </table>  
   </p>
    </div>
...
<h3><a href="#" id="section2"></a></h3>
    ...
    <div class="result">
        <table align="center">
            <tr>
                <td><b>Total Anggaran Pergeseran Final</td>
            ...
            <tr>
                <td><b>Total Anggaran Kas Pergeseran Final</td>
