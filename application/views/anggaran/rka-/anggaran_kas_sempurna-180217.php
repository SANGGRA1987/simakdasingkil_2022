...
<div id="accordion">
<h3><a href="#" id="section1">Anggaran Kas Penyempurnaan</a></h3>
   ...
   <p>
        ...
        <br /><input id="s" type="submit" name="submit" value="Input Anggaran Kas Penyempurnaan" onclick="javascript:section2();"/><br /><br />
...
<h3><a href="#" id="section2"></a></h3>
    ...
    <div class="result">
        <table align="center">
            <tr>
                <td><b>Total Anggaran Penyempurnaan</td>
