    ...
    function simpan(){
        ...
        $(function(){      
         $.ajax({
            ...
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/rka_ro/simpan_trskpd_sempurna_ro",
            success:function(data){
                if (data = 1){
    ...
    function load(){         
        ...
        $(function(){      
         $.ajax({
            ...
            url:"<?php echo base_url(); ?>index.php/rka_ro/load_trdskpd_sempurna",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    bulan = n['bulan'];
...
<div id="accordion">
<h3><a href="#" id="section1">Anggaran Kas Belanja Pergeseran RO</a></h3>
...
<h3><a href="#" id="section2"></a></h3>
    ...
    <div class="result">
        <table align="center">
            ...
            <tr>
                <td><b>Total Anggaran Kas Pergeseran Kegiatan</b></td>
            ...
            <tr>
                <td><b>Total Anggaran Kas Pergeseran</td>
