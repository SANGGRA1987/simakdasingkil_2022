       ...
       // $('#frm_ctk').attr('action',urll);                        
		...
		function cetak(pilih)
        {
			...
			if(ctk==2){
				...
				var kdorg   = kd_org; 
				if(spj==1){
				var url    = '<?php echo site_url(); ?>/lamp_perda/cetak_lamp_semester_rinci_org_spj/'+bulan+'/'+pilih+'/'+anggaran+'/'+kdorg+'/'+jenis+'/'+ctglttd+'/'+ttd+'/'+spj; 
				}else{
				var url    = '<?php echo site_url(); ?>/lamp_perda/cetak_lamp_semester_rinci_org_sp2d/'+bulan+'/'+pilih+'/'+anggaran+'/'+kdorg+'/'+jenis+'/'+ctglttd+'/'+ttd+'/'+spj; 
				}	
			}
