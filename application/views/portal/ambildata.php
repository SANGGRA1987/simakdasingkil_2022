  ...
  <style>    
    ...
    function lihatdata(){
      ...
      if(parkey=="4e732ced3463d06de0ca9a15b6153677"){
        var urlll = '<?php echo base_url(); ?>/index.php/service_portal/load_getdata_prog';  
        get_setprog();
      }else{
        var urlll = '<?php echo base_url(); ?>/index.php/service_portal/load_getdata_renja';  
        get_setrenja();
      }
      
      
      var judulx = document.getElementById('hjudul').value;
      $("#judul_lihat").attr("Value",judulx);
      
      $(function(){ 
                $('#dg_view_simakda').edatagrid({
	           	url: urlll,
                queryParams:({no:parkey,th:parth,skpd:parskpd})
                });        
                });
                
      //}else{
      //      alert("Lakukan Proses Request Ke PORTAL Terlebih Dahulu");
      //      exit();
      //}  
...
<div id="accordion">
    ...
    <p align="right">         
        ...
        <tr>
            ...
            <td></td>
            <td align="left">
            <a class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:lihatdata_prog();">Lihat Data Program Kegiatan</a>
            <a class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:lihatdata_renja();">Lihat Data Renja</a>
