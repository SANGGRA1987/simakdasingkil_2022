  ...
  function load_ttd_skpd(kdskpd){
    ...
    function cetak($pilih){
            ...
            if(ctk==1){
    			...
    			window.open(urll+'/'+pilih+'/'+ttd1+'/'+ttd2+'/'+tgl_ttd+'/'+csskpd+'/'+status_ang,'_blank');
    			window.focus();
...
<div id="">
    ...
    <p align="right">         
        ...
        <tr>
        <td width="922px" colspan="2"><input type="radio" name="cetak" value="1" id="status" onclick="opt(this.value)" /><b>SKPD</b>
                    <div id="kode_skpd">
                        <table style="width:100%;" border="0">
                            <tr >
                    			<td width="22px" height="40%" ><B>&nbsp;&nbsp;</B></td>
        ...
        <tr>
                ...
                <div id="div_periode">
                        <table style="width:100%;" border="0">
                            ...
                            &nbsp;<b>Jenis Anggaran: &nbsp;</b><input type="radio" name="status_ang" value="1" id="status_ang" onclick="opt_ttd(this.value)" /> <b>Murni</b> &nbsp;
                            ||&nbsp;<input type="radio" name="status_ang" value="2" id="status_ang" onclick="opt_ttd(this.value)" /> <b>Perubahan</b>                           
