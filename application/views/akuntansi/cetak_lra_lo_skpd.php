  ...
  $('#ttd').combogrid({  
	...
	function cetak($pilih){
			...
			cbulan = $('#bulan').combogrid('getValue');
				...
				urll ='<?php echo base_url(); ?>index.php/akuntansi/cetak_lra_lo_skpd/'+cbulan+'/'+kdskpd;
				if (bulan==''){
    			...
    			window.open(urll+'/'+pilih+'/LO Jenis', '_blank');
    			window.focus();
	...
	function cetak_obyek($pilih){
			...
			cbulan = $('#bulan').combogrid('getValue');
				...
				urll ='<?php echo base_url(); ?>index.php/akuntansi/cetak_lra_lo_obyek/'+cbulan+'/'+kdskpd;
				if (bulan==''){
				alert("Pilih Bulan dulu");
				exit();	
				}
    			...
    			//var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_lo";	  
    			window.open(urll+'/'+pilih+'/LO Obyek', '_blank');
    			window.focus();
    ...
    function cetak_rincian($pilih){
			...
			cbulan = $('#bulan').combogrid('getValue');
				...
				urll ='<?php echo base_url(); ?>index.php/akuntansi/cetak_lra_lo_rincian/'+cbulan+'/'+kdskpd;
				if (bulan==''){
				alert("Pilih Bulan dulu");
				exit();	
				}
    			...
    			//var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_lo";	  
    			window.open(urll+'/'+pilih+'/LO Rincian', '_blank');
    			window.focus();
...
<div id="accordion">
    ...
    <p align="right">         
		...
		<tr >
            ...
            <a class="easyui-linkbutton" iconCls="icon-word" plain="true" onclick="javascript:cetak_obyek(3);">Word</a></td>
			</td>
		</tr>
        <tr >
            ...
            <a class="easyui-linkbutton" iconCls="icon-word" plain="true" onclick="javascript:cetak_rincian(3);">Word</a></td>
			</td>
		</tr>
        </table>                      
    </p> 
