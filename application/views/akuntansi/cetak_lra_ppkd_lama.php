...
<head>
  ...
  <style>    
    ...
    function cetak($ctk)
        {
            var cetak =$ctk;           	
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_ppkd";	  
			 ctglttd = $('#tgl_ttd').datebox('getValue');
        
            ctgl1 =  cbulan = $('#bulan').combogrid('getValue');
            cttd =  cbulan = $('#ttd').combogrid('getValue');
          
            lc = '?tgl1='+ctgl1+'&tgl_ttd='+ctglttd+'&c_ttd='+cttd;
...
<h3>CETAK LAPORAN REALISASI ANGGARAN PPKD</h3>       
<div id="accordion">
    ...
    <p align="right">         
        ...
        <tr>
                ...
                <div id="div_ttd">
                        <table style="width:100%;" border="0">
                            <td width="20%" height="40%">BUD&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong></strong></td>
							<td width="1%">:</td>
		...
		<tr >
			<td colspan="2"><a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak(0);">Cetak</a>
            <a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak(1);">PDF</a>
            <a class="easyui-linkbutton" iconCls="icon-word" plain="true" onclick="javascript:cetak(2);">Cetak excel</a></td>
		</tr>
