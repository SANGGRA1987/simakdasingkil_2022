	...
	return choice;
     ...
     $(document).ready(function() {
       ...
       $('#sskpd').combogrid({  
		...
		textField:'kd_skpd',  
		mode:'remote',
		url:'<?php echo base_url(); ?>index.php/akuntansi/skpd_kolom3',  
		columns:[[  
			{field:'kd_skpd',title:'Kode SKPD',width:100},  
...
function mapping_lo(){
/*    var bln = '12';
    AddItems('Penghitungan LO '+nmx+' Sampai dengan Bulan Desember TA 2016!','','0');
	AddItems('Loading......................','','0');
	hit_record2(bln);
*/
    ...
    $(document).ready(function(){
				$.ajax({
					type: "POST",
					url: '<?php echo base_url(); ?>/index.php/akuntansi/posting_lo_kolom',
...
function ambil_apbd_wsdl(baris,ahir,bln,interval,rrrrr){
			...
			$(document).ready(function(){
				$.ajax({
					type: "POST",
					url: '<?php echo base_url(); ?>/index.php/akuntansi/proses_mapping_lo_konsols',
...
function hit_record2(bln){
			...
			$(document).ready(function(){
				$.ajax({
					type: "POST",
					url: '<?php echo base_url(); ?>/index.php/akuntansi/jum_record_lo_konsols',
					data: ({skpd37:kdskpd}),
					dataType:"json",
					success:function(data){
						//alert(data.jumlah);
...
function AddItems(isi,pesan,tambah)
    	...
    	function cetaklo(ctk)
        {
            ...
            var  ttd_2 = $('#ttdx1').combogrid('getValue');            
			...
			window.open(url+'/'+bulanctk+'/'+cetak+'/'+initx+'/'+ctglttd+'/'+ttd2+'/'+label, '_blank');			
			window.focus();
        }
        
        
    	function cetaklo1(ctk)
        {
			/*var txt;
			var r = confirm("Pilih [OKE] untuk Cetak menggunakan Tanda Tangan");
			if (r == true) {
            ...
            var cetak =ctk;           	
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lo_konsol_gab_real_calk";	  
			window.open(url+'/'+bulanctk+'/'+cetak+'/'+initx+'/'+ctglttd+'/'+label, '_blank');			
			window.focus();
        }
		
		function cetaklogab(ctk)
        {
			/*var txt;
			var r = confirm("Pilih [OKE] untuk Cetak menggunakan Tanda Tangan");
			if (r == true) {
			...
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lo_konsol_gab";	  
			//window.open(url+'/'+cetak+'/'+txt, '_blank');
			window.open(url+'/'+bulanctk+'/'+cetak+'/'+label, '_blank');			
            window.focus();
        }	

		function cetaklogab_konsol(ctk)
        {
            var cbulan = $('#bulanctk').datebox('getValue'); 
            var cetak =ctk;           	
            var label = document.getElementById('label').value;
            
			var url    = "<?php echo site_url(); ?>/akuntansi/rpt_lo_konsol_skpd";	  
			window.open(url+'/'+bulanctk+'/'+cetak+'/'+label, '_blank');
			window.focus();
        }		

		function cetaklogab_sap(ctk)
        {   
            ...
            var label = document.getElementById('label').value;
            var cetak =ctk;           	
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lo_sap_gab";	  
			window.open(url+'/'+bulanctk+'/'+cetak+'/'+initx+'/'+ttd2+'/'+ctglttd+'/'+label, '_blank');
			window.focus();
        }		
...
<h3>LAPORAN LO PEMKOT GABUNGAN</h3>       
<div id="accordion">
    ...
    <p align="right">         
		...
		<tr>
                <td colspan="3" align="center"><INPUT TYPE="button" VALUE="POSTING LO SKPD" style="height:40px;width:180px" onclick="mapping_lo()" >&nbsp;
		...
		<tr >
			<td align ='left'>PEMKOT KESELURUHAN (TANPA POSTING) &nbsp;&nbsp;</td> 
			<td align ='left'>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklogab_sap(0);">Cetak Layar</a>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklogab_sap(1);">Cetak PDF</a>
            <a id="cetak1" class="easyui-linkbutton" disabled iconCls="icon-excel" plain="true" onclick="javascript:cetaklogab_sap(2);">Cetak excel</a>
            <a id="cetak2" class="easyui-linkbutton" disabled iconCls="icon-word" plain="true" onclick="javascript:cetaklogab_sap(3);">Cetak word</a></td>
		</tr>                         
		<tr >
			<td align ='left'>PEMKOT KESELURUHAN (CALK) &nbsp;&nbsp;</td> 
			<td align ='left'>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklo1(0);">Cetak Layar</a>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklo1(1);">Cetak PDF</a>
            <a id="cetak1" class="easyui-linkbutton" disabled iconCls="icon-excel" plain="true" onclick="javascript:cetaklo1(2);">Cetak excel</a>
            <a id="cetak2" class="easyui-linkbutton" disabled iconCls="icon-word" plain="true" onclick="javascript:cetaklo1(3);">Cetak word</a></td>
		</tr>             
		<tr >
			<td align ='left'>PEMKOT KESELURUHAN &nbsp;&nbsp;</td> 
			<td align ='left'>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklo(0);">Cetak Layar</a>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklo(1);">Cetak PDF</a>
            <a id="cetak1" class="easyui-linkbutton" disabled iconCls="icon-excel" plain="true" onclick="javascript:cetaklo(2);">Cetak excel</a>
            <a id="cetak2" class="easyui-linkbutton" disabled iconCls="icon-word" plain="true" onclick="javascript:cetaklo(3);">Cetak word</a></td>
		</tr>
		<tr >			
			<td align ='left'>PEMKOT GABUNGAN &nbsp;&nbsp;</td> 
			<td align ='left'>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklogab(0);">Cetak Layar</a>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklogab(1);">Cetak PDF</a>
            <a id="cetak1" class="easyui-linkbutton" disabled iconCls="icon-excel" plain="true" onclick="javascript:cetaklogab(2);">Cetak excel</a>
            <a id="cetak2" class="easyui-linkbutton" disabled iconCls="icon-word" plain="true" onclick="javascript:cetaklogab(3);">Cetak word</a></td>
		</tr>	
		<tr >			
			<td align ='left'>PER SKPD &nbsp;&nbsp;</td> 
			<td align ='left'>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklogab_konsol(0);">Cetak Layar</a>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklogab_konsol(1);">Cetak PDF</a>
            <a id="cetak1" class="easyui-linkbutton" disabled iconCls="icon-excel" plain="true" onclick="javascript:cetaklogab_konsol(2);">Cetak excel</a>
            <a id="cetak2" class="easyui-linkbutton" disabled iconCls="icon-word" plain="true" onclick="javascript:cetaklogab_konsol(3);">Cetak word</a></td>
		</tr>	
        </table>   
