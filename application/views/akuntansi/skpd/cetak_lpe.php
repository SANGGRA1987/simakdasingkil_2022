...
$(function(){   
    ...
    function cetak($pilih){
            ...
            urll ='<?php echo base_url(); ?>index.php/akuntansi_skpd/ctk_lpe/'+cbulan;
				if (bulan==''){
    			...
    			window.open(urll+'/'+pilih+'/'+tgl_ttd+'/'+ttd1+'/'+ttd2+'/'+kdskpd+'/'+pilihanttd+'/'+label+'/LPE', '_blank');
    			window.focus();
...
<div id="accordion">
    ...
    <p align="right">         
		...
		<tr >
            ...
            <a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak(3);">Cetak PDF</a></td>
		</tr>
