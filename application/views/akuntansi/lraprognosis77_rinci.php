...
<div id="content1" align="center"> 
    <h3 align="center"><b>CETAK LAPORAN REALISASI ANGGARAN ( LRA ) TRIWULAN / SEMESTER <br /> RINCI </b> </h3>
     ...
     <table align="center" style="width:100%;" border="0">
       ...
       <tr>
            ...
            <tr>
                ...
                <a href="<?php echo site_url(); ?>/akuntansi/cetak_lra77_skpd_prognosis_rinci/1" class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
         <a href="<?php echo site_url(); ?>/akuntansi/cetak_lra77_skpd_prognosis_rinci/2" class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:openWindow(this.href);return false">Excell</a>
                </td>                
            </tr>
        </table>  
