...
<head>
    ...
    $(function(){ 
     $('#dg').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){    
           ...
           get(nomor,tgl,skpd,nmskpd,ket,total_d,total_k);
           load_detail();
        },
     ...
     $('#jenis').combobox({           
        ...
        data: [{label: '0 || Perubahan SAL',value: '0'},
               ...
               {label: '7 || Pendapatan LO',value: '7'},
               {label: '8 || Beban LO',value: '8'},],
    ...
    function get(nomor,tgl,skpd,nmskpd,ket,total_d,total_k){
    ...
    function simpan_ju(){
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",       
                dataType : 'json',         
                data: ({tabel:'trhju_pkd',no:cno,tgl:ctgl,skpd:cskpd,nmskpd:cnmskpd,ket:cket,total_d:ctotald,total_k:ctotalk}),
...
<h3><a href="#" id="section2">JURNAL UMUM</a></h3>
   ...
   <p>         
        <table align="center" style="width:100%;">
            ...
            <tr>
                <td>S K P D</td>
                <td><input id="skpd" name="skpd" style="width: 200px;" /></td>
                <td></td>
                <td>Nama SKPD :</td> 
...
<div id="dialog-modal" title="Input ">
    ...
    <table>
      <tr>
        <td>Jenis</td>
        <td>:</td>
        <td width="300"><input id="jenis" name="jenis" value=""/>
        </td>
      </tr>
      <tr>
        <td>Debet / Kredit</td>
        <td>:</td>
        <td width="300"><input id="rk" name="rk" value=""/>
        </td>
      </tr>
      <tr>
        <td>Kode Sub Kegiatan</td>
        <td>:</td>
        <td width="300"><input id="giat" name="giat" style="width: 150px;" /></td>
        <td>Nama Sub Kegiatan</td>
        <td>:</td>
        <td><input name="text" type="text" id="nmgiat" style="border:0;width: 500px;" readonly="true"/></td>
      </tr>
      <tr>
        <td >Kode Rekening</td>
        <td>:</td>
        <td><input id="rek" name="rek" style="width: 150px;" /></td>
        <td >Nama Rekening</td>
        <td>:</td>
        <td><input name="text" type="text" id="nmrek" style="border:0;width: 500px;" readonly="true"/></td>
      </tr>
      <tr>
        <td >Nilai</td>
        <td>:</td>
        <td><input name="text" type="text" id="nilai" style="text-align: right;" onkeypress="return(currencyFormat(this,',','.',event))" /></td>
      </tr>
      <tr>
        <td>un-posting</td>
        <td>:</td>
        <td><input name="checkbox" type="checkbox" id="posting"/></td>
      </tr>
    </table>
    </fieldset>
    <fieldset>
