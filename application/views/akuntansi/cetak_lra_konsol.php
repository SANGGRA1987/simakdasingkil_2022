...
function mapping_neraca(){
    ...
    $(document).ready(function(){
				$.ajax({
					type: "POST",
					url: '<?php echo base_url(); ?>/index.php/akuntansi/posting_lra_kolom',
...
function AddItems(isi,pesan,tambah)
    	...
    	function cetaklra(ctk)
        {
            ...
            var cetak =ctk;           	
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_gab_pemkot_real";	  
			window.open(url+'/'+bulanctk+'/'+cetak+'/'+initx+'/'+ctglttd+'/'+ttdperda, '_blank');			
			window.focus();
        } 
        
		
    	function cetaklra1(ctk)
        {
			/*var txt;
			var r = confirm("Pilih [OKE] untuk Cetak menggunakan Tanda Tangan");
			if (r == true) {
            ...
            var cbulan = $('#bulanctk').datebox('getValue'); 
            var cetak =ctk;           	
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_gab_pemkot_real_calk";	  
			window.open(url+'/'+bulanctk+'/'+cetak+'/'+initx+'/'+ctglttd+'/'+ttdperda, '_blank');			
			window.focus();
        }
		...
		function cetaklragab(ctk)
        {
			...
			var cbulan = $('#bulanctk').datebox('getValue'); 
            var cetak =ctk;           	
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_gab_skpd";	  
		...
		function cetaklragab_konsol(ctk)
        {
            var cbulan = $('#bulanctk').datebox('getValue');
            var cetak =ctk;           	
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_gab_konsol";	  
			window.open(url+'/'+bulanctk+'/'+cetak, '_blank');			
			window.focus();
        }		
...
<h3>LAPORAN LRA PEMKOT GABUNGAN</h3>       
<div id="accordion">
    ...
    <p align="right">         
		...
		<tr >
			...
			<td align ='left'>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklra1(0);">Cetak Layar</a>
			<a id="cetak0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetaklra1(1);">Cetak PDF</a>
            <a id="cetak1" class="easyui-linkbutton" disabled iconCls="icon-excel" plain="true" onclick="javascript:cetaklra1(2);">Cetak excel</a>
            <a id="cetak2" class="easyui-linkbutton" disabled iconCls="icon-word" plain="true" onclick="javascript:cetaklra1(3);">Cetak word</a></td>
		</tr>     
		<tr >
