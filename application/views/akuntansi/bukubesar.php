...
<head>
	...
	$('#sskpd').combogrid({  
		...
		onSelect:function(rowIndex,rowData){
			...
			$("#kdrek5").combogrid({url:'<?php echo base_url(); ?>index.php/akuntansi/rekening',queryParams:({kd:kdskpd})});
			//validate_giat();
		}  
		}); 
	});
   ...
   $(function(){
	$('#ttd').combogrid({  
		...
		function cetakbb()
        {
			...
			window.open(url+'/'+dcetak+'/'+ttd1+'/'+skpd+'/'+rek5+'/'+dcetak2+'/'+jenis, '_blank');
			window.focus();
        }
		function cetakbb_()
        {
...
<h3>CETAK BUKU BESAR</h3>
    ...
    <p align="right">         
		...
		<tr >
			...
			<td width="80%"> <INPUT TYPE="button" VALUE="CETAK LAYAR" ONCLICK="cetakbb()" style="height:40px;width:100px" >&nbsp;&nbsp;&nbsp;&nbsp;
			<INPUT TYPE="button" VALUE="CETAK PDF" ONCLICK="cetakbb_()" style="height:40px;width:100px" >
			</td>
		</tr>
		<tr >
			<td >&nbsp</td>
