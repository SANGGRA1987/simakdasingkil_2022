    ...
    function cetak($pilih){
			...
			if(ctk==1){
				//if(pilihan=='1'){
					...
					urll ='<?php echo base_url(); ?>index.php/akuntansi/cetak_lpe77/'+cbulan+'/-/1'; 
					
				/*}else if(pilihan=='2'){
					urll ='<?php echo base_url(); ?>index.php/akuntansi/cetak_lpe77/'+dcetak+'/'+dcetak2+'/2'; 
				}*/
			}else{				
				if (kdskpd==''){
				...
				urll ='<?php echo base_url(); ?>index.php/akuntansi/cetak_lpe77_skpd/'+cbulan+'/'+kdskpd;
			}
