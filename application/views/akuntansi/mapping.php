		...
		$(function(){      
		 $.ajax({
			...
			success:function(data){
				if (data = 1){
					alert('POSTING JURNAL BUD SELESAI');
	...
	function mapping_bud(){
		...
		$(function(){      
		 $.ajax({
			...
			data: ({nomor:'1'}),
			dataType:"json",
			url:"<?php echo base_url(); ?>index.php/akuntansi/proses_mapping_bud",
			success:function(data){
				if (data = 1){
					alert('POSTING JURNAL BUD SELESAI');
					document.getElementById('load').style.visibility='hidden';
...
<h3>PROSES REKAL TRANSAKSI KE JURNAL </h3>
    <div>
    <p >         
        <table id="sp2d" title="Mapping Realisasi" style="width:870px;height:300px;" >  
		<tr >
			<td width="100%" align="center"> <INPUT TYPE="button" VALUE="POSTING JURNAL BUD" style="height:40px;width:150px" onclick="mapping()" >
			</td>
		</tr>
		<!--<tr >
			<td width="100%" align="center"> <INPUT TYPE="button" VALUE="POSTING JURNAL BUD" style="height:40px;width:150px" onclick="mapping_bud()" >
			</td>
		</tr>
		<tr >
