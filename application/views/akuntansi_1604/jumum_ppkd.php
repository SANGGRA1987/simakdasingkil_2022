...
<head>
    ...
    $(function(){ 
     $('#dg').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){    
           ...
           reev = rowData.kreev;
           get(nomor,tgl,skpd,nmskpd,ket,total_d,total_k,reev);
           load_detail();
        },
    ...
    function get(nomor,tgl,skpd,nmskpd,ket,total_d,total_k,reev){
                   ...
                   if (status == '0'){
                       ...
                       var dgrid = $('#dg1').datagrid('getSelections');
 			           for(var w=0;w<dgrid.length;w++){
                            ...
                            cjns       = dgrid[w].jns;
                            cpos       = dgrid[w].post;
                            intsub = ckdgiat.substr(0,21);
                                                                            
                            if (w>0) {
                                csql = csql+",('"+cnovoucher+"','"+ckdgiat+"','"+cnmgiat+"','"+crek+"','"+cnmrek+"','"+cdebet+"','"+ckredit+"','"+crk+"','"+cjns+"','"+cpos+"','"+w+"','"+cskpd+"')";
                            } else {
                                csql = " values('"+cnovoucher+"','"+ckdgiat+"','"+cnmgiat+"','"+crek+"','"+cnmrek+"','"+cdebet+"','"+ckredit+"','"+crk+"','"+cjns+"','"+cpos+"','"+w+"','"+cskpd+"')";                                            
                            }
   ...
   <p>         
        <table align="center" style="width:100%;">
           ...
           <tr>
                ...
                Jenis Jurnal<select  name="j_j" id="j_j" >
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<option value="0">Umum</option>
			<!--<option value="2">Koreksi Persediaan</option>
			<option value="1">Revaluasi</option>
			<option value="3">Lain - Lain</option>-->
            <option value="4">NON APBD</option>
            <option value="8">LRA Tanpa Kegiatan</option>
            <option value="31">a. Dampak Kumulatif Penerapan Amortisasi Aset Tak Berwujud</option>
			<option value="32">b. Koreksi Kas di Kasda</option>
			<option value="33">c. Koreksi Kas di Bendahara Pengeluaran</option>
			<option value="34">d. Koreksi Kas Lainnya</option>
            <option value="35">e. Koreksi Persediaan</option>            
            <option value="36">f. Koreksi Piutang</option>
            <option value="37">g. Penilaian Aset Tetap</option>
			<option value="38">h. Mutasi Masuk dan Keluar Aset</option>
			<option value="39">i. Koreksi Aset Tetap</option>
            <option value="40">j. Koreksi Aset tak Berwujud</option>            
            <option value="41">k. Koreksi Aset Lainnya</option>
			<option value="42">l. Koreksi Investasi</option>
			<option value="43">m. Koreksi Pembiayaan</option>
			<option value="44">n. Koreksi Kewajiban Jangka Panjang</option>
            <option value="45">o. Koreksi Lain-lain</option>
