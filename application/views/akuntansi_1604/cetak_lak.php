...
<head>
  ...
  <style>    
	...
	$('#sskpd').combogrid({  
		...
		textField:'kd_skpd',  
		mode:'remote',
		url:'<?php echo base_url(); ?>index.php/rka/lap_skpd',  
		columns:[[  
    ...
    function cetak($pilih){
			...
			if(ctk==1){
             ...
             var ctglttd = $('#tgl_ttd1').datebox('getValue'); 
				...
				urll ='<?php echo base_url(); ?>index.php/akuntansi/rpt_lak/'+cbulan;
				if (bulan==''){
        ...
        var ctk = "1";
			...
			if(ctk==1){
             ...
             var ctglttd = $('#tgl_ttd1').datebox('getValue'); 
				...
				urll ='<?php echo base_url(); ?>index.php/akuntansi/rpt_lak_kota/'+cbulan;
				if (bulan==''){
				alert("Pilih Bulan dulu");
				exit();	
				}
