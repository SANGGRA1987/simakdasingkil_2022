...
<head>
  ...
  <style>    
    ...
    function cetak($ctk)
        {
            var cetak =$ctk;           	
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_lo_ppkd";	  
			ctglttd = $('#tgl_ttd').datebox('getValue');
            cttd1 =  cbulan = $('#ttd').combogrid('getValue');
            ctgl1 =  cbulan = $('#bulan').combogrid('getValue');
          
            lc = '?tgl1='+ctgl1+'&tgl_ttd='+ctglttd+'&cd_ttd='+cttd1;
    ...
    $('#ttd2').combogrid({  
     ...
     function openWindow( url ){
        ...
        cttd1 =  cbulan = $('#ttd').combogrid('getValue');
            ...
            lc = '?tgl1='+ctgl1+'&tgl_ttd='+ctglttd+'&c_ttd='+cttd1;
...
<h3>CETAK LAPORAN OPERASIONAL PPKD</h3>       
<div id="accordion">
