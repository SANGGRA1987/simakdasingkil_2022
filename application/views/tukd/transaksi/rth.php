...
<head>
    ...
    function validate1(){
        ...
        function cetak(ctk)
        {
			...
			var url2    = "<?php echo site_url(); ?>/tukd/cetak_rth_periode";  
			...
			//	window.open(url+'/'+bulan+'/'+ctk+'/'+ttd+'/'+ctglttd+'/'+cetk+'/'+'-'+'/'+'-'+'/'+format+'/'+atas+'/'+bawah+'/'+kiri+'/'+kanan, '_blank');
				window.open(url+'/'+bulan+'/'+ctk+'/'+ttd+'/'+ctglttd+'/'+cetk+'/'+'-'+'/'+'-'+'/'+format+'/'+atas+'/'+bawah+'/'+kiri+'/'+kanan+'/RTH', '_blank');
				window.focus();
			}else{
				window.open(url2+'/'+bulan+'/'+ctk+'/'+ttd+'/'+ctglttd+'/'+cetk+'/'+ctglttd1+'/'+ctglttd2+'/'+atas+'/'+bawah+'/'+kiri+'/'+kanan+'/RTH', '_blank');
				window.focus();
			}
        }
    ...
    <p align="right">         
		...
		<td colspan="4">
    		...
    		<tr >
    			...
    			Spasi : &nbsp;<input type="number" id="bawah" name="bawah" style="width: 50px; border:1" value="0" /> &nbsp;&nbsp;
    			</td>
    		</tr>
