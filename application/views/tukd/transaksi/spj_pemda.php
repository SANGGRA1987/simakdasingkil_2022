...
<head> 
    ...
    function validate1(){
        ...
        function cetak(ctk){
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_spj_pemda";  
		...
		function cetak1(ctk){
            ...
            var url    = "<?php echo site_url(); ?>/tukd/cetak_spj_priode";  
		...
		function cetak_ali(ctk){
            ...
            if(pil_ctk=='2'){
            var url    = "<?php echo site_url(); ?>/tukd/cetak_spj_excel";  			            
            window.open(url+'/'+skpd+'/'+bulan+'/'+ttd_1+'/'+ctglttd+'/'+ttd_2+'/'+ctk+'/'+atas+'/'+bawah+'/'+kiri+'/'+kanan+'/1'+'/bk'+'/'+jns_ang, '_blank');
			window.focus();
            }else{
            var url    = "<?php echo site_url(); ?>/tukd/cetak_spj_excel_priode";  			            
...
<div id="accordion">
    ...
    <p align="right">         
        ...
        <tr>
            ...
            <input type="radio" name="cetak" value="2" id="status" onclick="opt(this.value)" checked="checked"/>Bulan
            </td>
			<td>
            <div id="dbulan">
            ...
            <div id="dperiode">
                <input type="text" id="tgl_1" style="width: 100px;" /> s.d. <input type="text" id="tgl_2" style="width: 100px;" />             
            </div>
            </td>
		</tr>
		<tr>
                ...
                <div id="div_skpd">
                        <table style="width:100%;" border="0">
							<tr >
								...
								<td width="80%"><input id="sskpd" name="sskpd" style="width: 200px;" />&nbsp;&nbsp;<input id="nmskpd" name="nmskpd" style="width: 600px; border:0;" readonly /></td>
								</tr>
						</table> 
                </div>
                </td>
		...
		<tr>
			...
			<td width="80%"><select id="jns_ang"><option value="nilai">MURNI</option>
		...
		<tr >
			...
			&nbsp;&nbsp;
			<!--<a class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:cetak_ali(2);">SPJ Fungsional</a>-->
			</td>
		</tr>
		<tr >
			<td colspan="2">
			...
			&nbsp;&nbsp;
			<!--<a class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:cetak_ali(3);">SPJ Administratif</a>-->
			</td>
		</tr>
		<!--
		<tr >
