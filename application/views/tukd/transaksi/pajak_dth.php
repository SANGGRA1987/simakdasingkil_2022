...
<head>
    ...
    $(function(){
        ...
        $('#sskpd').combogrid({  
                ...
                textField:'kd_skpd',  
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/tukd/skpduser',  
                columns:[[  
        ...
        function cetak(jenis=''){
            ...
            var ttd_1   = ttd1.split(" ").join("AsDfghJklxu");
            ...
            var xxx     = ttd_1+"/"+ttd2+"/"+ctglttd+"/"+bulan+"/"+period1+"/"+period2+"/"+skpd;
            var url     = "<?php echo site_url(); ?>/tukd/dth_pajak/"+xxx;
            window.open(url); 
            window.focus();        
...
<div id="">
 <h1 style="padding: 4px">DALAM PERBAIKAN</h1>
    <fieldset>
    ...
    <p align="right">         
        ...
        <tr >
            <td width="20%" height="40" ><B>Bendahara Pengeluaran</B></td>
            <td width="80%">
                <input type="text" id="ttd1" style="width: 200px;" /> &nbsp;&nbsp;
