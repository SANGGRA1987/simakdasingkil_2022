...
<head>
	...
	$('#sskpd').combogrid({  
		...
		textField:'kd_skpd',  
		mode:'remote',
		url:'<?php echo base_url(); ?>index.php/tatausaha/dth_globalController/skpd',  
		columns:[[  
	...
	$(function(){  
            $('#ttd').combogrid({  
                ...
                textField:'nip',  
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/tatausaha/dth_globalController/load_ttd/BUD',  
                columns:[[  
    ...
    function cetak(ctk)
        {
			...
			var url    = "<?php echo site_url(); ?>/tatausaha/dth_globalController/cetak_dth_global2";  
			if(bulan==0){
    ...
    function cetak_skpd(ctk)
        {
			...
			var url    = "<?php echo site_url(); ?>/tatausaha/dth_globalController/cetak_dth_global_skpd";  
			if(bulan==0){
			alert('Pilih Bulan dulu')
			exit()
			}
