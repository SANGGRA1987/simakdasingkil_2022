      ...
      $('#sp2d').combogrid({
		...
		$('#cspp').combogrid({  
          ...
          $('#spp').edatagrid({
    		...
    		url: '<?php echo base_url(); ?>/index.php/tukd_bos/load_sp3b_bos',
            idField:'id',            
            rownumbers:"true", 
            fitColumns:"true",
            singleSelect:"true",
...
//==grid view edit
              var nlpj      = no_lpjx;//document.getElementById('hidd_sp2d').value;              			  
 			$('#dg1').edatagrid({
				url: '<?php echo base_url(); ?>/index.php/tukd_bos/select_data1_lpj_ag',
				 queryParams:({ lpj:nlpj,kdskpd: kode}),
                 idField:'idx',
                 toolbar:"#toolbar",              
                 rownumbers:"true", 
                 fitColumns:false,
    ...
    function get_nomor_sp2b()
        {
        	$.ajax({
        		url:'<?php echo base_url(); ?>index.php/tukd_bos/no_urut_sp2b',
        		type: "POST",
        		dataType:"json",                         
   ...
   function get_tahun() {
        ...
        if(st=='1'){
            ...
            get_nomor_sp2b();
            nomer_sp2b_tmbh = "/SP2BBOS/"+kode+"/"+tahun_anggaran;            
...
//        }
    ...
    function cetak(){
        ...
        $("#cspp").combogrid("setValue",no_sp2bd);
        $("#dialog-modal").dialog('open');
        //$("#cspp").combogrid("setValue",nom);
		//pilih_giat(nom);
    ...
    function tambah_no(){
     ...
     function cetakup(cetak){
		...
		//var ttd_2 =ttd2.split(" ").join("a");
			...
			var url    = "<?php echo site_url(); ?>/tukd_bos/cetak_sp2b_bos";  
    ...
    function kembali(){
     ...
     function load_sum_lpj(){          
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            url:"<?php echo base_url(); ?>index.php/tukd_bos/load_sum_lpj",
            data:({lpj:no_lpjx,kode:kode}),
            dataType:"json",
            success:function(data){ 
	...
	function simpan_setuju(){
		...
		$(function(){      
			 $.ajax({
				...
				dataType:"json",
				url:"<?php echo base_url(); ?>index.php/tukd_bos/setuju_sp3b",
				success:function(data){
					if (data = 2){
						alert('SP2B telah disetujui');
						document.getElementById("p1").innerHTML="SP2B SUDAH DISETUJUI!!";
						document.getElementById("btcair").value="BATAL SETUJU";
                        $('#idcetak').linkbutton('enable');
					}
				}
	...
	function batal_setuju(){
		...
		$(function(){      
			 $.ajax({
				...
				dataType:"json",
				url:"<?php echo base_url(); ?>index.php/tukd_bos/batalsetuju_sp3b",
				success:function(data){
					if (data = 2){
						alert('SP2B telah dibatalkan');
						document.getElementById("p1").innerHTML="SP2B TELAH DIBATALKAN!!";
						document.getElementById("btcair").value="SETUJU";
                        $('#idcetak').linkbutton('disable');
                        $("#no_sp2b").attr("value",'');
...
<h3><a href="#" id="section4" onclick="javascript:$('#spp').edatagrid('reload')">List SPB DANA BOS</a></h3>
<div>
    <p align="right">  
        <a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
        <input type="text" value="" id="txtcari"/>
        <table id="spp" title="List SP2B" style="width:910px;height:450px;" >  
        </table>
		<font color="blue"><b>*) Warna biru menunjukkan sudah disetujui oleh Perbendaharaan</b></font> 
    </p> 
</div>

<h3><a href="#" id="section1">Input SPB</a></h3>
...
<table border='0' style="font-size:11px" >
   ...
   <td width='80%'><input type="text" name="no_sp2b" id="no_sp2b" style="width:50px" /> <input type="text" name="no_sp2b_tambahan" id="no_sp2b_tambahan" style="width:240px" readonly="true" />
   <input type="hidden" name="no_simpan_sp2b" id="no_simpan_sp2b" style="width:250px" disabled />
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   Tanggal SPB 
   ...
   <tr style="border-bottom-style:hidden;border-spacing:0px;padding:3px 3px 3px 3px;border-collapse:collapse;">
   <td  width='20%'>No SP2B</td>
   <td width='80%'><input type="text" name="no_sp3b" id="no_sp3b" style="width:300px" readonly="true"/> 
   ...
   <tr style="border-bottom-style:hidden;border-spacing:0px;padding:3px 3px 3px 3px;border-collapse:collapse;">
   <td  width='20%'>No. LPJ DANA BOS</td>
 ...
 <tr style="height: 30px;">
  ...
  -->
        ...
        <table id="dg1" title="LPJ DANA BOS" style="width:900%;height:160%;" >  
        </table>
...
<div id="dialog-modal" title="CETAK SPB">	  
    <fieldset>
        <table>
            <tr>            
                <td width="200px" >NO SPB:</td>
