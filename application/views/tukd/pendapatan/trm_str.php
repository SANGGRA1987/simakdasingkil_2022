...
<h3>CETAK BUKU PENERIMAAN DAN PENYETORAN</h3>
    ...
    <p align="right">         
		...
		<tr >
			<td width="15%" height="40" ><B>SKPD</B><input type="hidden" id="sskpd" name="sskpd" readonly="true" style="width: 150px; border: 0;"  /></td>
  
			<td width="85%"> <input id="sskpd2" name="sskpd2" style="width:180px;border: 0;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="nmskpd" name="nmskpd" readonly="true" style="width: 500px; border:0;" /></td>
		</tr>
        
  
		<tr >
			<td width="15%" height="40" ><B>PERIODE</B></td>
			<td width="85%"><input id="dcetak" name="dcetak" type="text"  style="width:155px" />&nbsp;&nbsp;s/d&nbsp;&nbsp;<input id="dcetak2" name="dcetak2" type="text"  style="width:155px" /></td>
		</tr>



		<tr >
			<td width="15%" height="40" ><B>Jenis Cetakkan</B></td>
			<td width="85%"><select name="jnsctk" id="jnsctk" style="height: 27px; width: 190px;">
		...
		<tr >
			...
			<td width="85%"> <INPUT TYPE="button" VALUE="CETAK LAYAR" ONCLICK="cetak(0)" style="height:40px;width:100px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <INPUT TYPE="button" VALUE="CETAK PDF" ONCLICK="cetak(1)" style="height:40px;width:100px" >
			</td>
		</tr>
