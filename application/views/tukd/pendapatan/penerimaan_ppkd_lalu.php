...
<head>
    ...
    var kode = '1.20.00.00';
    var giat = '1.20.1.20.00.00.00.01.01';
    var nomor= '';
    var judul= '';
    var cid = 0;
    var lcidx = 0;
        ...
        $('#skpd').combogrid({  
         ...
         $('#rek').combogrid({  
           ...
           columns:[[  
               ...
               $("#giat").attr("value",rowData.kd_subkegiatan);
              }    
            });
    ...
    $(function(){ 
     $('#dg').edatagrid({
       ...
       function simpan_terima(){
        ...
        var cskpd = '1.20.00.00';//$('#skpd').combogrid('getValue');
      ...
      //  if(lcstatus=='tambah'){ 
            $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'tr_terima_ppkd',no:cno,tgl:ctgl,skpd:cskpd,ket:lcket,kdrek:lckdrek,nilai:lntotal,reklo:rek,nottp:ctetap,tglttp:ctgltetap,sts:cstatus,giat:kdgiat,jenis:jenis}),
                    dataType:"json"
                });
            });    
	...
	//section1();
     ...
     function tambah(){
		...
		$("#notetap").combogrid("setValue",'  ');
		  $("#giat").attr("value",'1.20.1.20.00.00.00.01.01');	
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">INPUTAN PENERIMAAN PPKD ATAS PIUTANG TAHUN LALU</a></b></u></h3>
    <div>
    <p align="right">         
...
<div id="dialog-modal" title="">
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            <tr>
                <td colspan="5"><b>Dengan Penetapan</b><input type="hidden" id="status"  onclick="javascript:runEffect();"/>
                    <div id="tagih">
                        <table>
                            <tr>
                                <td>No.Penetapan</td>
                                <td><input type="text" id="notetap" style="width: 150px;" /></td>
                            
                                <td>Tgl Penetapan</td>
                                <td><input type="text" id="tgltetap" style="width: 120px;" /></td>   
                            </tr>
                        </table> 
                    </div>
            ...
            <tr>
                <td>Rekening</td>
                <td></td>
                <td><input id="rek" name="rek" style="width: 140px;" /> <input type="hidden" id="rek1" name="rek1" style="width: 140px;" /><input type="hidden" id="giat" style="width: 200px;" />
