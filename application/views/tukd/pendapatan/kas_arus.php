...
<div id="content1" align="center"> 
    <h3 align="center"><b>BUKU KAS UMUM</b></h3>
     ...
     <table align="center" style="width:100%;" border="0">
			...
			<tr>
                <td align="left">
                    <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetakh(0);">Cetak Buku Kas Umum(Layar)</a><br>
                    <a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetakh(1);">Cetak  Buku Kas Umum(PDF)</a><br>
                    <a class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:cetakh(2);">Cetak  Buku Kas Umum(Excel)</a><br><br>
                </td>                
            </tr>			
            <tr hidden>
