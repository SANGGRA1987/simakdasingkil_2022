     ...
     $('#dg').edatagrid({
        ...
        $('#skpd').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $('#nomor').combogrid({url:'<?php echo base_url(); ?>index.php/tukd/ambil_sts/'+kode+'/'+tgl_awal});                 
           }  
       });
...
//        }
        ...
        $(document).ready(function(){
            $.ajax({
                ...
                data: ({tabel:'trhkasin_ppkd',nokas:cnokas,tglkas:ctglkas,no:cno,bank:cbank,tgl:ctgl,skpd:cskpd,ket:lcket,jnsrek:cjnsrek,giat:cgiat,rekbank:lcrekbank,total:lntotal,value_det:lcval_det}),
                dataType:"json",
                success:function(data){
                    status = data.pesan;
                    if(status=='0'){
