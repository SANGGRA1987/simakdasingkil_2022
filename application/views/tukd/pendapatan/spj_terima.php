    ...
    /* function get_skpd()
        ...
        function ttd1(){  
            ...
            $('#ttd1').combogrid({  
                ...
                textField:'nip',  
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/tukd/load_ttd_pa/pa', 
		 ...
		 function ttd2(){ 
            ...
            $('#ttd2').combogrid({  
                ...
                textField:'nip',  
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/tukd/load_ttd_bp/bp',
                queryParams: ({kdskpd:ckdskpd}),  
                columns:[[  
                    {field:'nip',title:'NIP',width:200},  
                    {field:'nama',title:'Nama',width:400}    
                ...
                <div id="div_skpd">
                        <table style="width:100%;" border="0">
                            ...
                            <td width="79%"><input type="hidden" id="skpd" name="skpd" style="width: 100px;" />
                             <input id="sskpd2" name="sskpd2" style="width:150px;border: 0;" />
                            <input type="text" id="nmskpd" readonly="true" style="width: 450px;border:0" />
                            </td>
                        </table>
                </div>
                </td>
		...
		<td colspan="4">
                <div id="div_bend">
                        <table style="width:100%;" border="0">
                            ...
                            <td width="1%">:</td>
                            <td><select type="text" id="ttd1" style="width: 180px;" /> 
                            </td> 
