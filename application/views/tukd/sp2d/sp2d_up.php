...
<head>
            ...
            $('#csp2d').combogrid({  
                ...
                url: '<?php echo base_url(); ?>/index.php/tukd/pilih_sp2d',  
                    ...
                    columns:[[  
                        ...
                        {field:'kd_skpd',title:'SKPD',align:'left',width:100},
                        {field:'no_spm',title:'SPM',width:100} 
    ...
    $(function(){ 
     $('#sp2d').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_up',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onDblClickRow:function(rowIndex,rowData){
         ...
         $(function(){
              $('#sp2dedit').combogrid({  
                panelWidth:800,
                url: '<?php echo base_url(); ?>/index.php/tukd/pilih_sp2d_up_edit',                  
                    idField:'no_sp2d',                    
                    textField:'no_sp2d',
                    mode:'remote',  
                    fitColumns:true,  
    ...
    $(function(){		
            $('#nospm').combogrid({  
                panelWidth:900,  
                url: '<?php echo base_url(); ?>/index.php/tukd/nospm_up',  
                    idField:'no_spm',                    
                    textField:'no_spm',
                    mode:'remote',  
                    fitColumns:true,  
...
$('#bankedit').combogrid({  
      ...
      $(function(){
            $('#kskpd_2').combogrid({  
                panelWidth:830,  
                url: '<?php echo base_url(); ?>/index.php/tukd/skpd_sp2d_load/1',  
                    idField:'kd_skpd',                    
                    textField:'nm_skpd',
                    mode:'remote',  
                    fitColumns:true,  
           ...
           function validate_tombol_sp2d_edit(kd_skpd_edit){
                ...
                $('#sp2dedit').combogrid({  
                panelWidth:800,
                url: '<?php echo base_url(); ?>/index.php/tukd/pilih_sp2d_up_edit/'+kd_skpd_edit,                  
                    idField:'no_sp2d',                    
                    textField:'no_sp2d',
                    mode:'remote',  
                    fitColumns:true,  
...
function spm_combo(){
			  $('#nospm').combogrid("setValue",'');
		$('#nospm').combogrid({url:'<?php echo base_url(); ?>index.php/tukd/nospm_up'
                                   });
	}
    </script>
    <STYLE TYPE="text/css"> 
...
<h3><a href="#" id="section1" onclick="javascript:$('#sp2d').edatagrid('reload')">List SP2D UP</a></h3>
    <div>
    <p align="right"> Nomor SP2D yang tersimpan&nbsp;<b><input type="text" name="no_sp2d_save" id="no_sp2d_save" style="width:370px ;" readonly="true"/></b>&nbsp;&nbsp;       
...
<tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><input type="hidden" name="no_sp2d" id="no_sp2d" style="width:70px;" readonly="true"/>
		<input type="text" name="no_sp2d_tambahan" id="no_sp2d_tambahan" style="width:410px;" /></td>
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td width='53%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><textarea name="nmskpd" id="nmskpd" cols="30" rows="1" style="border: 0;"  readonly="true"></textarea></td>
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><input id="sp" name="sp" style="width:400px" readonly="true"/><input type="hidden" id="jns_spd" name="jns_spd" style="width:20px" readonly="true"/></td>
...
<div id="dialog-batal" title="KETERANGAN PEMBATALAN SP2D">
    ...
    <table>
        <tr>
            <td width="110px">NO SP2D:</td>
            <td><input id="no_sp2d_batal" name="no_sp2d_batal" style="width: 400px;" readonly="true"/></td>
        </tr>
        <tr>
            <td width="110px">NO SPM:</td>
            <td><input id="no_spm_batal" name="no_spM_batal" style="width: 400px;" readonly="true"/></td>
        </tr>
        <tr>
            <td width="110px">NO SPP:</td>
            <td><input id="no_spp_batal" name="no_spp_batal" style="width: 400px;" readonly="true"/></td>
        </tr>
        <tr>
