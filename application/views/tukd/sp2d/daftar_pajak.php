...
<head>
    ...
    function get_skpd()
        ...
        function cetak(ctak)
        {
			...
			var ctgl_cetak   = $('#tgl_cetak').datebox('getValue');			
			...
			if(ctglttd==''){
				...
				alert('Tanggal Cetak harus di isi');
				return;
			}else{
					...
					if((jns=='0' && cetk=='0') || (jns=='0' && cetk=='3') || ( jns=='1' && cetk=='0') || ( jns=='1' && cetk=='3')){
						...
						window.open(url+'/'+jns+'/'+belanja+'/'+ctak+'/'+ctglttd+'/'+ctglttd1+'/'+no_halaman+'/'+cetk+'/'+ttd+'/x/'+ctgl_cetak, '_blank');
						window.focus();
						...
						var url        = "<?php echo site_url(); ?>/tukd/ctk_daftar_pajak";
						window.open(url+'/'+jns+'/'+belanja+'/'+ctak+'/'+ctglttd+'/'+ctglttd1+'/'+no_halaman+'/'+cetk+'/'+ttd+'/'+skpd+'/'+ctgl_cetak, '_blank');
						window.focus();
				...
				<table style="width:100%;" border="0">
					...
					<td ><input type="radio" name="cetak" value="1" id="status" onclick="opt(this.value)" /><b>Per SKPD</b>
                        ...
                        <table >
                            <tr >
                    			<td ><B>SKPD</B></td>
                    			<td ><input id="skpd" name="skpd" style="width: 170px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="nmskpd" name="nmskpd" style="width: 300px; border:0;" /></td>
                    		</tr>
                        </table> 
						</div>
					</td>
		...
		<tr>
			<td>
				<table style="width:100%;" border="0">
					...
					<td><input type="text" id="tgl_cetak" style="width: 100px;" /></td>
