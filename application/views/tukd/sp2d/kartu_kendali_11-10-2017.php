...
//		});
	 ...
	 function validate_kegi(kode){
		 ...
		 $('#kg').combogrid({  
                panelWidth:500,  
                url: '<?php echo base_url(); ?>/index.php/tukd/pgiat_all/'+kode,  			
                    idField:'kd_kegiatan',  
	 ...
	 function validate_rek(cgiat){
		...
		textField:'kd_rek5',  
		mode:'remote',
		url:'<?php echo base_url(); ?>/index.php/tukd/lds_rek/'+cgiat,  
		columns:[[  
    ...
    function get_skpd()
		...
		function cetak_kartu_kendali_gaji($cetak)
        {
			var cetak =$cetak;           	
			var dcetak = $('#dcetak').datebox('getValue');      
			var dcetak2 = $('#dcetak2').datebox('getValue');      
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_kartu_kendali_gaji"; 
			window.open(url+'/'+dcetak+'/'+ttd1+'/'+skpd+'/'+kdkegi+'/'+dcetak2+'/'+cetak);
			window.focus();
        }
...
<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak_kartu_kendali_kegi(1);">Cetak Pdf</a>
		...
		<tr >
			<td width="20%" height="40" ><B>Cetak Per Gaji</B></td>
			<td width="80%"> <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak_kartu_kendali_gaji(2);">Cetak Layar</a>
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak_kartu_kendali_gaji(1);">Cetak Pdf</a>
			</td>
