		...
		$('#cspp').combogrid({  
          ...
          $('#spp').edatagrid({
            ...
            onSelect:function(rowIndex,rowData){
              ...
              sp2d		= rowData.sp2d;
              st		= rowData.status;
			  tglsah	= rowData.tgl_sah_bud;
                    
              get(nomer,kode,tgllpj,cket,status_lpj,tgl_sp2d,sp2d,nmskpd,tglsah);
              detail_trans_3();
              load_sum_lpj(); 
              lcstatus = 'edit';                                       
            },
...
//==grid view edit
 			...
 			$('#dg1').edatagrid({
				url: '<?php echo base_url(); ?>/index.php/tukd/select_data1_lpj_ag',
                 ...
                 columns:[[
					...
					{field:'kdrek5',title:'Rekening',width:100,align:'left'},
   ...
   function get_tahun() {
	     ...
	     function get(nomer,kode,tgllpj,cket,status_lpj,tgl_sp2d,sp2d,nmskpd,tglsah){
    ...
    function tambah_no(){
     ...
     function cetakup(cetak){
		...
		if((jns=='0') || (jns=='1')){
			...
			// window.focus();
      alert("Silahkan Pilih PIlihan Jenis Cetakan");
      exit();
		}
     }
...
//             });    
	...
	function simpan_setuju(){
		...
		var tglsah = $('#ddsah').datebox('getValue'); 
		$(function(){      
			 $.ajax({
				type: 'POST',
				data: ({no_lpj:no_lpj,kd_skpd:kode,tgl_sah:tglsah}),
				dataType:"json",
			 ...
			 $.ajax({
				...
				success:function(data){
					if (data == '1'){
						...
						alert('Tidak bisa dibatalkan karena No LPJ sudah dibuatkan SP2D');
						document.getElementById("p1").innerHTML="Tidak bisa dibatalkan karena No LPJ sudah dibuatkan SP2D";
						document.getElementById("btcair").value="BATAL SETUJU";
					}
				}
			 });
...
<table border='0' style="font-size:11px" >
	...
	<tr style="border-bottom-style:hidden;border-spacing:0px;padding:3px 3px 3px 3px;border-collapse:collapse;"> 
		<td  width='20%'>Tgl Pengesahan</td>
		<td>&nbsp;<input id="ddsah" name="ddsah" type="text" style="width:120px" onkeypress="javascript:enter(event.keyCode,'tgl_sp2d');"/></td>   
	</tr>
  <tr style="border-bottom-style:hidden;border-spacing:0px;padding:3px 3px 3px 3px;border-collapse:collapse;">
   ...
   <td>&nbsp;<input id="dd" name="dd" type="text" style="width:120px" onkeypress="javascript:enter(event.keyCode,'tgl_sp2d');"/></td>   
	</tr>
	<tr style="border-bottom-style:hidden;border-spacing:0px;padding:3px 3px 3px 3px;border-collapse:collapse;">
   <td width='20%'>SKPD</td>
   <td width="80%">     
