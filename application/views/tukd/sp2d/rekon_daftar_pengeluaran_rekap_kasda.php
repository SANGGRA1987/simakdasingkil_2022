...
<head>
	...
	$(function(){  
            $('#ttd').combogrid({  
                ...
                textField:'nip',  
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/tatausaha/rekap_kasController/load_ttd/BUD',  
                columns:[[  
			...
			$('#skpd').combogrid({  
				...
				textField:'kd_skpd',  
				mode:'remote',
				url:'<?php echo base_url(); ?>index.php/tatausaha/rekap_kasController/skpd',  
				columns:[[  
	...
	function opt(val){                 
        ...
        function cetak(tipectak)
        {
			...
			var url        = "<?php echo site_url(); ?>/tatausaha/rekap_kasController/ctk_rekap_pengeluaran_kasda_baru";	
        ...
        function cetak_2(tipectak)
        {
			...
			var ttd        = $('#ttd').combogrid('getValue');
		        ttd        = ttd.split(" ").join("123456789");
			var url        = "<?php echo site_url(); ?>/tatausaha/rekap_kasController/ctk_rekap_pengeluaran_kasda_tgl";	
            var tgl_per1    = $('#tgl_per1').datebox('getValue');
			var tgl_per2    = $('#tgl_per2').datebox('getValue');			
...
<div id="accordion" style="width:100%;">
    ...
    <p align="right">         
        <table border="0" id="sp2d" title="Cetak Daftar Pengeluaran" style="width:100%;"  >
		<tr>
			<td colspan="0">
