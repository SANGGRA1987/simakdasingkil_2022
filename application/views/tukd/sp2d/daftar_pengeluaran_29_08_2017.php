    ...
    function get_skpd()
        ...
        function cetak(ctak)
        {
            ...
            if(jns=='9'){
				...
				var url        = "<?php echo site_url(); ?>/tukd/ctk_daftar_pengeluaran_all";
            	...
            	var skpd       = document.getElementById('sskpd').value;
				var url        = "<?php echo site_url(); ?>/tukd/ctk_daftar_pengeluaran_all_jns";
				window.open(url+'/'+jns+'/'+bulan+'/'+ctak+'/'+ttd+'/'+ctglttd+'/'+no_halaman+'/'+cetk+'/'+ctglttd1+'/'+spasi+'/'+skpd, '_blank');
				window.focus(); 
			}
            }else{
			...
			if(cetk=='2'){
			 //ctk_daftar_pengeluaran_peri
				var url        = "<?php echo site_url(); ?>/tukd/ctk_daftar_pengeluaran_peri";
				window.open(url+'/'+jns+'/'+bulan+'/'+ctak+'/'+ttd+'/'+ctglttd+'/'+no_halaman+'/'+cetk+'/'+ctglttd1+'/'+spasi+'/'+tgl_per1+'/'+tgl_per2, '_blank');
				window.focus();
			}else if(cetk=='0'){
				var skpd       = document.getElementById('skpd').value;
		...
		<tr>
			<td colspan="0">
				<table style="width:100%;" border="0">
                    ...
                    <tr>
					<td><input type="radio" name="cetak" value="9" onclick="opt(this.value)" /><b>Semua Per Bulan</b></td>
					</tr>
					<tr>
					...
					<tr>
					<td ><input type="radio" name="cetak" value="2" onclick="opt(this.value)" /><b>Per Periode</b>
						<div id="pertglperi">
                        <table >
                            <tr >
                    			<td ><B>Periode</B></td>
					...
					<tr>
					<td ><input type="radio" name="cetak" value="4" onclick="opt(this.value)" /><b>Per Bulan</b>
						<div id="perbulan">
                        <table >
                            <tr >
                    			<td ><B>Unit</B></td>
