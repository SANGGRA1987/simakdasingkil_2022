...
<head>
    ...
    $(function(){ 
     $('#sp2d').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){
            ...
            sp2d_edit  = rowData.sp2d_edit;

			
			getdata(no_sp2d,tgl_sp2d,no_spm,tgl_spm,no_spp,tgl_spp,kd_skpd,nm_skpd,jns_spp,keperluan,bulan,no_spd,bank,nmrekan,no_rek,npwp,jns_bbn,status,jns_spd,s_batal,sp2d_edit);
			detail();
            tombol_spm(sp2d_edit);
            pot();
        },
  ...
  $('#bank1').combogrid({  
		...
		function getdata(no_sp2d,tgl_sp2d,no_spm,tgl_spm,no_spp,tgl_spp,kd_skpd,nm_skpd,jns_spp,keperluan,bulan,no_spd,bank,nmrekan,no_rek,npwp,jns_bbn,status,jns_spd,sp2d_edit){
			//alert(status);
 ...
 lcstatus = 'tambah';
        ...
        var no_spm   =document.getElementById('spmsave').value;
     ...
     $('#del').linkbutton('enable');   
        ...
        $(function(){      
             $.ajax({
                ...
                data: ({nospp:nospp}),
                dataType:"json",
                url:"<?php echo base_url(); ?>index.php/tukd/perbaiki_spm",
                success:function(data){
                    if (data = 1){
                        alert('SPM Bisa diperbaiki');
                        document.getElementById("p3").innerHTML="SPM sedang diperbaiki!!";
                        section1();
                    }
                }
             });
        ...
        function tombol_spm(sp2d_edit){
    if (sp2d_edit=='2') {
        document.getElementById("p3").innerHTML="SPM sedang diperbaiki!!";
    //document.getElementById("btcair").value="BATAL SETUJU";
     }else if (sp2d_edit=='1') {
        document.getElementById("p3").innerHTML="SPM sudah diperbaiki!!";
    //document.getElementById("btcair").value="BATAL SETUJU";
     }else{
...
<h3><a href="#" id="section1" onclick="javascript:$('#sp2d').edatagrid('reload')">List SP2D Gaji Admin</a></h3>
    <div>
    <p align="right"> Nomor SP2D yang tersimpan&nbsp;&nbsp;<b><input type="text" name="no_sp2d_save" id="no_sp2d_save" style="width:290px ;" readonly="true"/></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|         
...
<table border='1' style="font-size:11px" >
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   <p id="p3" style="font-size: x-large;color: red;"></p>
   <INPUT TYPE="button" name="btbaik" id="btbaik" VALUE="PERBAIKI" ONCLICK="simpan_baik()" style="height:40px;width:100px">
   <INPUT type="hidden" name="btambil" id="btambil" VALUE="AMBIL DATA SPM" ONCLICK="ambil()" style="height:40px;width:200px">
    <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;" >No SP2D</td>
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><input type="text" name="no_sp2d" id="no_sp2d" style="width:70px ;"/>
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><input type="text" name="nospm" id="nospm" style="width:240px ;" /><input type="hidden" name="spmsave" id="spmsave" style="width:240px ;" /></td>
