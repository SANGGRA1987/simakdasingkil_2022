...
<head>
	 ...
	 $(function(){
              $('#nospm').combogrid({  
                panelWidth:1000,                  
                    ...
                    columns:[[  
                        ...
                        {field:'nm_skpd',title:'Nama',align:'left',width:550} 
        ...
        //function val_ttd(dns){
		 ...
		 $(function(){
              $('#sp2dedit').combogrid({  
                panelWidth:800,
                url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_tu_edit',                  
                    idField:'no_sp2d',                    
                    textField:'no_sp2d',
                    mode:'remote',  
                    fitColumns:true,  
    ...
    $(function(){
            $('#kskpd').combogrid({  
                panelWidth:700,  
                url: '<?php echo base_url(); ?>/index.php/tukd/skpd_sp2d/3',  
                    idField:'kd_skpd',                    
                    textField:'kd_skpd',
                    mode:'remote',  
                    fitColumns:true,  
       ...
       $(function(){
            $('#kskpd_2').combogrid({  
                panelWidth:830,  
                url: '<?php echo base_url(); ?>/index.php/tukd/skpd_sp2d_load/3',  
                    idField:'kd_skpd',                    
                    textField:'nm_skpd',
                    mode:'remote',  
                    fitColumns:true,  
    ...
    $(function(){
            ...
            function validate_tombol_sp2d_edit(kd_skpd_edit){
                ...
                $('#sp2dedit').combogrid({  
                panelWidth:800,
                url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_tu_edit/'+kd_skpd_edit,                  
                    idField:'no_sp2d',                    
                    textField:'no_sp2d',
                    mode:'remote',  
                    fitColumns:true,  
...
//$("#nama_bank").attr("value",rowData.nama_bank);
        ...
        function validate_tombol_spm(kd_skpd){
            ...
            $('#nospm').combogrid({  
                panelWidth:1000,  
                url: '<?php echo base_url(); ?>/index.php/tukd/nospm_tu/'+kd_skpd,  
                    idField:'no_spm',                    
                    textField:'no_spm',
                    mode:'remote',  
                    fitColumns:true,  
 ...
 lcstatus = 'tambah';
    ...
    function cari_skpd(kd_skpd){
     var kriteria = kd_skpd; 
        $(function(){ 
            $('#sp2d').edatagrid({
	       url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_tu',
         queryParams:({cari:kriteria})
...
<h3><a href="#" id="section1" onclick="javascript:$('#sp2d').edatagrid('reload')">List SP2D TU</a></h3>
   <div>
