...
<head>
    ...
    var lcstatus = '';
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd/load_perbaikan_spm',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        $(function(){
            ...
            textField:'kd_skpd',  
            mode:'remote',
            //url:'<?php echo base_url(); ?>index.php/rka/skpduser_perbaikan/',  
            columns:[[  
...
//$("#nama_bank").attr("value",rowData.nama_bank);
 ...
 function validate_skpd(){
     ...
     $(function(){
            ...
            textField:'kd_skpd',  
            mode:'remote',
            url:'<?php echo base_url(); ?>index.php/tukd/skpduser_perbaikan/'+jns_sp,  
            columns:[[  
                {field:'kd_skpd',title:'Kode SKPD',width:100},  
                {field:'nm_skpd',title:'Nama SKPD',width:700}    
            ]],
	...
	function getedit(kd_skpdedit,nm_skpdedit,no_spmedit,no_sppedit,pimpinanedit,no_rekedit,npwpedit,bankedit,keperluanedit,nmrekanedit,no_tagihedit,ketbastedit){
     ...
     function validate_jenis(){
        ...
        $(function(){ 
                $('#dg').edatagrid({
                  url: '<?php echo base_url(); ?>/index.php/tukd/load_perbaikan_spm/'+sskpd+'/'+jns_ang,
        ...
        $(function(){      
         $.ajax({
            ...
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/tukd/perbaiki_data_spm",
...
<p>
        ...
        <table id="dg" title="LIST SPM" style="width:870px;height:450px;" >  
        </table>
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
        ...
        <tr>
            ...
            <td>:<input id="spmedit" name="spmedit" style="width: 250px;" readonly="true"/></td>
        </tr>
        <tr>
            <td width="110px">NO Tagih</td>
            <td>:<input id="no_tagihedit" name="no_tagihedit" style="width: 250px;" readonly="true"/></td>
        </tr>
        <tr>
            <td width="110px">NO SPP</td>
            <td>:<input id="sppedit" name="sppedit" style="width: 250px;" readonly="true"/></td>
        </tr>
       ...
       <tr>
        ...
        <tr>
            ...
            no rek
            :<input id="norekedit" name="norekedit" style="width: 150px;"/></td>
        </tr>
        <tr>
