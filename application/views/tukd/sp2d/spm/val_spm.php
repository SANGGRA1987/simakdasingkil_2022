...
<head>
    ...
    var lcstatus = '';
     ...
     $(document).ready(function() {
        ...
        $('#kd_skpd').combogrid({  
            panelWidth:500,  
            url: '<?php echo base_url(); ?>/index.php/tukd/skpd_spm',  
            idField:'kd_skpd',  
            textField:'kd_skpd',
            mode:'remote',  
            fitColumns:true,  
            ...
            {field:'nm_skpd_',title:'Nama SKPD',width:300}
            ]],  
            onSelect:function(rowIndex,rowData){
             // alert(rowData.nm_skpd);
             $("#nm_skpd").attr("value",rowData.nm_skpd_);
            }   
        });
    ...
    function cek2($cetak,$jxx){
        ...
        if (ttd == '') {
            alert('Silahkan Pilih Tanda Tangan !!!');
            exit();
        }
        
        urlx='';
        if($jxx<=1){
            urlx="<?php echo site_url(); ?>/tukd/preview_cetakan_val_spm/"+$cetak+'/Report-val/'+kd_skpd+'/'+ttd
        }else{
            urlx="<?php echo site_url(); ?>/tukd/preview_cetakan_val_sp2d/"+$cetak+'/Report-SP2D/'+kd_skpd+'/'+ttd    
        }
        openWindows( urlx );
    }
    ...
    function openWindows( urlx ){
     ...
     function cetak(){
        $("#dialog-modal-antrian").dialog('open');
    }  
      ...
      function cek_data(no_sppedit,kd_skpdedit){
           ...
           var kd_skpd= kd_skpdedit;
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>index.php/tukd/select_data_untuk_cek',
                type: "POST",
                dataType:"json",
...
<h3 align="center"><u><b><a href="#" id="section1">VALIDASI TERIMA SPP & SPM</a></b></u></h3>
    ...
    <tr>
        ...
        <td>:&nbsp;</td>
        <td>&nbsp;<input id="sskpd" name="sskpd" style="width:200px;border: 0;" />
        <input id="nmskpd" name="nmskpd" readonly="true" style="width: 500px; border:0;  " /></td>
    </tr>

        <tr>
         <td width="10%">Cetak List</td>
         <td width="1%">:</td>
         <td width="40%"><a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak();">cetak</a></td>    
     </tr>
    </table>
...
<div id="dialog-modal" title="">
    ...
    <td width="60%">    
     <table align="center" style="width:100%;" border="0">
            ...
            <td>:<input id="kdskpdedit" name="kdskpdedit" style="width: 200px;" readonly="true"/>&nbsp;&nbsp;<input id="nmskpdedit" name="nmskpdedit" style="width: 400px;border: none;padding-left: 7px;"readonly="true" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>:<input id="spmedit" name="spmedit" style="width: 410px;" readonly="true"/></td>
        </tr>
        <tr>
            <td width="110px">NO SPP</td>
            <td>:<input id="sppedit" name="sppedit" style="width: 410px;" readonly="true"/></td>
        </tr>
         <tr>
            <td width="110px">Rekanan</td>
            <td>:<input id="rekanedit" name="rekanedit" style="width: 500px;" /></td>
        </tr>
       <tr>
        ...
        <tr>
            ...
            <td>Rp. <input name="nilaispm" id="nilaispm" readonly style="border-style: none ;width: 220px;"></td>
        </tr> 
        </tr>
       ...
       <td bgcolor="#F8F8FF" width="40%">
            ...
            <tr><td><input type="checkbox" name="spm1" id="spm1" value="1"/>Surat Pernyataan Pernyataan SPP UP/SPP-GU</td></tr>
            <tr><td><input type="checkbox" name="spm2" id="spm2" value="2"/>Surat Pengantar SPP UP/SPP-GU</td></tr>
            <tr><td><input type="checkbox" name="spm3" id="spm3" value="3"/>Ringkasan SPP UP/SPP GU</td></tr>
            <tr><td><input type="checkbox" name="spm4" id="spm4" value="4"/>Salinan SPD</td></tr> 
            <tr><td><input type="checkbox" name="spm5" id="spm5" value="5"/>Surat Pengesahan Laporan SPJ atas Pengunaan</td></tr>
            <tr><td><input type="checkbox" name="spm6" id="spm6" value="6"/>Rincian SPP UP/SPP-GU</td></tr> 
            <tr><td><input type="checkbox" name="spm7" id="spm7" value="7"/>Lampiran Lainnya (UP/GU) </td></tr>               
            </table>
            </div>
...
<div id="dialog-modal-antrian" title="CETAK LIST ANTRIAN">
    <p class="validateTips">SILAHKAN PILIH SKPD</p> 
    <fieldset>
        <table>
            <tr>
                <td width="110px">SKPD</td>
                <td> : <input id="kd_skpd" name="kd_skpd" style="width: 150px;" /></td>
            </tr>
            <tr>
                <td width="110px">&nbsp;</td>
                <td><input id="nm_skpd" name="nm_skpd" style="width: 400px;border: none;padding-left: 10px;" readonly="true" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="110px">&nbsp;</td>
                <td><input id="nm_ttd" name="nm_ttd" style="width: 250px;border: none;padding-left: 10px;" /></td>
            </tr>
        </table>  
    </fieldset> 
    ...
    <table>
        ...
        <tr>
            <td colspan="3">Cetak List Antrian SPM</td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="3">Cetak List SP2D</td>
        </tr>
        <tr>
            <td>
