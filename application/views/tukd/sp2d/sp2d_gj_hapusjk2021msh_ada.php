    ...
    $(function(){ 
     $('#sp2d').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){
			...
			getdata(no_sp2d,tgl_sp2d,no_spm,tgl_spm,no_spp,tgl_spp,kd_skpd,nm_skpd,jns_spp,keperluan,bulan,no_spd,bank,nmrekan,no_rek,npwp,jns_bbn,status,jns_spd,s_batal);
			detail();
            pot();
        },
                ...
                url: '<?php echo base_url(); ?>/index.php/tukd/nospm_gaji/'+kd_skpd,  
                    ...
                    columns:[[  
                     ...
                     onSelect:function(rowIndex,rowData){
						...
						var tambahan = "/SP2D/LS-GJ/" + skpd7 + "/" + tahun;
...
{		var a_no_sp2d_smtr_tox=no_spm+beat_sp2d;
		...
		/*if(cekno==5){
            alert("Nomor SP2D bisa 5 Digit");
        }else{
		if (cekno!=4){
			alert("Nomor SP2D harus 4 Digit");
			exit();
		}
		}*/
...
<table border='1' style="font-size:11px" >
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><input type="text" name="no_sp2d" id="no_sp2d" style="width:70px;" readonly="true"/>
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><input type="text" name="nospm" id="nospm" style="width:240px ;" /></td>
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">   
   ...
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><input id="nospp" name="nospp" style="width:240px" readonly="true" /></td>
...
<div id="dialog-modal" title="CETAK SP2D">
	...
	<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd/cetak_sp2d');return false;">Cetak</a>
