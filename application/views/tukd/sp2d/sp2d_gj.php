...
<head>
    ...
    $(function(){
        ...
        $(function(){
            $('#csp2d').combogrid({  
                panelWidth:500,  
                url: '<?php echo base_url(); ?>/index.php/tukd/pilih_sp2d_gajo',  
                    idField:'no_sp2d',                    
                    textField:'no_sp2d',
                    mode:'remote',  
                    fitColumns:true,  
        ...
        //function val_ttd(dns){
         ...
         //}
          ...
          $(function(){
              $('#sp2dedit').combogrid({  
                panelWidth:800,
                url: '<?php echo base_url(); ?>/index.php/tukd/pilih_sp2d_gajo_edit',                  
                    idField:'no_sp2d',                    
                    textField:'no_sp2d',
                    mode:'remote',  
                    fitColumns:true,  
                    columns:[[  
                        {field:'no_sp2d',title:'No',width:120},  
                    ...
                    kd_gajiedit = rowData.kd_gaji;
                    getedit(no_spmedit,no_sppedit,tgledit,pimpinanedit,no_rekedit,npwpedit,bankedit,keperluanedit,nmrekanedit,kd_gajiedit);
                    }                        
                });            
       });
    ...
    $(function(){ 
     $('#sp2d').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_gj',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onSelect:function(rowIndex,rowData){
			...
			getdata(no_sp2d,tgl_sp2d,no_spm,tgl_spm,no_spp,tgl_spp,kd_skpd,nm_skpd,jns_spp,keperluan,bulan,no_spd,bank,nmrekan,no_rek,npwp,jns_bbn,status,jns_spd,s_batal,kd_gaji,urut);
			detail();
            pot();
        },
     ...
     $(function(){
            $('#kskpd').combogrid({  
                panelWidth:700,  
                url: '<?php echo base_url(); ?>/index.php/tukd/skpd_sp2d/4',  
                    idField:'kd_skpd',                    
                    textField:'kd_skpd',
                    mode:'remote',  
                    fitColumns:true,  
                    columns:[[  
                        {field:'kd_skpd',title:'SKPD',width:200},  
                        {field:'nm_skpd',title:'NAMA',align:'left',width:500}
       ...
       $(function(){
            $('#kskpd_2').combogrid({  
                panelWidth:830,  
                url: '<?php echo base_url(); ?>/index.php/tukd/skpd_sp2d_load/4',  
                    idField:'kd_skpd',                    
                    textField:'nm_skpd',
                    mode:'remote',  
                    fitColumns:true,  
		 ...
		 $('#nospm').combogrid({  
                panelWidth:1000,  
                //url: '<?php echo base_url(); ?>/index.php/tukd/nospm_gaji/'+kd_skpd,  
                    idField:'no_spm',                    
                    textField:'no_spm',
                    mode:'remote',  
                    fitColumns:true,  
                    columns:[[  
                        {field:'no_spm',title:'No',width:300},  
...
function validate_tombol_sp2d_edit(kd_skpd_edit){
                ...
                $('#sp2dedit').combogrid({  
                panelWidth:800,
                url: '<?php echo base_url(); ?>/index.php/tukd/pilih_sp2d_gajo_edit/'+kd_skpd_edit,                  
                    idField:'no_sp2d',                    
                    textField:'no_sp2d',
                    mode:'remote',  
                    fitColumns:true,  
       ...
       function getedit(no_spmedit,no_sppedit,tgledit,pimpinanedit,no_rekedit,npwpedit,bankedit,keperluanedit,nmrekanedit,kd_gajiedit){
            ...
            $("#kd_gajiedit").attr("value",kd_gajiedit);            
        }


		function getdata(no_sp2d,tgl_sp2d,no_spm,tgl_spm,no_spp,tgl_spp,kd_skpd,nm_skpd,jns_spp,keperluan,bulan,no_spd,bank,nmrekan,no_rek,npwp,jns_bbn,status,jns_spd,s_batal,kd_gaji,urut){			
			$("#no_sp2d").attr("value",urut);
			$("#no_sp2d_tambahan").attr("value",no_sp2d);			
			$("#csp2d").combogrid("setValue",no_sp2d);
			$("#dd").datebox("setValue",tgl_sp2d);
			$("#kd_gaji").attr("Value",kd_gaji);
	...
	function simpan_sp2d(){        
        ...
        var kode_gaji   = document.getElementById('kd_gaji').value;
		var m           = angka(total);
        ...
        if (kode_gaji=="") {
        alert ("Jenis Gaji Tidak Boleh Kosong");
        exit();
        }
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data: ({cskpd:k,cspd:l,urut_sp2d:no1,no_sp2d:no_sp2d_new,tgl_sp2d:b1,no_spm:no_spm,tgl_spm:b2,no_spp:no_spp,tgl_spp:b,jns_spp:c,bulan:d,keperluan:e,nmskpd:j,rekanan:f,bank:g,npwp:h,rekening:i,nilai:m,jenis:cc,sp2d_blk:beat_sp2d,lcstatus_input:lcstatus,no_sp2d_tag:no_sp2d_new,kode_gaji:kode_gaji}),
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/tukd/simpan_sp2d_gaji_baru",
            success:function(data){
				if (data==2){                    			
...
function perbaiki_sp2d(){        
       ...
       // var editsp2d= $("#sp2dedit").combogrid("getValue") ; 
        ...
        var kd_gajiedit = document.getElementById('kd_gajiedit').value;

        $(function(){      
         $.ajax({
            type: 'POST',
            data: ({editsp2d:editsp2d,spmedit:spmedit,sppedit:sppedit,tgledit:tgledit,bnkedt:bnkedt,rekanedit:rekanedit,pimpinanedit:pimpinanedit,norekedit:norekedit,npwpedit:npwpedit,kepedit:kepedit,kd_gajiedit:kd_gajiedit}),
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/tukd/perbaiki_sp2d_gaji",
...
function spm_combo(){
			  $('#nospm').combogrid("setValue",'');
		$('#nospm').combogrid({url:'<?php echo base_url(); ?>index.php/tukd/nospm'
                                   });
	}
function sp2d_combo(){
		$('#csp2d').combogrid({url:'<?php echo base_url(); ?>index.php/tukd/load_sp2d'
                                   });
	}
    </script>
    <STYLE TYPE="text/css"> 
...
<h3><a href="#" id="section1" onclick="javascript:$('#sp2d').edatagrid('reload')">List SP2D Gaji</a></h3>
    <div>
    <p align="right"> Nomor SP2D yang tersimpan&nbsp;<b><input type="text" name="no_sp2d_save" id="no_sp2d_save" style="width:300px ;" readonly="true"/></b>&nbsp;&nbsp;&nbsp;|         
        <a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:section2();kosong();">Tambah</a>
        <a class="easyui-linkbutton"iconCls="icon-print" plain="true" onclick="javascript:cetak();">cetak</a>
       <!-- <a class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="javascript:editdata();">Perbaiki</a>              -->
        <a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
        <input type="text" value="" id="txtcari"/><br /><!--<input type="text" name="kskpd_2" id="kskpd_2" style="width:855px;" />-->
...
<table border='1' style="font-size:11px" >
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td colspan="3" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><input type="text" name="kskpd" id="kskpd" style="width:240px;" />
  </td>
 </tr>
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <input type="hidden" name="no_sp2d_hidden" id="no_sp2d_hidden" style="width:70px ;"/>
   <input type="text" name="no_sp2d_tambahan" id="no_sp2d_tambahan" style="width:410px;" />
   </td>
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td width='31%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><textarea name="ketentuan" id="ketentuan" cols="20" rows="1" ></textarea></td>
 </tr>
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><textarea id="rekanan" name="rekanan" cols="20" rows="1"> </textarea></td>
 </tr>
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td width="8%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><input type="text" name="bank1" id="bank1" disabled/>
 ...
 <tr style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td width='31%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><input type="text" name="npwp" id="npwp" value=""  style="width:200px ;"/></td>
 </tr> 
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   <td width='8%'  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">Jenis Gaji</td>
   <td width='53%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><select name="kd_gaji" id="kd_gaji" style="width:200px;">
...
<div id="dialog-modal" title="CETAK SP2D">
    ...
    <table>
        <tr>
            ...
            <td><input id="csp2d" name="csp2d" style="width: 350px;" /></td>
        </tr>
        <tr>
	...
	<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/sp2d/cetak_sp2d');return false;">Cetak</a>
...
<div id="dialog-batal" title="KETERANGAN PEMBATALAN SP2D">
    ...
    <table>
     <tr>
            ...
            <td>:<input id="kdskpdedit" name="kdskpdedit" style="width: 150px;" /><input id="nmskpdedit" name="nmskpdedit" style="width: 350px;" /></td>
        </tr>
        <tr>
            <td width="110px">NO SP2D</td>
            <td>:<input id="sp2dedit" name="sp2dedit" style="width: 250px;" /></td>
        </tr>
        <tr>
            <td width="110px">NO SPM</td>
            <td>:<input id="spmedit" name="spmedit" style="width: 200px;" readonly="true"/></td>
        </tr>
        <tr>
            <td width="110px">Jenis Gaji</td>
            <td><select name="kd_gajiedit" id="kd_gajiedit" style="width:200px;">
     <option value="">...Pilih Jenis Gaji... </option>
     <option value="10">10&nbsp;| Reguler</option>
     <option value="11">11&nbsp;| Rapelan</option>
     <option value="12">12&nbsp;| Susulan</option>
     ...
     <option value="14">14&nbsp;| Gaji 14</option>
        ...
        <tr>
            <td width="110px">NO SPP</td>
            <td>:<input id="sppedit" name="sppedit" style="width: 200px;" readonly="true"/></td>
        </tr>
        <tr>
            <td width="110px">tgl SP2D</td>
            <td>:<input id="tglsp2dedit" name="tglsp2dedit" style="width: 100px;" /></td>
        </tr>
         <tr>
       ...
       <tr>
            ...
            <td>:<input id="pimpinanedit" name="pimpinanedit" style="width: 200px;" /></td>
        </tr>
        <tr>
            <td width="110px">no rek</td>
            <td>:<input id="norekedit" name="norekedit" style="width: 150px;"/></td>
        </tr>
        <tr>
            <td width="110px">NPWP</td>
            <td>:<input id="npwpedit" name="npwpedit" style="width: 150px;"/></td>
        </tr>
        <tr>
            <td width="110px">Bank</td>
            <td>:<input id="bankedit" name="bankedit" style="width: 130px;" /></td>
        </tr>
        <tr>
            <td width="110px">Keperluan</td>
            <td><textarea name="keperluanedit" id="keperluanedit" cols="300" rows="2" style="width: 500px;"></textarea></td>
        </tr>
    </table>  
    </fieldset>
    <a class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:perbaikidata();">Update</a>
