...
<head>
    ...
    $(function(){
     ...
     function validate_tombol_sp2d_edit(kd_skpd_edit){
        ...
        $(function(){
            $('#kskpd').combogrid({  
                panelWidth:800,  
                url: '<?php echo base_url(); ?>/index.php/tukd/skpd_sp2d/6',  
                    idField:'kd_skpd',                    
                    textField:'kd_skpd',
                    mode:'remote',  
                    fitColumns:true,  
    ...
    $(function(){ 
     $('#sp2d').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_ls',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
...
//$("#nama_bank").attr("value",rowData.nama_bank);
        ...
        function validate_tombol_spm(kd_skpd){          
            $('#nospm').combogrid({  
                panelWidth:1000,  
                url: '<?php echo base_url(); ?>/index.php/tukd/nospm_ls2/'+kd_skpd,  
                    idField:'no_spm',                    
                    textField:'no_spm',
                    mode:'remote',  
                    fitColumns:true,  
	   ...
	   var tgl_spp  = $('#dd').datebox('getValue');
		...
		function getdata(no_sp2d,tgl_sp2d,no_spm,tgl_spm,no_spp,tgl_spp,kd_skpd,nm_skpd,jns_spp,keperluan,bulan,no_spd,bank,nmrekan,no_rek,npwp,jns_bbn,status,jns_spd,s_batal,urut){			
...
<table border='1' style="font-size:11px" >
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><input type="hidden" name="no_sp2d" id="no_sp2d" style="width:70px;" readonly="true"/>
	<input type="text" name="no_sp2d_tambahan" id="no_sp2d_tambahan" style="width:410px;" readonly="true" />
   </td>
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td width='53%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><input type="text" name="npwp" id="npwp" value=""  style="width:200px ;" readonly="true"/></td>
