...
<head>
    ...
    $(function(){ 
     $('#sp2d').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_gu_nihil',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
    ...
    $(function(){		
            $('#nospm').combogrid({  
                panelWidth:500,  
                url: '<?php echo base_url(); ?>/index.php/tukd/nospm_gu_nihil',  
                    idField:'no_spm',                    
                    textField:'no_spm',
                    mode:'remote',  
                    fitColumns:true,  
                    columns:[[  
                     ...
                     onSelect:function(rowIndex,rowData){
						...
						var tambahan = "/SP2D/GU-NIHIL/" + skpd7 + "/" + tahun;
...
function validate_tombol_sp2d_edit(kd_skpd_edit){
                ...
                $('#sp2dedit').combogrid({  
                panelWidth:800,
                url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_gu_nihil_edit/'+kd_skpd_edit,                  
                    idField:'no_sp2d',                    
                    textField:'no_sp2d',
                    mode:'remote',  
                    fitColumns:true,  
     ...
     var kriteria = skpd; 
        ...
        $(function(){            
         ...
         $(function(){
              $('#sp2dedit').combogrid({  
                panelWidth:800,
                url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_gu_nihil_edit',                  
                    idField:'no_sp2d',                    
                    textField:'no_sp2d',
                    mode:'remote',  
                    fitColumns:true,  
...
function spm_combo(){
			  $('#nospm').combogrid("setValue",'');
		$('#nospm').combogrid({url:'<?php echo base_url(); ?>index.php/tukd/nospm_gu_nihil'
                                   });
	}
    </script>
    <STYLE TYPE="text/css"> 
...
<h3><a href="#" id="section1" onclick="javascript:$('#sp2d').edatagrid('reload')">List SP2D GU-NIHIL</a></h3>
    <div>
...
<table border='1' style="font-size:11px" >
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <input type="text" name="no_sp2d_tambahan" id="no_sp2d_tambahan" style="width:240px;" readonly="true" /></td>
   </td>
