...
//$("#nama_bank").attr("value",rowData.nama_bank);
                ...
                url: '<?php echo base_url(); ?>/index.php/tukd/nospm_ls2/'+kd_skpd,  
                    ...
                    columns:[[  
                     ...
                     onSelect:function(rowIndex,rowData){
						...
						var tambahan = "/SP2D/LS/" + skpd7 + "/" + tahun;
       ...
       function get_nomor_sp2d()
		...
		function getdata(no_sp2d,tgl_sp2d,no_spm,tgl_spm,no_spp,tgl_spp,kd_skpd,nm_skpd,jns_spp,keperluan,bulan,no_spd,bank,nmrekan,no_rek,npwp,jns_bbn,status,jns_spd){
			//alert(status);
			//var no_sp2d_nomor = no_sp2d.split("/",1);
			//var no_sp2d_tambh = no_sp2d.substr(4,32);
...
<table border='1' style="font-size:11px" >
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td colspan="3" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><input type="text" name="kskpd" id="kskpd" style="width:200px;" />
  </td>
 </tr>
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
