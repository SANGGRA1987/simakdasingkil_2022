    ...
    var lcstatus = '';
     ...
     $('#dg').edatagrid({
		...
		$('#jenis').combogrid({
           ...
           columns:[[  
               {field:'kd_rek6',title:'Kode Rekening',width:150},  
		...
		$(document).ready(function(){
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'trhkasin_ppkd',nokas:no_kas,jns:jenis,ket:uraian,ttd:ctglttd,nilai:lntotal,kegiatan:giat}),
                    dataType:"json",
                    success:function(data){
                        status = data.xdata;
                        if (status=='0'){
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
				<td>Jenis</td>
				<td></td>
				<td><input id="jenis" name="jenis" style="width: 150px;" /></td>
			</tr>
			<tr>
				<td>Nama Jenis</td>
				<td></td>
