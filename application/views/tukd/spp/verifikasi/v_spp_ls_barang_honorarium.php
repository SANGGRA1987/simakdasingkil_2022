...
<div id="content"> 
	<div id="accordion">
		<h3 align="center"><u><b><a href="#" id="section1">VERIFIKASI SPP LS BARANG JASA honorarium, jasa, biaya pemeliharaan/ operasional dan/atau sejenisnya</a></b></u></h3>
		<div>
		<p align="left" >  
		</p>
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
			<input type="text" value="" id="txtcari" style="width: 500px;"/>
			<table id="dg" title="DAFTAR SPP LS BARANG JASA honorarium, jasa, biaya pemeliharaan/ operasional dan/atau sejenisnya" style="width:870px;height:500px;" >  
			</table>
		</div>
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <tr>   
		...
		<div id="spm_gu">
			<table width="100%">
				<tr><td><b>Kelengkapan dokumen Pengajuan SP2D LS honorarium, jasa, biaya pemeliharaan/ operasional dan/atau sejenisnya</b></td>
					</tr>            
				...
				<tr><td><input type="checkbox" name="spm5" id="spm5" value="5"/>Daftar/Rekapitulasi Penerima Honor/Jasa/sejenisnya</td>
					</tr>
				<tr><td><input type="checkbox" name="spm6" id="spm6" value="6"/>Surat setoran/bukti pelunasan pajak restoran</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm7" id="spm7" value="7"/>Elektronik billing pajak PPN danPPh</td>
					</tr>
				<tr><td><input type="checkbox" name="spm8" id="spm8" value="8"/>Surat setoran/bukti setoran zakat</td>
					</tr>
				<tr><td><input type="checkbox" name="spm9" id="spm9" value="9"/>Surat setoran/bukti setoran infaq</td>
					</tr>
				<tr><td><input type="checkbox" name="spm10" id="spm10" value="10"/>	Surat Pernyataan Verifikasi Kelengkapan dan Keabsahan Dokumen dan Lampiran SPP LS Pengadaan Barang dan Jasa yang ditandatangani oleh PPK SKPK, dan</td>
					</tr>
				<tr><td><input type="checkbox" name="spm11" id="spm11" value="11"/>SFormat checklist kelengkapan dokumen yang ditandatangani oleh PPK SKPK</td>
					</tr>
				<tr><td>&nbsp;</td>
					</tr> 
				...
				<tr><td><input type="checkbox" name="spm16" id="spm16" value="16"/>Penatausahaan dan Pengelolaan Kas</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm17" id="spm17" value="17"/>Belanja Langsung</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm18" id="spm18" value="18"/>Belanja Tidak Langsung</td>	
					</tr>
				<tr><td>&nbsp;</td>						
					</tr>					
	...
	<table>
		<td>
			<table>
				<tr>
					<td>        
					<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd_verif/cetak_sppls_barang_jasa_honorarium');return false;">Cetak</a>					
					</td>
					<td>
