...
<div id="content"> 
	<div id="accordion">
		<h3 align="center"><u><b><a href="#" id="section1">VERIFIKASI SPP LS PIHAK KETIGA BANSOS BERUPA UANG</a></b></u></h3>
		<div>
		<p align="left" >  
		</p>
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
			<input type="text" value="" id="txtcari" style="width: 500px;"/>
			<table id="dg" title="DAFTAR SPP LS PIHAK KETIGA BANSOS BERUPA UANG" style="width:870px;height:450px;" >  
			</table>
		</div>
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <tr>   
		...
		<div id="spm_gu">
			<table width="100%">
				<tr><td><b>Kelengkapan dokumen Pengajuan SP2D LS Belanja Bantuan Sosial berupa uang</b></td>
					</tr>            
				<tr><td><input type="checkbox" name="spm1" id="spm1" value="1"/>Surat Pengantar SPM LS Pihak Ketiga Lainnya</td>
					</tr>
				<tr><td><input type="checkbox" name="spm2" id="spm2" value="2"/>Surat Pernyataan Pengajuan SPM Pihak Ketiga Lainnya (SPTJM-SPM)</td>
					</tr>
				...
				<tr><td><input type="checkbox" name="spm5" id="spm5" value="5"/>Daftar/Rekapitulasi penerima bantuan sosial</td>
					</tr>
	...
	<table>
		<td>
			<table>
				<tr>
					<td>        
					<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd_verif/cetak_sppls_pihak3_bansos');return false;">Cetak</a>					
					</td>
					<td>
