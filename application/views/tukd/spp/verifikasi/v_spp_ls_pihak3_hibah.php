...
<head>
    ...
    $(function(){ 
     $('#dg').edatagrid({
        url: '<?php echo base_url(); ?>/index.php/tukd_verif/load_verif_spp_ls_pihak_ketiga',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
    ...
    function getedit(no_sppedit,tgl_terima,tot_spm){
			...
			document.getElementById('spm11').checked = false;
			document.getElementById('spm12').checked = true;
			document.getElementById('spm13').checked = false;
    ...
    function openWindow(url) {
		...
		lc = '?no='+no+'&ctglttd='+ctglttd+'&ttd='+ttd+'&ttd1='+ttd1+'&catatan1='+catatan1+'&catatan2='+catatan2+'&catatan3='+catatan3+'&dspm1='+dspm1+'&dspm2='+dspm2+'&dspm3='+dspm3+'&dspm4='+dspm4+'&dspm5='+dspm5+'&dspm6='+dspm6+'&dspm7='+dspm7+'&dspm8='+dspm8+'&dspm9='+dspm9+'&dspm10='+dspm10+'&dspm11='+dspm11+'&dspm12='+dspm12+'&dspm13='+dspm13+'&dspm14='+dspm14+'&dspm15='+dspm15+'&dspm16='+dspm16+'&LSPIHAK3='+'LSPIHAK3';
...
<div id="content"> 
	<div id="accordion">
		<h3 align="center"><u><b><a href="#" id="section1">VERIFIKASI SPP LS PIHAK KETIGA HIBAH BERUPA UANG</a></b></u></h3>
		<div>
		<p align="left" >  
		</p>
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
			<input type="text" value="" id="txtcari" style="width: 500px;"/>
			<table id="dg" title="DAFTAR SPP LS PIHAK KETIGA HIBAH BERUPA UANG" style="width:870px;height:450px;" >  
			</table>
		</div>
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <tr>   
		...
		<div id="spm_gu">
			<table width="100%">
				<tr><td><b>Kelengkapan dokumen Pengajuan SP2D LS Belanja Hibah berupa uang kepada Pemerintah Pusat, Pemerintah Daerah lainnya, badan usaha milik negara, BUMD, dan/atau badan dan lembaga, serta organisasi kemasyarakatan</b></td>
					</tr>            
				<tr><td><input type="checkbox" name="spm1" id="spm1" value="1"/>Surat Pengantar SPM LS Pihak Ketiga Lainnya</td>
					</tr>
				<tr><td><input type="checkbox" name="spm2" id="spm2" value="2"/>Surat Pernyataan Pengajuan SPM LS Pihak Ketiga Lainnya (SPTJM-SPM)</td>
					</tr>
				<tr><td><input type="checkbox" name="spm3" id="spm3" value="3"/>Surat Penyediaan Dana/SPD</td>
					</tr>
				<tr><td><input type="checkbox" name="spm4" id="spm4" value="4"/>SPM LS Pihak Ketiga Lainnya</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm5" id="spm5" value="5"/>Berita Acara Pembayaran</td>
					</tr>
				<tr><td><input type="checkbox" name="spm6" id="spm6" value="6"/>Print out/foto copy rekening giro terbaru</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm7" id="spm7" value="7"/>Foto copy NPWP</td>
					</tr>
				<tr><td><input type="checkbox" name="spm8" id="spm8" value="8"/>Surat Pernyataan Verifikasi Kelengkapan dan Keabsahan Dokumen dan Lampiran SPP LS Pihak Ketiga Lainnya yang ditandatangani oleh PPK SKPK, dan</td>
					</tr>
				<tr><td><input type="checkbox" name="spm9" id="spm9" value="9"/>Format checklist kelengkapan dokumen yang ditandatangani oleh PPK SKPK</td>
					</tr>
				<tr><td>&nbsp;</td>
					</tr> 
				...
				<tr><td><input type="checkbox" name="spm10" id="spm10" value="10"/>Berkas memenuhi persyaratan</td>
					</tr>
				<tr><td><input type="checkbox" name="spm11" id="spm11" value="11"/>Berkas tidak memenuhi persyaratan</td>
					</tr>				
				...
				<tr><td><input type="checkbox" name="spm14" id="spm14" value="14"/>Penatausahaan dan Pengelolaan Kas</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm15" id="spm15" value="15"/>Belanja Langsung</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm16" id="spm16" value="16"/>Belanja Tidak Langsung</td>	
					</tr>
				<tr><td>&nbsp;</td>						
					</tr>					
				<tr><td><input type="checkbox" name="spm12" id="spm12" value="12"/>Berkas memenuhi persyaratan</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm13" id="spm13" value="13"/>Berkas tidak memenuhi persyaratan</td>						
					</tr>	
				<tr><td>Catatan atas berkas :</td>
					</tr>
	...
	<table>
		<td>
			<table>
				<tr>
					<td>        
					<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd_verif/cetak_sppls_pihak3_hibah');return false;">Cetak</a>					
					</td>
					<td>
