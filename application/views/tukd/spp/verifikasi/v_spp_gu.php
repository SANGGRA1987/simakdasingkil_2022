...
<head>
    ...
    $(function(){ 
     $('#dg').edatagrid({
        url: '<?php echo base_url(); ?>/index.php/tukd_verif/load_verif_spp_gu',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
    ...
    function getedit(no_sppedit,tgl_terima,tot_spm){
			...
			document.getElementById('spm8').checked = false;
    ...
    function openWindow(url) {
		...
		lc = '?no='+no+'&ctglttd='+ctglttd+'&ttd='+ttd+'&ttd1='+ttd1+'&catatan1='+catatan1+'&catatan2='+catatan2+'&catatan3='+catatan3+'&dspm1='+dspm1+'&dspm2='+dspm2+'&dspm3='+dspm3+'&dspm4='+dspm4+'&dspm5='+dspm5+'&dspm6='+dspm6+'&dspm7='+dspm7+'&dspm8='+dspm8+'&dspm9='+dspm9+'&dspm10='+dspm10+'&dspm11='+dspm11+'&dspm12='+dspm12+'&dspm13='+dspm13+'&GU='+'GU';
...
<div id="content"> 
	<div id="accordion">
		<h3 align="center"><u><b><a href="#" id="section1">VERIFIKASI SPP GU</a></b></u></h3>
		<div>
		<p align="left" >  
		</p>
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
			<input type="text" value="" id="txtcari" style="width: 500px;"/>
			<table id="dg" title="DAFTAR SPP GU" style="width:870px;height:450px;" >  
			</table>
		</div>
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <tr>   
		...
		<div id="spm_gu">
			<table width="100%">
				<tr><td><b>KELENGKAPAN DOKUMEN PENGAJUAN SP2D GU</b></td>
					</tr>            
				<tr><td><input type="checkbox" name="spm1" id="spm1" value="1"/>Surat Penyediaan Dana/SPD</td>
					</tr>
				<tr><td><input type="checkbox" name="spm2" id="spm2" value="2"/>Surat Pengantar SPM GU</td>
					</tr>
				<tr><td><input type="checkbox" name="spm3" id="spm3" value="3"/>Surat Pernyataan Pengajuan SPM GU (SPTJM-SPM)</td>
					</tr>
				<tr><td><input type="checkbox" name="spm4" id="spm4" value="4"/>SPM GU</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm5" id="spm5" value="5"/>Surat Pernyataan Verifikasi Kelengkapan dan Keabsahan Dokumen dan Lampiran SPP-GU yang ditandatangani oleh PPK SKPK, dan</td>
					</tr>
				<tr><td><input type="checkbox" name="spm6" id="spm6" value="6"/>Format checklist kelengkapan dokumen yang ditandatangani oleh PPK SKPK</td>
					</tr>
				<tr><td>&nbsp;</td>
					</tr> 
				...
				<tr><td><input type="checkbox" name="spm7" id="spm7" value="7"/>Berkas memenuhi persyaratan</td>
					</tr>
				<tr><td><input type="checkbox" name="spm8" id="spm8" value="8"/>Berkas tidak memenuhi persyaratan</td>
					</tr>				
				...
				<tr><td><input type="checkbox" name="spm11" id="spm11" value="11"/>Penatausahaan dan Pengelolaan Kas</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm12" id="spm12" value="12"/>Belanja Langsung</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm13" id="spm13" value="13"/>Belanja Tidak Langsung</td>	
					</tr>
				<tr><td>&nbsp;</td>						
					</tr>					
	...
	<table>
		<td>
			<table>
				<tr>
					<td>        
					<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd_verif/cetak_sppgu');return false;">Cetak</a>					
					</td>
					<td>
