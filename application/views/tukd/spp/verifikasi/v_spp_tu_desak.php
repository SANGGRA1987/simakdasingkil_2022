...
<head>
    ...
    function openWindow(url) {
		...
		lc = '?no='+no+'&ctglttd='+ctglttd+'&ttd='+ttd+'&ttd1='+ttd1+'&catatan1='+catatan1+'&catatan2='+catatan2+'&catatan3='+catatan3+'&dspm1='+dspm1+'&dspm2='+dspm2+'&dspm3='+dspm3+'&dspm4='+dspm4+'&dspm5='+dspm5+'&dspm6='+dspm6+'&dspm7='+dspm7+'&dspm8='+dspm8+'&dspm9='+dspm9+'&dspm10='+dspm10+'&dspm11='+dspm11+'&dspm12='+dspm12+'&dspm13='+dspm13+'&dspm14='+dspm14+'&TU='+'TU';
...
<div id="content"> 
	<div id="accordion">
		<h3 align="center"><u><b><a href="#" id="section1">VERIFIKASI SPP TU MENDESAK</a></b></u></h3>
		<div>
		<p align="left" >  
		</p>
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
			<input type="text" value="" id="txtcari" style="width: 500px;"/>
			<table id="dg" title="DAFTAR SPP TU MENDESAK" style="width:870px;height:450px;" >  
			</table>
		</div>
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <tr>   
		...
		<div id="spm_gu">
			<table width="100%">
				<tr><td><b>Kelengkapan dokumen Pengajuan SP2D TU yang bersifat mendesak dan tidak dapat menggunakan mekanisme LS atau SPP UP/GU</b></td>
					</tr>            
				...
				<tr><td><input type="checkbox" name="spm4" id="spm4" value="4"/>Surat Persetujuan TU</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm5" id="spm5" value="5"/>SPM TU</td>
					</tr>
				<tr><td><input type="checkbox" name="spm6" id="spm6" value="6"/>Surat Pernyataan Verifikasi Kelengkapan dan Keabsahan Dokumen dan Lampiran SPP-TU yang ditandatangani oleh PPK SKPK, dan</td>
					</tr> 
	...
	<table>
		<td>
			<table>
				<tr>
					<td>        
					<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd_verif/cetak_spptu_desak');return false;">Cetak</a>					
					</td>
					<td>
