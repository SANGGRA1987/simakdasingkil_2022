...
<head>
    ...
    $(function(){ 
     $('#dg').edatagrid({
        url: '<?php echo base_url(); ?>/index.php/tukd_verif/load_verif_spp_ls_gaji',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
...
<div id="content"> 
	<div id="accordion">
		<h3 align="center"><u><b><a href="#" id="section1">VERIFIKASI SPP LS TPP PNS</a></b></u></h3>
		<div>
		<p align="left" >  
		</p>
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
			<input type="text" value="" id="txtcari" style="width: 500px;"/>
			<table id="dg" title="DAFTAR SPP LS TPP PNS" style="width:870px;height:450px;" >  
			</table>
		</div>
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <tr>   
		...
		<div id="spm_gu">
			<table width="100%">
				<tr><td><b>Kelengkapan dokumen Pengajuan SP2D TPP PNS/Insentif PNS/lainnya, disesuaikan peruntukannya</b></td>
					</tr>            
				<tr><td><input type="checkbox" name="spm1" id="spm1" value="1"/>Surat Penyediaan Dana/SPD</td>
					</tr>
				<tr><td><input type="checkbox" name="spm2" id="spm2" value="2"/>Surat Pengantar SPM LS TPP PNS/Insentif PNS</td>
					</tr>
				<tr><td><input type="checkbox" name="spm3" id="spm3" value="3"/>Surat Pernyataan Pengajuan SPM LS (SPTJM-SPM)</td>
					</tr>
				<tr><td><input type="checkbox" name="spm4" id="spm4" value="4"/>Daftar/Rekapitulasi Penerima TPP/Insentif atas Pemungutan Pajak dan Retribusi Daerah/lainnya</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm5" id="spm5" value="5"/>SPM LS TPP PNS/Insentif PNS</td>
					</tr>
				<tr><td><input type="checkbox" name="spm6" id="spm6" value="6"/>Elektronik billing pajak PPh</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm7" id="spm7" value="7"/>Surat setoran/bukti setoran zakat</td>
					</tr>
				<tr><td><input type="checkbox" name="spm8" id="spm8" value="8"/>Surat setoran/bukti setoran infaq</td>
					</tr>
				<tr><td><input type="checkbox" name="spm9" id="spm9" value="9"/>Surat Pernyataan Verifikasi Kelengkapan dan Keabsahan Dokumen dan Lampiran SPP LS TPP PNS/Insentif PNS yang ditandatangani oleh PPK SKPK</td>
					</tr>
				<tr><td><input type="checkbox" name="spm10" id="spm10" value="10"/>Format checklist kelengkapan dokumen yang ditandatangani oleh PPK SKPK</td>
					</tr>
				<tr><td>&nbsp;</td>
					</tr> 
				...
				<tr><td><input type="checkbox" name="spm15" id="spm15" value="15"/>Penatausahaan dan Pengelolaan Kas</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm16" id="spm16" value="16"/>Belanja Langsung</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm17" id="spm17" value="17"/>Belanja Tidak Langsung</td>	
					</tr>
				<tr><td>&nbsp;</td>						
					</tr>					
	...
	<table>
		<td>
			<table>
				<tr>
					<td>        
					<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd_verif/cetak_sppls_tpp');return false;">Cetak</a>					
					</td>
					<td>
