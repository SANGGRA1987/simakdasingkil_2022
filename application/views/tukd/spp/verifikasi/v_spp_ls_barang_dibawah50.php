...
<div id="content"> 
	<div id="accordion">
		<h3 align="center"><u><b><a href="#" id="section1">VERIFIKASI SPP LS BARANG JASA (0 S.D 50 JT)</a></b></u></h3>
		<div>
		<p align="left" >  
		</p>
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
			<input type="text" value="" id="txtcari" style="width: 500px;"/>
			<table id="dg" title="DAFTAR SPP LS BARANG JASA (0 S.D 50 JT)" style="width:870px;height:500px;" >  
			</table>
		</div>
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <tr>   
		...
		<div id="spm_gu">
			<table width="100%">
				<tr><td><b>Kelengkapan dokumen Pengajuan SP2D LS Pengadaan Barang dan Jasa (0 sd 50 Juta)</b></td>
					</tr>            
				...
				<tr><td><input type="checkbox" name="spm4" id="spm4" value="4"/>Berita Acara Pembayaran</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm5" id="spm5" value="5"/>SPM LS Pengadaan Barang dan Jasa</td>
					</tr>
				<tr><td><input type="checkbox" name="spm6" id="spm6" value="6"/>Elektronik billing pajak PPN dan PPh</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm7" id="spm7" value="7"/>Foto copy NPWP</td>
					</tr>
				<tr><td><input type="checkbox" name="spm8" id="spm8" value="8"/>Print out/foto copy rekening giro terbaru</td>
					</tr>
				<tr><td><input type="checkbox" name="spm9" id="spm9" value="9"/>Surat Pernyataan Verifikasi Kelengkapan dan Keabsahan Dokumen dan Lampiran SPP LS Pengadaan Barang dan Jasa yang ditandatangani oleh PPK SKPK, dan</td>
					</tr>
	...
	<table>
		<td>
			<table>
				<tr>
					<td>        
					<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd_verif/cetak_sppls_barang_jasa_dibawah50');return false;">Cetak</a>					
					</td>
					<td>
