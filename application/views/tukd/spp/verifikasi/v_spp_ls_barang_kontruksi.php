...
<head>
    ...
    function getedit(no_sppedit,tgl_terima,tot_spm){
			...
			document.getElementById('spm19').checked = true;
			document.getElementById('spm20').checked = false;
			document.getElementById('spm21').checked = false;
            $("#spm_gu").show();                               
        } 
    ...
    function openWindow(url) {
		...
		var dspm21 = document.getElementById('spm21').checked;   
...
<div id="content"> 
	<div id="accordion">
		<h3 align="center"><u><b><a href="#" id="section1">VERIFIKASI SPP LS BARANG JASA KONTRUKSI</a></b></u></h3>
		<div>
		<p align="left" >  
		</p>
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
			<input type="text" value="" id="txtcari" style="width: 500px;"/>
			<table id="dg" title="DAFTAR SPP LS BARANG JASA KONTRUKSI" style="width:870px;height:500px;" >  
			</table>
		</div>
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <tr>   
		...
		<div id="spm_gu">
			<table width="100%">
				<tr><td><b>Kelengkapan dokumen Pengajuan SP2D LS Kontruksi</b></td>
					</tr>            
				...
				<tr><td><input type="checkbox" name="spm6" id="spm6" value="6"/>Surat setoran/bukti pemotongan/pelunasan denda keterlambatan pekerjaan</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm7" id="spm7" value="7"/>Berita acara pembayaran</td>
					</tr>
				<tr><td><input type="checkbox" name="spm8" id="spm8" value="8"/>Surat setoran/bukti pelunasan galian c</td>
					</tr>
				<tr><td><input type="checkbox" name="spm9" id="spm9" value="9"/>Elektronik billing pajak PPN dan PPh</td>
					</tr>
				<tr><td><input type="checkbox" name="spm10" id="spm10" value="10"/>Foto copy NPWP</td>
					</tr>
				<tr><td><input type="checkbox" name="spm11" id="spm11" value="11"/>Print out/foto copy rekening giro terbaru</td>
					</tr>
				<tr><td><input type="checkbox" name="spm12" id="spm12" value="12"/>Surat setoran/bukti setoran Infaq</td>
					</tr>
				<tr><td><input type="checkbox" name="spm13" id="spm13" value="13"/>Surat Pernyataan Verifikasi Kelengkapan dan Keabsahan Dokumen dan Lampiran SPP LS Pengadaan Barang dan Jasa yang ditandatangani oleh PPK SKPK, dan</td>
					</tr>
				<tr><td><input type="checkbox" name="spm14" id="spm14" value="14"/>Format checklist kelengkapan dokumen yang ditandatangani oleh PPK SKPK</td>
					</tr>
				<tr><td>&nbsp;</td>
					</tr> 
				...
				<tr><td><input type="checkbox" name="spm19" id="spm19" value="19"/>Penatausahaan dan Pengelolaan Kas</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm20" id="spm20" value="20"/>Belanja Langsung</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm21" id="spm21" value="21"/>Belanja Tidak Langsung</td>	
					</tr>
				<tr><td>&nbsp;</td>						
					</tr>					
				<tr><td><input type="checkbox" name="spm17" id="spm17" value="17"/>Berkas memenuhi persyaratan</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm18" id="spm18" value="18"/>Berkas tidak memenuhi persyaratan</td>						
					</tr>	
				<tr><td>Catatan atas berkas :</td>
					</tr>
	...
	<table>
		<td>
			<table>
				<tr>
					<td>        
					<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd_verif/cetak_sppls_barang_jasa_kontruksi');return false;">Cetak</a>					
					</td>
					<td>
