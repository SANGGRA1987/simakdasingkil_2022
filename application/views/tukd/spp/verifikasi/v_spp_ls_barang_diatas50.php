...
<head>
    ...
    function getedit(no_sppedit,tgl_terima,tot_spm){
			...
			document.getElementById('spm14').checked = true;
			document.getElementById('spm15').checked = false;
			document.getElementById('spm16').checked = true;
			document.getElementById('spm17').checked = false;
			document.getElementById('spm18').checked = true;
			document.getElementById('spm19').checked = false;
			document.getElementById('spm20').checked = false;
            $("#spm_gu").show();                               
        } 
...
<div id="content"> 
	<div id="accordion">
		<h3 align="center"><u><b><a href="#" id="section1">VERIFIKASI SPP LS BARANG JASA DIATAS 50 JT</a></b></u></h3>
		<div>
		<p align="left" >  
		</p>
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
			<input type="text" value="" id="txtcari" style="width: 500px;"/>
			<table id="dg" title="DAFTAR SPP LS BARANG JASA DIATAS 50 JT" style="width:870px;height:500px;" >  
			</table>
		</div>
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <tr>   
		...
		<div id="spm_gu">
			<table width="100%">
				<tr><td><b>Kelengkapan dokumen Pengajuan SP2D LS Pengadaan Barang dan Jasa (diatas 50 Juta)</b></td>
					</tr>            
				<tr><td><input type="checkbox" name="spm1" id="spm1" value="1"/>Surat Penyediaan Dana/SPD</td>
					</tr>
				<tr><td><input type="checkbox" name="spm2" id="spm2" value="2"/>Surat Pengantar SPM LS Pengadaan Barang dan Jasa</td>
					</tr>
				<tr><td><input type="checkbox" name="spm3" id="spm3" value="3"/>Surat Pernyataan Pengajuan SPM LS Pengadaan Barang dan Jasa (SPTJM-SPM)</td>
					</tr>
				...
				<tr><td><input type="checkbox" name="spm7" id="spm7" value="7"/>Surat setoran/bukti pemotongan/pelunasan denda keterlambatan pekerjaan</td>
					</tr>
				<tr><td><input type="checkbox" name="spm8" id="spm8" value="8"/>Elektronik billing pajak PPN dan PPh</td>
					</tr>
				<tr><td><input type="checkbox" name="spm9" id="spm9" value="9"/>Foto copy NPWP</td>
					</tr>
				<tr><td><input type="checkbox" name="spm10" id="spm10" value="10"/>Print out/foto copy rekening giro terbaru</td>
					</tr>
				<tr><td><input type="checkbox" name="spm11" id="spm11" value="11"/>Surat setoran/bukti setoran Infaq</td>
					</tr>
				<tr><td><input type="checkbox" name="spm12" id="spm12" value="12"/>Surat Pernyataan Verifikasi Kelengkapan dan Keabsahan Dokumen dan Lampiran SPP LS Pengadaan Barang dan Jasa yang ditandatangani oleh PPK SKPK, dan</td>
					</tr>
				<tr><td><input type="checkbox" name="spm13" id="spm13" value="13"/>Format checklist kelengkapan dokumen yang ditandatangani oleh PPK SKPK</td>
					</tr>
				<tr><td>&nbsp;</td>
					</tr> 
				...
				<tr><td><input type="checkbox" name="spm14" id="spm14" value="14"/>Berkas memenuhi persyaratan</td>
					</tr>
				<tr><td><input type="checkbox" name="spm15" id="spm15" value="15"/>Berkas tidak memenuhi persyaratan</td>
					</tr>				
				...
				<tr><td><input type="checkbox" name="spm18" id="spm18" value="18"/>Penatausahaan dan Pengelolaan Kas</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm19" id="spm19" value="19"/>Belanja Langsung</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm20" id="spm20" value="20"/>Belanja Tidak Langsung</td>	
					</tr>
				<tr><td>&nbsp;</td>						
					</tr>					
				<tr><td><input type="checkbox" name="spm16" id="spm16" value="16"/>Berkas memenuhi persyaratan</td>	
					</tr>
				<tr><td><input type="checkbox" name="spm17" id="spm17" value="17"/>Berkas tidak memenuhi persyaratan</td>						
					</tr>	
				<tr><td>Catatan atas berkas :</td>
					</tr>
	...
	<table>
		<td>
			<table>
				<tr>
					<td>        
					<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd_verif/cetak_sppls_barang_jasa_diatas50');return false;">Cetak</a>					
					</td>
					<td>
