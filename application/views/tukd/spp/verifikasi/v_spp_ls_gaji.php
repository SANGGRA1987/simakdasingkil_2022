...
<div id="content"> 
	<div id="accordion">
		<h3 align="center"><u><b><a href="#" id="section1">VERIFIKASI SPP LS GAJI DAN TUNJANGAN</a></b></u></h3>
		<div>
		<p align="left" >  
		</p>
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
			<input type="text" value="" id="txtcari" style="width: 500px;"/>
			<table id="dg" title="DAFTAR SPP LS GAJI DAN TUNJANGAN" style="width:870px;height:450px;" >  
			</table>
		</div>
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <tr>   
		...
		<div id="spm_gu">
			<table width="100%">
				<tr><td><b>Kelengkapan dokumen Pengajuan SP2D LS Gaji induk/terusan/susulan, dan sejenisnya</b></td>
					</tr>            
				<tr><td><input type="checkbox" name="spm1" id="spm1" value="1"/>Surat Penyediaan Dana/SPD</td>
					</tr>
				<tr><td><input type="checkbox" name="spm2" id="spm2" value="2"/>Surat Pengantar SPM LS Gaji dan Tunjangan</td>
					</tr>
				<tr><td><input type="checkbox" name="spm3" id="spm3" value="3"/>Surat Pernyataan Pengajuan SPM LS Gaji dan Tunjangan (SPTJM-SPM)</td>
					</tr>
				<tr><td><input type="checkbox" name="spm4" id="spm4" value="4"/>SPM LS Gaji dan Tunjangan</td>
					</tr> 
				<tr><td><input type="checkbox" name="spm5" id="spm5" value="5"/>Print out Rekapitulasi Amprah Gaji</td>
					</tr>
				...
				<tr><td><input type="checkbox" name="spm9" id="spm9" value="9"/>Surat setoran JKK</td>
					</tr>
				<tr><td><input type="checkbox" name="spm10" id="spm10" value="10"/>Surat setoran JKM</td>
				</tr>
				<tr><td><input type="checkbox" name="spm11" id="spm11" value="11"/>Surat Pernyataan Verifikasi Kelengkapan dan Keabsahan Dokumen dan Lampiran SPP LS Gaji dan Tunjangan yang ditandatangani oleh PPK SKPK, dan</td>
				</tr>
	...
	<table>
		<td>
			<table>
				<tr>
					<td>        
					<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow('<?php echo site_url(); ?>/tukd_verif/cetak_sppls_gaji');return false;">Cetak</a>					
					</td>
					<td>
