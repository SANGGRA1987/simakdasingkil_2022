    ...
    $(document).ready(function() {
        ...
        function validate_kegiatan(){
            ...
            $(function(){
              ...
              columns   :[[  
               ...
               cvkd_kegiatan = rowData.kd_kegiatan;
               //alert(cvkd_kegiatan);
        ...
        function validate_rekening(){
           ...
           if ( p > 0 ){   
                ...
                var kode_s   = document.getElementById('dn').value  ;
                var kode_keg = $('#kg').combogrid('getValue') ;
                ...
                $(function(){
                  ...
                  textField :'kd_rek5',  
                  mode      :'remote',
//                  url       :'<?php echo base_url(); ?>index.php/xtukd_ppkd/load_rek_ar/'+kode_keg+'/'+frek,                  
				  url       :'<?php echo base_url(); ?>index.php/xtukd_ppkd/load_ppkdd',                  
				  
				  queryParams:({kdkegiatan:cvkd_kegiatan,kdrek:frek}), 
                  columns:[[  
                   {field:'kd_rek5',title:'Kode Rekening',width:150},  
                   {field:'nm_rek5',title:'Nama Rekening',width:700}    
                   ]],
    ...
    function kosong(){
	 ...
	 function get_nomor_spp()
        {
            
        var kodes      = $("#rek_skpd").combogrid("getValue") ;
          if(kodes==''){
            alert('Silahkan Refresh Halaman, SKPD belum diketahui !')
          }else{


        	$.ajax({
        		url:'<?php echo base_url(); ?>index.php/tukd/no_urut_spp',
        		type: "POST",
        		dataType:"json",                         
        		success:function(data){
								var nosppnew = data.no_urut;
								var tambahan = nosppnew+"/SPP/LS/"+kodes+"/"+tahun_anggaran;
								//alert(tambahan);
        								$("#no_spp").attr("value",tambahan);
        							  }                                     
        	}); 
...
//exit();
   ...
   function openWindow( url )
        ...
        window.open(url+'/'+no+'/'+kode+'/'+jns+'/'+ttd_1+'/0/0/'+tanpa, '_blank');
        window.focus();
        }
