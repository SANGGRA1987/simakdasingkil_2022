...
<head>
    ...
    $(function(){
        $('#crskpd').combogrid({  
            panelWidth:500,  
            url: '<?php echo base_url(); ?>/index.php/tukd/load_skpd_cair',  
            idField:'kd_skpd',  
            textField:'kd_skpd',  
                    fitColumns:true,  
                    columns:[[  
                    ...
                    onSelect:function(rowIndex,rowData){
                        $("#crnmskpd").attr("value",rowData.nm_skpd);
                        carisKPD();
                    }   
                }); 
    });
	...
	function get_tahun() {
     ...
     function cari(){
     // var skpd = $("#crskpd").combogrid("getValue");
...
<div>
    <!-- <input type="text" id="crskpd" style="width: 180px" hidden/>
    <input type="text" value="" id="crnmskpd" style="width: 320px;border: none;"/> -->
    <a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
    <input type="text" value="" id="txtcari" style="width: 350px" autocomplete="off" />
    <p align="right">         
...
<table border='0' style="font-size:11px" >
 ...
 <tr>
   <td >No SP2D </td>
   <td><input type="text" name="no_sp2d" id="no_sp2d" readonly="true" style="width:410px" ></td>
   <td>Tgl SP2D </td>
   <td><input id="dd" name="dd" type="text" disabled style="width:155px" /></td>
 </tr>
 <tr>
   <td >No SPM</td>
   <td><input type="text" name="nospm" id="nospm"  style="width:410px" disabled  ></td>
   <td>Tgl SPM </td>
   <td><input id="tgl_spm" name="tgl_spm" type="text" readonly="true" style="width:150px" /></td>
 </tr>
 <tr>   
   <td width="8%" >No SPP</td>
   <td><input id="nospp" name="nospp" readonly="true" style="width:410px" /></td>
   <td>Tgl SPP </td>
 ...
 <tr>
   ...
   <td><input id="sp" name="sp" style="width:410px" readonly="true"/></td>
