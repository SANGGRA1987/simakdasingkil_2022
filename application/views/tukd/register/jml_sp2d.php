...
<head>
	...
	$(function(){  
            $('#ttd').combogrid({  
                ...
                textField:'nip',  
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/tatausaha/register_sp2dController/load_ttd/BUD',  
                columns:[[  
    ...
    function cetak(ctk)
        {
			...
			var url    = "<?php echo site_url(); ?>/tatausaha/register_sp2dController/cetak_reg_sp2d_count";  
