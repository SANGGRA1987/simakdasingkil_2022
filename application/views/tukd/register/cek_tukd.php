...
function pilih(pilih){        
	...
	function cetak_register_akun1(cetak){
			...
			var cbulan = $('#bulan').combogrid('getValue');
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register_penagihan"; 
	...
	function cetak_register_akun2(cetak){
			...
			var ttd1 =ttd.split(" ").join("a");
			var cbulan = $('#bulan').combogrid('getValue');
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register_cair"; 
				window.open(url+'/'+ttd1+'/'+cbulan+'/'+cetak+'/1');
				window.focus();				
        }
 	...
 	function cetak_register_akun3(cetak){
			...
			var ttd1 =ttd.split(" ").join("a");
			var cbulan = $('#bulan').combogrid('getValue');
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register_sp2d_belum"; 
				window.open(url+'/'+ttd1+'/'+cbulan+'/'+cetak+'/1');
				window.focus();				
        }

	function cetak_register_akun4(cetak){
			var cetak =cetak;
			var ttd    = nip;                           
			var ttd1 =ttd.split(" ").join("a");
			var cbulan = $('#bulan').combogrid('getValue');
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register_sp2d_tran"; 
				window.open(url+'/'+ttd1+'/'+cbulan+'/'+cetak+'/1');
				window.focus();				
        }

	function cetak_register_akun5(cetak){
			var cetak =cetak;
			var ttd    = nip;                           
			var ttd1 =ttd.split(" ").join("a");
			var cbulan = $('#bulan').combogrid('getValue');
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register_sp2d_spj"; 
				window.open(url+'/'+ttd1+'/'+cbulan+'/'+cetak+'/1');
				window.focus();				
        }
...
<h3>CEK DATA PENATAUSAHAAN</h3>
    ...
    <p align="right">         
		...
		<tr >
			<td width="20%" height="40" ><B>CEK DATA PENAGIHAN</B></td>
		...
		<tr >
			<td width="20%" height="40" ><B>CEK DATA CAIR</B></td>
		...
		<tr >
			<td width="20%" height="40" ><B>CEK DATA SP2D  BELUM DI TRANSAKSIKAN</B></td>
		...
		<tr >
			<td width="20%" height="40" ><B>CEK DATA SP2D  TELAH DI TERIMA TETAPI BELUM DI TRANSAKSIKAN</B></td>
			<td width="80%"> <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak_register_akun4(2);">Cetak Layar</a>
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak_register_akun4(1);">Cetak Pdf</a>
		</td>
		</tr> 
		<tr >
			<td width="20%" height="40" ><B>CEK DATA SPJ SELISIH DENGAN BKU (POT PAJAK SP2D LS Tunai)</B></td>
			<td width="80%"> <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak_register_akun5(2);">Cetak Layar</a>
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak_register_akun5(1);">Cetak Pdf</a>
		</td>             		
		<tr >
			<td >&nbsp;</td>
			<td >&nbsp;</td>
