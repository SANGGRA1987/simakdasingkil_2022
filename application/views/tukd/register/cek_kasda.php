...
function pilih(pilih){        
	...
	function cetak_kas(cetak){
			var cetak =cetak;
			var ttd    = nip;                           
			var ttd1 =ttd.split(" ").join("a");
			var cbulan = $('#bulan').combogrid('getValue');
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register_kasda"; 
				window.open(url+'/'+ttd1+'/'+cbulan+'/'+cetak+'/1');
				window.focus();				
        }

	function cetak_kas1(cetak){
			var cetak =cetak;
			var ttd    = nip;                           
			var ttd1 =ttd.split(" ").join("a");
			var cbulan = $('#bulan').combogrid('getValue');
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register_kaspeng"; 
				window.open(url+'/'+ttd1+'/'+cbulan+'/'+cetak+'/1');
				window.focus();				
        }

	function cetak_kas2(cetak){
			var cetak =cetak;
			var ttd    = nip;                           
			var ttd1 =ttd.split(" ").join("a");
			var cbulan = $('#bulan').combogrid('getValue');
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register__rinci_kaspeng"; 
				window.open(url+'/'+ttd1+'/'+cbulan+'/'+cetak+'/1');
				window.focus();				
        }
...
<h3>CEK DATA KAS DI KASDA</h3>
    ...
    <p align="right">         
		...
		<tr >
			<td width="20%" height="40" ><B>CEK KAS DI KASDA</B></td>
			<td width="80%"> <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak_kas(2);">Cetak Layar</a>
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak_kas(1);">Cetak Pdf</a>
			</td>
		</tr>  
		<tr >
			<td width="20%" height="40" ><B>CEK KAS BENDAHARA PENGELUARAN</B></td>
			<td width="80%"> <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak_kas1(2);">Cetak Layar</a>
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak_kas1(1);">Cetak Pdf</a>
			</td>
		</tr>  
		<tr >
			<td width="20%" height="40" ><B>CEK RINCI KAS BENDAHARA PENGELUARAN</B></td>
			<td width="80%"> <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak_kas2(2);">Cetak Layar</a>
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak_kas2(1);">Cetak Pdf</a>
			</td>
		</tr>  
		<tr >
			<td >&nbsp;</td>
