...
function pilih(pilih){        
	...
	function cetak_register_lpj(cetak){
			...
			var skpd   = kode; 			
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register_lra_to_lo"; 
				window.open(url+'/'+ttd1+'/'+skpd+'/'+cbulan+'/'+cetak+'/1');
				window.focus();				
        }
    
    function cetak_register_lpj_2(cetak){
			var cetak =cetak;
			var ttd    = nip;                           
			var ttd1 =ttd.split(" ").join("a");
			var cbulan = $('#bulan').combogrid('getValue');
			var skpd   = kode; 			
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register_lra_to_lo_all"; 
				window.open(url+'/'+ttd1+'/'+skpd+'/'+cbulan+'/'+cetak+'/1');
				window.focus();				
        }    
	...
	function cetak_register_lpj1(cetak){
			...
			var cbulan = $('#bulan').combogrid('getValue');
			var skpd   = kode; 			
				var url    = "<?php echo site_url(); ?>/tukd/cetak_register_lra_to_lo_aset"; 
				window.open(url+'/'+ttd1+'/'+skpd+'/'+cbulan+'/'+cetak+'/1');
				window.focus();				
        }
...
<h3>CETAK LRA TO LO</h3>
    ...
    <p align="right">         
		...
		<tr >
			<td width="20%" height="40" ><B>Cetak LRA TO LO</B></td>
		...
		<tr >
			<td width="20%" height="40" ><B>Cetak LRA TO ASET</B></td>
        ...
        <tr >
			<td width="20%" height="40" ><B>Cetak LRA TO LO (PEMKOT)</B></td>
			<td width="80%"> <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak_register_lpj_2(2);">Cetak Layar</a>
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak_register_lpj_2(1);">Cetak Pdf</a>
			</td>
		</tr>       
		<tr >
			<td >&nbsp;</td>
