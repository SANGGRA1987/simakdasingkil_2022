...
//		});
    ...
    function get_skpd()
	  ...
	  function opt2(val){        
	  	...
	  	selectedEffect = "clip";
	  	if (ctk2=='2'){
	  		$( "#div_bulan" ).show( selectedEffect, options, 1000 );
	  		$( "#div_periode" ).hide( selectedEffect, options, 1000 );
	  	} else if (ctk2=='1'){
	  		$( "#div_periode" ).show( selectedEffect, options, 1000 );
	  		$( "#div_bulan" ).hide( selectedEffect, options, 1000 );
	  	} else {
	  		exit();
	  	}                 
	  }    
	...
	function cetak_register_sp2d(cetak){
			...
			if (cetak == '0') {
				alert('Silahkan Pilih Jenis Cetakan SKPD Atau Keseluruhan!!!');
				exit();
			}

			if (cetak2 == '0') {
				alert('Silahkan Pilih Jenis Periode Atau Bulanan!!!');
				exit();
			}

			if (status == '') {
				alert('Silahkan Pilih Status SP2D!!!');
				exit();
			}
			...
			var url    = "<?php echo site_url(); ?>/register/register_sp2d_bud_ctk"; 
			window.open(url+'/'+cetak+'/'+cetak1+'/'+cetak2+'/'+dcetak+'/'+dcetak2+'/'+bulan+'/'+ttd+'/'+status+'/'+skpd+'/Register_SP2D');
			window.focus();
			}
...
<h3>CETAK REGISTER SP2D</h3>
    ...
    <p align="right">         
        <table id="sp2d" title="Cetak KARTU KENDALI" style="width:870px;height:300px;" >
        	<tr>
        		<td colspan="2">
        			<input type="radio" name="cetak" value="0" onclick="opt(this.value)" checked hidden/>
        			<input type="radio" name="cetak" value="1" onclick="opt(this.value)" />Per SKPD &ensp;
        			<input type="radio" name="cetak" value="2" onclick="opt(this.value)"/>Keseluruhan
        		</td>

        	</tr>		
        	<tr >
        		<td colspan="2">
        			<div id="div_skpd" hidden>
        	...
        	<tr>
        		<td colspan="2">
        			<input type="radio" name="cetak" value="0" onclick="opt2(this.value)" checked hidden />
        			<input type="radio" name="cetak" value="1" onclick="opt2(this.value)" />Per Periode &ensp;
        			<input type="radio" name="cetak" value="2" onclick="opt2(this.value)" />Per Bulan
        		</td>
        		
        	</tr>
        	<tr >
        		<td colspan="2">
        			<div id="div_bulan" hidden>
        				<table style="width:100%;" border="0">
        					<tr>
        	...
        	<tr >
        		<td colspan="2">
        			<div id="div_periode" hidden>
        				<table style="width:100%;" border="0">
        					<tr>
        						<td width="20%" height="40" ><B>PERIODE</B></td>
        						<td width="80%">
        							<input id="dcetak" name="dcetak" type="text"  style="width:155px" />&nbsp;&nbsp;s/d&nbsp;&nbsp;
        							<input id="dcetak2" name="dcetak2" type="text"  style="width:155px" /></td>
        					</tr>
        				</table>
        			</div>
        		</td>
