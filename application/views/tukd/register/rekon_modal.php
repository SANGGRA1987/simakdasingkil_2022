...
<head>
	...
	$(function(){
		...
		$('#bulan').combogrid({  
                   ...
                   textField:'nm_bulan',  
                   mode:'remote',
                   url:'<?php echo base_url(); ?>index.php/tatausaha/reg_modalrekonController/bulan',  
                   columns:[[ 
        ...
        $('#ttd').combogrid({  
		panelWidth:500,  
		url: '<?php echo base_url(); ?>/index.php/tatausaha/reg_modalrekonController/load_ttd/BUD',  
			idField:'nip',                    
			textField:'nama',
			mode:'remote',  
			fitColumns:true,  
	 ...
	 function validate_kegi(kode){
		 ...
		 $('#kg').combogrid({  
                panelWidth:500,  
                url: '<?php echo base_url(); ?>/index.php/tatausaha/reg_modalrekonController/pgiat/'+kode,  			
                    idField:'kd_kegiatan',  
	 ...
	 function validate_rek(cgiat){
		...
		textField:'kd_rek5',  
		mode:'remote',
		url:'<?php echo base_url(); ?>/index.php/tatausaha/reg_modalrekonController/ld_rek/'+cgiat,  
		columns:[[  
    ...
    function get_skpd()
        {
        	...
        	$.ajax({
        		url:'<?php echo base_url(); ?>index.php/tatausaha/reg_modalrekonController/config_skpd',
        		type: "POST",
        		dataType:"json",                         
...
function pilih(pilih){        
	...
	function cetak_register_persp2d(cetak){
			...
			if(pilihan=='1'){
				if(dengan==0){
				var url    = "<?php echo site_url(); ?>/tatausaha/reg_modalrekonController/cetak_register_persp2d_belanja_modal_baru"; 
				} else {
				var url    = "<?php echo site_url(); ?>/tatausaha/reg_modalrekonController/cetak_register_persp2d_belanja_modal_baru"; 
				}
		...
		//	var url    = "<?php echo site_url(); ?>/tatausaha/reg_modalrekonController/cetak_register_persp2d"; 
			var url    = "<?php echo site_url(); ?>/tatausaha/reg_modalrekonController/cetak_register_persp2d_belanja_modal_baru"; 
...
<h3>CETAK REKAP BELANJA MODAL</h3>
    <div>
    <p align="right">         
		...
		<tr>
			...
			<td width="80%"><input id="dcetak" name="dcetak" type="text"  style="width:110px" />&nbsp;&nbsp;s/d&nbsp;&nbsp;<input id="dcetak2" name="dcetak2" type="text"  style="width:110px" /></td>
		</tr>
		<!--<tr>
