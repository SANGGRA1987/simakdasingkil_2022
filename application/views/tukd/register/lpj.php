...
<head>
	...
	$(function(){
		...
		$('#skpd').combogrid({  
           ...
           textField:'kd_skpd',  
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/tatausaha/register_lpjController/skpd',  
           columns:[[  
		...
		$('#bulan').combogrid({  
                   ...
                   textField:'nm_bulan',  
                   mode:'remote',
                   url:'<?php echo base_url(); ?>index.php/tatausaha/register_lpjController/bulan',  
                   columns:[[ 
        ...
        $('#ttd').combogrid({  
		panelWidth:500,  
		url: '<?php echo base_url(); ?>/index.php/tatausaha/register_lpjController/load_ttd/BUD',  
			idField:'nip',                    
			textField:'nama',
			mode:'remote',  
			fitColumns:true,  
	 ...
	 function validate_kegi(kode){
		 ...
		 $('#kg').combogrid({  
                panelWidth:500,  
                url: '<?php echo base_url(); ?>/index.php/tatausaha/register_lpjController/pgiat/'+kode,  			
                    idField:'kd_kegiatan',  
	 ...
	 function validate_rek(cgiat){
		...
		textField:'kd_rek5',  
		mode:'remote',
		url:'<?php echo base_url(); ?>/index.php/tatausaha/register_lpjController/ld_rek/'+cgiat,  
		columns:[[  
    ...
    function get_skpd()
        {
        	...
        	$.ajax({
        		url:'<?php echo base_url(); ?>index.php/tatausaha/register_lpjController/config_skpd',
        		type: "POST",
        		dataType:"json",                         
...
function pilih(pilih){        
	...
	function cetak_register_lpj(cetak){
			...
			var dcetak = $('#dcetak_ttd').datebox('getValue'); 			
				var url    = "<?php echo site_url(); ?>/tatausaha/register_lpjController/cetak_register_lpjtu"; 
				window.open(url+'/'+ttd1+'/'+skpd+'/'+cbulan+'/'+cetak+'/'+dcetak+'/REGISTER LPJ TU');
				window.focus();				
        }
	...
	function cetak_register_lpj1(cetak){
			...
			var dcetak = $('#dcetak_ttd').datebox('getValue');   		
				...
				var url    = "<?php echo site_url(); ?>/tatausaha/register_lpjController/cetak_register_lpjup"; 
				window.open(url+'/'+ttd1+'/'+skpd+'/'+cbulan+'/'+cetak+'/'+dcetak+'/REGISTER LPJ UP');
