...
<head>
    ...
    $(function(){ 
     $('#dg').edatagrid({
        url: '<?php echo base_url(); ?>/index.php/tukd/load_map_terima',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
     ...
     function simpan(){
        ...
        var vinit   = document.getElementById('init_edt').value; 
         ...
         $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/tukd_bosda/simpan_proteksi_simpanhps',
                data: ({tabel:'ms_skpd_bos_init',skpd:vskpd,nmskpd:vnmskpd,init:vinit}),
                dataType:"json",
...
<div id="accordion">
<h3><a href="#" id="section1">Proteksi Anggaran / Transaksi</a></h3>
  <table id="dg" title="List Data" style="width:870px;height:450px;" >  
  </table>
</div>
</div>
...
<div id="dialog-modal" title="Edit Proteksi">
    ...
    <table>
        <tr>
            <td width="110px">Kode Satuan Pendidikan</td>
