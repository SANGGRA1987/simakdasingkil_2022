    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            <tr>
                ...
                <td width="1%">:</td>
                <td><input type="text" id="kode_u" style="width:80px;"/><input type="text" id="nm_u" style="width:310px;"/></td>  
            </tr> 
            <tr>
                <td width="30%">KODE URUSAN 2</td>
                <td width="1%">:</td>
                <td><input type="text" id="kode_u2" style="width:80px;"/><input type="text" id="nm_u2" style="width:310px;"/></td>  
            </tr> 
            <tr>
                <td width="30%">KODE URUSAN 3</td>
                <td width="1%">:</td>
                <td><input type="text" id="kode_u3" style="width:80px;"/><input type="text" id="nm_u3" style="width:310px;"/></td>  
            </tr> 
           <tr>
