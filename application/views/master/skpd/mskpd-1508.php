...
<head>   
  ...
  <script type="text/javascript">
    ...
    var lcstatus = '';
     ...
     $('#dg').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){
          ...
          nilai_kua = rowData.nilai_kua;
          get(kd_s,kd_u,nm_s,npwp,rek,nilai_kua); 
          lcidx = rowIndex;  
    ...
    function get(kd_s,kd_u,nm_s,npwp,rek,nilai_kua) {
     ...
     $('#dg').edatagrid({
       ...
       function simpan_skpd(){
        ...
        if(lcstatus=='tambah'){ 
            ...
            lcinsert = "(kd_skpd,kd_urusan,nm_skpd,npwp,rekening,nilai_kua)";
            lcvalues = "('"+ckode+"','"+ckode_u+"','"+cnama+"','"+cnpwp+"','"+crek+"','"+vn_kua+"')";
            ...
            lcquery = "UPDATE ms_skpd SET nm_skpd='"+cnama+"',kd_urusan='"+ckode_u+"',npwp='"+cnpwp+"',rekening='"+crek+"',nilai_kua='"+vn_kua+"' where kd_skpd='"+ckode+"'";
