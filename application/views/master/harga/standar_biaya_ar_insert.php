...
<head>   
    ...
    $(document).ready(function() {
     ...
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/sb/sb/select_sisb_all',
        idField       : 'id',            
        rownumbers    : "true", 
        fitColumns    : "true",
        singleSelect  : "true",
    ...
    $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/sb/sb/ambil_asb1_2',
...
<div id="content"> 
<h3 align="center"><u><b><a>MASTER STANDAR BIAYA</a></b></u></h3>
    <div align="center">
    <p align="center">     
    <table style="width:400px;" border="0">
        <tr>
        <td><input type="text" value="Sumber Data : sisb.pontianakkota" id="txtcari" style="width:300px;" disabled/></td>
        </tr>
        <tr>
        <td colspan="4">
        <table id="dg" title="LISTING DATA STANDAR BIAYA" style="width:900px;height:440px;" >  
        </table>
        </td>
        </tr>
    </table>  
