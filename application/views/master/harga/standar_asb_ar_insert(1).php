...
<div id="content"> 
<h3 align="center"><u><b><a>MASTER STANDAR ASB</a></b></u></h3>
    <div align="center">
    <p align="center">     
    <table style="width:400px;" border="0">
        <tr>
        <td><input type="text" value="Sumber Data : sisb.pontianakkota/asb" id="txtcari" style="width:300px;" disabled/></td>
        </tr>
        <tr>
        <td colspan="4">
        <table id="dg" title="LISTING DATA STANDAR ASB" style="width:900px;height:440px;" >  
        </table>
        </td>
        </tr>
    </table>  
