<div id="content">
        ...
        <table class="narrow">
		    ...
		    <?php if (  $user->kunci != "1" ) : ?>	
                <td>Kunci User &nbsp;
                <a href="<?php echo site_url(); ?>/master/tombol_kunci_renja2/<?php echo $user->kd_skpd; ?>" title="Kunci User"><img src="<?php echo base_url(); ?>assets/images/icon/kunci.ico" /></a>
            <?php endif; ?>
            <?php if (  $user->kunci == "1" ) : ?>
                <td>Buka User &nbsp;
                <a href="<?php echo site_url(); ?>/master/tombol_buka_renja/<?php echo $user->kd_skpd; ?>" title="Buka User Renja "><img src="<?php echo base_url(); ?>assets/images/icon/unlock.ico" /></a>
            <?php endif; ?>     
                </td>
            </tr>
            <?php endforeach; ?>
