    ...
    function simpan_rek1(){
        ...
        if(lcstatus=='tambah'){ 
            ...
            $(document).ready(function(){
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url(); ?>/index.php/master/simpan_master_bank',
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/master/update_master_bank',
     ...
     function hapus(){
        ...
        var urll = '<?php echo base_url(); ?>index.php/master/hapus_master_bank';
        $(document).ready(function(){
